...
/**
 * @author Felix Jost, http://www.goodsolutions.ch this is a service instance for handling a clipboard (a la gui copy and paste). it is normally attached to one user, but
 *         this is up to the caller of the service.
 */
public interface ClipboardService {
	...
	/**
	 * @return (once only allowed) the UI representing the clipboard content (should be presented at some place like e.g. top right of the screen or similar, a place
