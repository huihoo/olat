...
/**
 * <h3>Description:</h3> This manager offers methods to deal with the context help. This version of the manager stores file in the filesystem because brasato has not yet
 * database stuff in it. <h3>Events thrown by this manager:</h3>
 * <ul>
 * <li>ContextHelpRatingEvent: communicate new user ratings between cluster nodes via CoordinatorManager</li>
 * </ul>
 * <p>
