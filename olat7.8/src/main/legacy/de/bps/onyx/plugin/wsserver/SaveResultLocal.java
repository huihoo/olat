/**
 * SaveResultLocal.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.5 Built on : Apr 30, 2009 (06:07:47 EDT)
 */
...
public class SaveResultLocal implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://test.plugin.bps.de/", "saveResultLocal", "ns1");
	 ...
	 */
	public void setResultLocalFile(final java.lang.String param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":saveResultLocal", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "saveResultLocal", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SaveResultLocal parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			final SaveResultLocal object = new SaveResultLocal();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"saveResultLocal".equals(type)) {
							...
							return (SaveResultLocal) de.bps.onyx.plugin.wsserver.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "resultLocalFile").equals(reader.getName())) {
					...
					object.setResultLocalFile(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
