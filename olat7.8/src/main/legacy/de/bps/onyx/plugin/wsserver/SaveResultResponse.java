/**
 * SaveResultResponse.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.5 Built on : Apr 30, 2009 (06:07:47 EDT)
 */
...
public class SaveResultResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://test.plugin.bps.de/", "saveResultResponse", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":saveResultResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "saveResultResponse", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SaveResultResponse parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			final SaveResultResponse object = new SaveResultResponse();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"saveResultResponse".equals(type)) {
							...
							return (SaveResultResponse) de.bps.onyx.plugin.wsserver.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
