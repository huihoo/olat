...
/**
 * <h3>Description:</h3> This controller offers a workflow to configure the system languages:
 * <ul>
 ...
 * </ul>
 * The configuration is activated right away and saved through the I8nModule to the system configuration properties files <h3>Events thrown by this controller:</h3> none
 * <p>
...
class I18nConfigController extends FormBasicController {
    ...
    protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
        ...
        defaultLangSelection = uifactory.addDropdownSingleselect("configuration.defaultLangSelection", formLayout, defaultlangKeys, defaultLangValues,
                defaultLangCssClasses);
        ...
        // inform the component that the values should not be escaped at rendering
        enabledLangSelection = uifactory.addCheckboxesVerticalWithTrustedText("configuration.enabledLangSelection", null, formLayout, availablelangKeys,
