 ...
 */
public abstract class AbstractGroupConfirmationSenderInfo {

    private final Identity originatorIdentity;

    protected AbstractGroupConfirmationSenderInfo(Identity originatorIdentity) {
