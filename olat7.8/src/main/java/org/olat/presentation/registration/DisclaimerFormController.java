...
public class DisclaimerFormController extends FormBasicController {
    ...
    public DisclaimerFormController(final UserRequest ureq, final WindowControl wControl, final boolean readOnly) {
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        acceptCheckbox = uifactory.addCheckboxesVertical(ACKNOWLEDGE_CHECKBOX_NAME, null, formLayout, new String[] { DCL_CHECKBOX_KEY },
                new String[] { translate(NLS_DISCLAIMER_ACKNOWLEDGED) }, null, 1);
        ...
        if (RegistrationModule.isDisclaimerAdditionalCheckbox()) {
            final String additionalCheckboxText = translate("disclaimer.additionalcheckbox");
            if (additionalCheckboxText != null) {
                additionalCheckbox = uifactory.addCheckboxesVertical(ADDITIONAL_CHECKBOX_NAME, null, formLayout, new String[] { DCL_CHECKBOX_KEY2 },
                        new String[] { additionalCheckboxText }, null, 1);
