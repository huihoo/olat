...
public class LTIConfigForm extends FormBasicController {
     ...
     * @param withCancel
     */
    public LTIConfigForm(final UserRequest ureq, final WindowControl wControl, final ModuleConfiguration config) {
        super(ureq, wControl);
        this.config = config;
        ...
        if (doDebugConfig == null) {
            doDebugConfig = Boolean.FALSE;
        }
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        setFormContextHelp("org.olat.presentation.course.nodes.basiclti", "ced-lti-conf.html", "help.hover.lt.conf");
    ...
    protected static StringBuilder getFullURL(final String proto, final String host, final Integer port, final String uri, final String query) {
