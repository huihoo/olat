...
class IQEditForm extends FormBasicController {
     ...
     * @param modConfig
     */
    IQEditForm(final UserRequest ureq, final WindowControl wControl, final ModuleConfiguration modConfig) {
        super(ureq, wControl);
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        final Boolean bAutoEnum = (Boolean) modConfig.get(IQEditController.CONFIG_KEY_AUTOENUM_CHOICES);
        final boolean confAutoEnum = (bAutoEnum != null) ? bAutoEnum.booleanValue() : false;
        autoEnumerateChoices = uifactory.addCheckboxesVertical("qti_AutoEnumChoices", "qti.form.auto.enumerate.choices", formLayout, new String[] { "xx" },
                new String[] { null }, null, 1);
        autoEnumerateChoices.select("xx", confAutoEnum);

        // provide memo field
        final Boolean bMemo = (Boolean) modConfig.get(IQEditController.CONFIG_KEY_MEMO);
        final boolean confMemo = (bMemo != null) ? bMemo.booleanValue() : false;
        provideMemoField = uifactory.addCheckboxesVertical("qti_provideMemoField", "qti.form.auto.memofield", formLayout, new String[] { "xx" }, new String[] { null },
                null, 1);
        ...
        displayScoreProgress = uifactory
                .addCheckboxesVertical("resultTitle", "qti.form.scoreprogress", formLayout, new String[] { "xx" }, new String[] { null }, null, 1);
     ...
     */
    boolean isDisplayScoreProgress() {
     ...
     * @return true: score progress is enabled
     */
    boolean isDisplayQuestionProgress() {
     ...
     */
    boolean isDisplayQuestionTitle() {
     ...
     */
    boolean isAutoEnumChoices() {
        return autoEnumerateChoices.isSelected(0);
    }

    /**
     * @return true: provide memo field
     */
    boolean isProvideMemoField() {
        return provideMemoField.isSelected(0);
    }
     ...
     */
    Boolean isMenuRenderSectionsOnly() {
     ...
     */
    boolean isShowResultsDateDependent() {
     ...
     */
    boolean isShowResultsAfterFinishTest() {
     ...
     */
    boolean isShowResultsOnHomePage() {
