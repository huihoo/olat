...
public class BulkActionGetNodePassed extends BulkAction {
    ...
    public BulkActionGetNodePassed(final OLATResourceable ores, final CourseNode courseNode, final Translator translator) {
    ...
    public List doAction(final List identities) {
        ...
        final List nodePassedResults = new ArrayList(identities.size());
        ...
        for (final Iterator iter = identities.iterator(); iter.hasNext();) {
            ...
            if (identity != null) {
                ...
                if (scoreEvaluation == null) {
                    ...
                    final Boolean nodePassed = scoreEvaluation.getPassed();
                    if (nodePassed == null) {
                        nodePassedResults.add(translator.translate("bulk.action.no.value"));
                    } else {
