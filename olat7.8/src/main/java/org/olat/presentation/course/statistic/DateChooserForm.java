        ...
        if (!fromDate.hasError() && !toDate.hasError()) {
            ...
            if (fromDateVal != null && toDateVal != null) {
                ...
                if (fromDateVal.after(toDateVal)) {
                    fromDate.setTranslator(PackageUtil.createPackageTranslator(org.olat.lms.course.condition.Condition.class, ureq.getLocale(), fromDate.getTranslator()));
                ...
                if (toDateVal == null && !toDate.isEmpty()) {
                    toDate.setTranslator(PackageUtil.createPackageTranslator(org.olat.lms.course.condition.Condition.class, ureq.getLocale(), toDate.getTranslator()));
