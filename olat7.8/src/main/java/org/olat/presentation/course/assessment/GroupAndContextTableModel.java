...
public class GroupAndContextTableModel extends DefaultTableDataModel implements TableDataModel {
     ...
     * @param groups
     * @param trans
     *            translator for the business group context
     */
    public GroupAndContextTableModel(final List groups, final Translator trans) {
        super(groups);
        this.trans = trans;
    }
    ...
    public Object getValueAt(final int row, final int col) {
        ...
        switch (col) {
        case 0:
            return StringHelper.escapeHtml(businessGroup.getName()).toString();
        case 1:
        ...
        case 2:
            ...
            name = StringHelper.escapeHtml(name).toString();
            return name;
        default:
            return "ERROR";
        }
