            ...
            if (event.getCommand().equals(Table.COMMANDLINK_ROWACTION_CLICKED)) {
                ...
                if (actionid.equals(CMD_SHOW)) {
                    ...
                    if (re == null) {
                        ...
                        DynamicTabHelper.openResourceTab(ores, ureq, launchController, efficiencyStatement.getCourseTitle(), null);
                    }
                } else if (actionid.equals(CMD_DELETE)) {
                    // show confirmation dialog
                    String text = translate("efficiencyStatements.delete.confirm", StringHelper.escapeHtml(efficiencyStatement.getCourseTitle()));
