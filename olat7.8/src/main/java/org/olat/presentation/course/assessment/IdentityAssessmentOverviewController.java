...
public class IdentityAssessmentOverviewController extends BasicController {
     ...
     *            configuration switch: true: user may select the nodes, e.g. to edit the nodes result, false: readonly view (user view)
     * @param discardEmptyNodes
     *            filtering default value: true: do not show nodes that have no value. false: show all assessable nodes
     * @param allowTableFiltering
     *            configuration switch: true: allow user to filter table all nodes/only nodes with data
     */
     ...
     * @param ureq
     * @param wControl
     * @param assessmentCourseNodes
     *            List of maps containing the node assessment data using the AssessmentManager keys
     */
