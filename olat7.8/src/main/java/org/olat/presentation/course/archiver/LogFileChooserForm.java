...
/**
 * @author schneider Comment: Shows or don't shows three checkboxes appropriate the parameters in the constructor. At least on of them has to be true.
 */
public class LogFileChooserForm extends FormBasicController {

    private final boolean admin, u, a, s;
     ...
     *            userLogVisibility
     * @param s
     *            statisticLogVisibility
     */

    public LogFileChooserForm(final UserRequest ureq, final WindowControl wControl, final boolean isOLATAdmin, final boolean a, final boolean u, final boolean s) {
        super(ureq, wControl);
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        setFormContextHelp("org.olat.presentation.course.archiver", "arch-logf.html", "help.hover.log");
