...
public class IQStatus {
     ...
     * @param translator
     */
    public IQStatus(final Translator translator) {
     ...
     *            assessment instance
     */
    public void update(final AssessmentInstance ai) {
        if (ai == null) {
            return;
        }
        if (title == null) {
    ...
    public String getAssessTimeLimit() {
        if (!isOpen || !hasAssessTimeLimit()) {
            return "";
        }
        final long due = assessStart + assessMaxdur;
    ...
    public boolean hasItemTimeLimitExeeded() {
        if (!isOpen || !hasItemTimeLimit()) {
            return false;
        }
        final long due = itemStart + itemMaxdur;
        if (due < Calendar.getInstance().getTimeInMillis()) {
            return true;
        }
        return false;
    }
    ...
    /**
     * @param isPreview
     *            true: preview mode enabled, false: preview mode disabled
     */
    ...
    public void setQuestionProgressLabel(final String label) {
