...
public class CPUIFactory {
     ...
     * @param wControl
     * @param rootContainer
     *            The VFS root container where the CP is found on disk
     * @param activateFirstPage
     *            true to automatically activate the first node with content
     * @param initialUri
     *            can be NULL, will use first page then
     ...
     *            The VFS root container where the CP is found on disk
     * @param showMenu
     *            true to display the menu, false to hide the menu
     * @param activateFirstPage
     *            true to automatically activate the first node with content
     * @param initialUri
     *            can be NULL, will use first page then
     ...
     *            A specific encoding for the content
     * @param jsEncoding
     *            A specific encoding for javascripts
     * @param activateFirstPage
     *            true to automatically activate the first node with content
     * @param initialUri
     *            can be NULL, will use first page then
     ...
     * 
     * @param res
     *            The OLAT resource to listen to
     * @param ureq
     * @param rootContainer
     *            The VFS root container where the CP is found on disk
     * @param showMenu
