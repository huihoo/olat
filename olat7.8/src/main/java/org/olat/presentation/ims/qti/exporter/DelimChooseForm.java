...
public class DelimChooseForm extends FormBasicController {
    ...
    public DelimChooseForm(final UserRequest ureq, final WindowControl wControl, final String sep, final String emb, final String esc, final String car, final String suf) {
        super(ureq, wControl);
        this.sep = sep;
        this.emb = emb;
        this.esc = esc;
