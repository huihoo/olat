...
public class NodeBeforeChangeEvent extends Event {
     ...
     * @param changedTitle
     */
    public void setNewTitle(final String changedTitle) {
     ...
     */
    public void setNewObjectives(final String newObjectives) {
    ...
    public void setNewQuestionMaterial(final String content) {
    ...
    public void setMatIdent(final String id) {
        this.matIdent = id;
    }
    ...
    public void setNewResponseMaterial(final String content) {
    ...
    public void setSectionIdent(final String ident) {
    ...
    public void setQuestionIdent(final String id) {
    ...
    public void setResponseIdent(final String id) {
    ...
    public void setItemIdent(final String ident) {
