...
public class BlogUIFactory extends FeedUIFactory {
    ...
    private BlogUIFactory(final Locale locale) {
        setTranslator(locale);
    }

    public static BlogUIFactory getInstance(final Locale locale) {
    ...
    public void setTranslator(final Locale locale) {
        ...
        translator = PackageUtil.createPackageTranslator(BlogUIFactory.class, locale, fallbackTans);
    }
