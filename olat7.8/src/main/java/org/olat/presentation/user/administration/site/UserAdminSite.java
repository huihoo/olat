...
public class UserAdminSite implements SiteInstance {
	 ...
	 * 
	 */
    public UserAdminSite(final Locale loc) {
    ...
    public MainLayoutController createController(final UserRequest ureq, final WindowControl wControl) {
        final MainLayoutController c = ControllerFactory.createLaunchController(ORES_OLATUSERADMINS, null, ureq, wControl, true);
        return c;
    }
