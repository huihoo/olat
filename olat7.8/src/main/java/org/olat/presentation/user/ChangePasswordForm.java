...
public class ChangePasswordForm extends FormBasicController {
    ...
    protected boolean validateFormLogic(final UserRequest ureq) {
        ...
        // System.out.println("verifyPasswordStrength - identity: " + ureq.getIdentity().getName());
        boolean isNewPasswordOK = getUserService().verifyPasswordStrength(oldpass.getValue(), newpass1.getValue(), ureq.getIdentity().getName());
        if (!isNewPasswordOK) {
