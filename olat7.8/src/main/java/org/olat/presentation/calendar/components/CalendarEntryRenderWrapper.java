...
public class CalendarEntryRenderWrapper {
    ...
    public CalendarEntryRenderWrapper(final CalendarEntry calendarEntry, final CalendarRenderWrapper calendarWrapper) {
    ...
    public CalendarRenderWrapper getCalendarRenderWrapper() {
    ...
    public String getCssClass() {
        return calendarWrapper.getCalendarConfig().getCss();
    }
