...
public interface PathHandler {
     ...
     * @param request
     * @param relPath
     * @return A resource descriptor, describing the resource, or null if the handler decides it will not serve the resource. in the latter case the servlet will then
     *         send a HttpServletResponse.SC_NOT_FOUND (404) error.
     * @deprecated Please use GlobalMapperRegistry if you need to provide an url for e.g. static resources which are shared by all users
     */
    @Deprecated
