...
public class GUIMessage {
    ...
    /**
     * after calling this method, the info is cleared so it is only rendered once and therefore only displayed once to the user
     * 
    ...
    /**
     * after calling this method, the error is cleared so it is only rendered once and therefore only displayed once to the user
     * 
     * @return
     */
    public String renderError() {
        ...
        setError(null);
        // return Formatter.escapeDoubleQuotes(result).toString();
        return FilterFactory.filterXSS(result);
    }
