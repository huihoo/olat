...
public class PortletAutoSortingConfigurator extends FormBasicController {
    ...
    protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
        ...
        if (sortingCriteria.getSortingTermsList().contains(SortingCriteria.TYPE_SORTING)
            ...
            selectionKeys = new String[] { String.valueOf(SortingCriteria.TYPE_SORTING), String.valueOf(SortingCriteria.ALPHABETICAL_SORTING),
                    String.valueOf(SortingCriteria.DATE_SORTING) };
            selectionValues = new String[] { getTranslator().translate("portlet.auto.sorting.type"), getTranslator().translate("portlet.auto.sorting.alphabetical"),
                    getTranslator().translate("portlet.auto.sorting.date") };
        ...
        final String[] sortingDirectionTranslatedKeys = new String[] { getTranslator().translate("portlet.auto.sorting.ascending"),
                getTranslator().translate("portlet.auto.sorting.descending") };
