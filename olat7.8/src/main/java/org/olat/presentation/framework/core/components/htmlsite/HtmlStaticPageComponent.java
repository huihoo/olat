...
public class HtmlStaticPageComponent extends Component implements AsyncMediaResponsible {
     ...
     *            The component name
     * @param the
     *            root folder which contains the files
     */
    ...
    private Mapper createMapper(final VFSContainer mapperRootContainer) {
        ...
        Mapper map = new Mapper() {
            ...
            public MediaResource handle(String relPath, HttpServletRequest request) {
                ...
                String encoding = SimpleHtmlParser.extractHTMLCharset(((VFSLeaf) currentItem).getInputStream());
    ...
    private void getFileContent(VFSLeaf sourceFile) {
        ...
        String encoding = SimpleHtmlParser.extractHTMLCharset(sourceFile.getInputStream());
    ...
    public static boolean isFileTypeSupported(String filePath) {
        ...
        return (filePath_.endsWith(".html") || filePath_.endsWith(".htm") || filePath_.endsWith(".txt"));
    }

    /**
     * Set some CSS styles on the element.
     * 
     * @param wrapperCssStyle
     *            CSS rules or NULL to not use them
     */
