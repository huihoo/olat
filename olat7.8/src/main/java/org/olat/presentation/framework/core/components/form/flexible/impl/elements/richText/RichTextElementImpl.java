...
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.AbstractTextElement;
 ...
 * @author gnaegi
 */
public class RichTextElementImpl extends AbstractTextElement implements RichTextElement, Disposable {

    private static final Logger log = LoggerHelper.getLogger();

    /**
     * JavaScript code. If you want to get the raw user data use the getRawValue() method.
     */
    @Override
     ...
     * @param windowBackOffice
     *            The window back office used to properly cleanup code in browser window
     */
    public RichTextElementImpl(String name, String predefinedValue, int rows, int cols, Form form, WindowBackOffice windowBackOffice) {
    ...
    protected RichTextElementImpl(String name, int rows, int cols, Form rootForm, WindowBackOffice windowBackOffice) {
        ...
        if (GUIInterna.isLoadPerformanceMode()) {
            configuration = new RichTextConfiguration(DISPPREFIX + rootForm.getReplayableDispatchID(getComponent()), rootForm.getDispatchFieldId());
        } else {
