...
/**
 * Description: <br>
 * A graphical thing displayed on the right side of the screen, containing mainly links which are offered in the current process. The order the Header, Links, or
 * component are added determines their vertical position. Direction is top-down.
 * 
 * @author Felix Jost
 */
public interface ToolController extends Controller {
     ...
     * @param text
     * @param ident
     *            An ident to reference this entry
     */
     ...
     *            An ident to reference this entry
     * @param cssClass
     *            a css class that provides an toolbox title bar image. optional, can be null (default image)
     */
     ...
     * 
     * @param action
     *            the command which the event will have when the event is fired because the user clicked this link.
     * @param text
     */
     ...
     *            An ident to reference this entry
     * @param cssClass
     *            The class for the enclosing div tag or null if default class used
     */
     ...
     * @param cssClass
     *            The class for the enclosing div tag or null if default class used
     * @param isDownloadLink
     *            if the link results in a download !! works not together with cssClass != null
     */
    ...
    /**
     * @param dragEnabled
     *            if true, all active toolentries can be dragged
     */
