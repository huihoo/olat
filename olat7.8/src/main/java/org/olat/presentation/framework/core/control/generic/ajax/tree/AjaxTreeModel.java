...
/**
 * Description:<br>
 * The ajax tree model provides method for the ajax tree to dynamically build the tree based on user selection. Compared to the standard tree model the tree is not
 * browsed via the child relationship but rather by the getChildrenForm method.
 * <P>
...
public abstract class AjaxTreeModel {
     ...
     *            to identify the the tree, is also used for the root node and to store and restore the tree state
     */
