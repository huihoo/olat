...
import org.olat.presentation.framework.core.components.panel.LayeredPanel;
...
public class GuiStackNiceImpl implements GuiStack {
    private static final String VELOCITY_ROOT = PackageUtil.getPackageVelocityRoot(GuiStackNiceImpl.class);
    ...
    /**
     * @param title
     *            the title of the modal dialog, can be null
     * @param content
     *            the component to push as modal dialog
     */
    @Override
