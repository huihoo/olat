...
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.FileElementImpl;
...
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.FormToggleImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.IntegerElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.JSDateChooser;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.MultiSelectionTree;
...
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.SpacerElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.StaticTextElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.TextAreaElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.TextBoxListElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.TextElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.RichTextElementImpl;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.table.FlexiTableDataModel;
import org.olat.presentation.framework.core.components.form.flexible.impl.elements.table.FlexiTableElementImpl;
...
public class FormUIFactory {
     ...
     * 
     * @param i18nLabel
     *            the i18n key to set the label, or <code>null</code> to disable the label.
     * @param fi
     */
     ...
     * @param cssClasses
     * @param columns
     *            Currently 1 and 2 columns are supported
     * @return
     */
     ...
     */
    public MultipleSelectionElement addCheckboxesVerticalWithTrustedText(String name, String i18nLabel, FormItemContainer formLayout, String[] keys,
            String values[], String[] cssClasses, int columns) {
        MultipleSelectionElementImpl mse = new MultipleSelectionElementImpl(name, MultipleSelectionElementImpl.createVerticalLayout(name, columns));
        mse.setTrustedText();
        mse.setKeysAndValues(keys, values, cssClasses);
        setLabelIfNotNull(i18nLabel, mse);
        formLayout.add(mse);
     ...
     * 
     * @param name
     *            item identifier and i18n key for the label
     * @param formLayout
     * @param theKeys
     *            the radio button keys
     * @param theValues
     *            the radio button display values
     * @return
     */
     ...
     * @param formLayout
     * @param theKeys
     *            the menu selection keys
     * @param theValues
     *            the menu display values
     * @param theCssClasses
     *            the css classes to style the menu items or NULL to use no special styling
     * @return
     */
     ...
     * @param name
     * @param labelKey
     *            i18n key for the label, may be <code>null</code> indicating no label.
     * @param formLayout
     * @param theKeys
     * @param theValues
     * @param theCssClasses
     ...
     */
    public StaticTextElement addStaticTextElementWithTrustedText(String name, String translatedText, FormItemContainer formLayout) {
        StaticTextElementImpl ste = (StaticTextElementImpl) addStaticTextElement(name, name, translatedText, formLayout);
        ste.setTrustedText();
        return ste;
    }
     ...
     * Creates a StaticTextElement with rendering information, that is the Renderer should not escape the translatedText.
     */
    public StaticTextElement addStaticTextElementWithTrustedText(String name, String i18nLabel, String translatedText, FormItemContainer formLayout) {
        StaticTextElementImpl ste = (StaticTextElementImpl) addStaticTextElement(name, i18nLabel, translatedText, formLayout);
        ste.setTrustedText();
        return ste;
    }
     ...
     * @param name
     * @param i18nLabel
     *            i18n key for label, null to disable
     * @param text
     * @param formLayout
     * @return
     */
     ...
     * @param name
     * @param i18nLabel
     *            i18n key for the label or null to set no label at all.
     * @param maxLen
     * @param rows
     *            the number of lines or -1 to use default value
     * @param cols
     *            the number of characters per line or -1 to use 100% of the available space
     * @param isAutoHeightEnabled
     *            true: element expands to fit content height, (max 100 lines); false: specified rows used
     * @param initialValue
     *            Initial value
     * @param formLayout
     * @return
     ...
     * @param rows
     *            The number of lines the editor should offer. Use -1 to indicate no specific height
     * @param cols
     *            The number of characters width the editor should offer. Use -1 to indicate no specific width
     * @param externalToolbar
     *            true: use an external toolbar that is only visible when the user clicks into the text area; false: use the static toolbar
     * @param formLayout
     ...
     *            true: use an external toolbar that is only visible when the user clicks into the text area; false: use the static toolbar
     * @param fullProfile
     *            false: load only the necessary plugins; true: load all plugins from the full profile
     * @param baseContainer
     *            The VFS container where to load resources from (images etc) or NULL to not allow embedding of media files at all
     * @param formLayout
     ...
     * 
     * @param name
     *            in velocity for <code>$r.render("name")</code>
     * @param translatedText
     *            already translated text that should be displayed.
     * @return
     */
     ...
     * 
     * @param name
     *            The name of the form element (identifyer), also used as i18n key
     * @param formLayout
     * @param presentation
     *            See Link.BUTTON etc
     * @return
    ...
    /**
     * @param name
     *            to be used to render in velocity <code>$r.render("name")</code>
     * @param i18nLink
     *            i18n key for the link text
     * @param i18nLabel
     *            i18n key for the link elements label, maybe <code>null</code>
     * @param formLayout
     *            FormLink is added as element here
     * @param presentation
     *            See Link.BUTTON etc.
     * @return
     */
     ...
     * 
     * @param name
     *            the name of the element (identifier), also used as i18n key
     * @param toggleText
     *            null if the i18n key should be used and translated, or a text to be on the toggle
     * @param formLayout
     * @param toggledOnCSS
     *            a special css class for the on state, or null for default
     * @param toggledOffCSS
     *            a special css class for the off state, or null for default
     * @return
     */
     ...
     * 
     * @param name
     *            the button name (identifyer) and at the same time the i18n key of the button
     * @param formItemContiner
     *            The container where to add the button
