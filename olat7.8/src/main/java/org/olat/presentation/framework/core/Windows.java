...
import org.olat.lms.commons.util.collection.FIFOMap;
...
import org.olat.presentation.framework.core.util.bandwidth.SlowBandWidthSimulatorImpl;
...
public class Windows implements Disposable {
    ...
    public SlowBandWidthSimulator getSlowBandWidthSimulator() {
        if (sbws == null)
            sbws = new SlowBandWidthSimulatorImpl();
        return sbws;
    }
