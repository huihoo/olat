...
import org.olat.presentation.framework.core.control.generic.spacesaver.ExpColController;
import org.olat.presentation.framework.core.control.winmgr.WindowBackOfficeImpl;
import org.olat.presentation.framework.core.control.winmgr.WindowManagerImpl;
...
public class DevelopmentController extends BasicController {
    ...
    protected void doDispose() {
        ...
        if (spacesaverController != null)
            spacesaverController.dispose();
        if (bandwithController != null)
            bandwithController.dispose();
    }
    ...
    private void dumpTree(StringOutput sb, Component current, int indent, Map<Controller, List<Component>> controllerInfos) {
        // add infos,
        Controller lController = Util.getListeningControllerFor(current);
        if (lController != null) {
