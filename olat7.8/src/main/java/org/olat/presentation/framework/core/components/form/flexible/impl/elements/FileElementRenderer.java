...
/**
 * <h3>Description:</h3> The file element renderer displays a file upload element for a single file. To make it more beauty, the standard file chooser button form the
 * browser is hidden and a fake button is displayed instead.
 * <p>
...
public class FileElementRenderer implements ComponentRenderer {
    ...
    public void render(Renderer renderer, StringOutput sb, Component source, URLBuilder ubu, Translator translator, RenderResult renderResult, String[] args) {
        ...
        Translator trans = PackageUtil.createPackageTranslator(FileElementRenderer.class, translator.getLocale(), translator);
        //
