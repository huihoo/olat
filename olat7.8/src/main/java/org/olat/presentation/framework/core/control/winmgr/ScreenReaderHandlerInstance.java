        ...
        return new ComponentRenderer() {
            ...
            public void render(Renderer renderer, StringOutput sb, Component source, URLBuilder ubu, Translator translator, RenderResult renderResult, String[] args) {
                ...
                if (source.isDomReplaceable() && source.isDirtyForUser() && isLargestDirty(source)) {
                    Translator trans = new PackageTranslator("org.olat.presentation.framework.core.control", I18nModule.getDefaultLocale());
                    Component parent = source.getParent();
                    while (trans == null) {
                        if (parent == null) {
                            // Ups, on top of component tree and still no translator found? Use default.
                            trans = new PackageTranslator("org.olat.presentation", I18nModule.getDefaultLocale());
                        } else {
