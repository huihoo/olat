...
/**
 * Description:<br>
 * This Controller creator can be used to instantiate an ActionExtension in olat_extensions.xml which uses a Factory to get a controller. Needed arguments: - factoryName
 * name of the factory class - factoryMethod Method to invoke on factory, should return a Controller
 * <P>
