...
package org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatsmileys;
...
public class OlatSmileysPlugin extends TinyMCECustomPlugin {
    ...
    /**
     * Creates a map for this plugin's parameters which can be read by the plugin's JavaScript code. NOTE: Theoretically, this should be happening inside the constructor
     * of this class, but this is not possible at the moment due to createStaticURIFor() depending on beans which aren't loaded yet at constructor time.
     * 
     */
    @Override
