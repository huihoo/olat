...
/**
 * One can send a message to the ChiefControllers which appears on top. Typically this is used for setting maintenance messages, such as <i>system is going down in 10
 * minutes</i>.
 * <p>
 * A ChiefController per se is not listening to such events. It must implement <code>GenericEventListener</code> and add itself to the channel which can be found in the
 * <code>ChiefControllerFactory</code>.
 * 
