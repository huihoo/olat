...
public class VelocityContainer extends Container {
     ...
     * 
     * @param componentName
     *            Name of component, displayed in debug mode
     * @param pagePath
     *            Full path to velocity page
     * @param trans
     *            Translator to be used
     * @param listeningController
     *            the listenenController; may be null if the caller has no need to register for events
     */
     ...
     * @param baseClass
     * @param pageName
     *            page name that is available within this base class package
     * @param trans
     *            Translator to be used
     * @param listeningController
     *            the listenenController; may be null if the caller has no need to register for events
    ...
    public VelocityContainer(String componentName, Class baseClass, String pageName, Translator trans, Controller listeningController) {
        this(componentName, PackageUtil.getPackageVelocityRoot(baseClass) + "/" + pageName + ".html", trans, listeningController);
    }
    ...
    /**
     * Add a variable to the velocity context. The methods of the objects accessed from the velocity file must be public. If not public you will get an error message in
     * the olat.log that the reference is not valid.
     * 
     * @param key
     * @param value
     */
     ...
     * <p>
     * put(component) will set the current translator on the component if the component itself does not yet have a translator set. The translator of the components can't
     * be modified afterwards.
     * <p>
     * This method overrides the protected setTranslator() method from the component interface and make it public to support workflows where the velocity container is
     * created in the constructor (e.g. FormBasicController) but the translator might be modified later (using some special fallback translator or such)
     * 
     * @param translator
