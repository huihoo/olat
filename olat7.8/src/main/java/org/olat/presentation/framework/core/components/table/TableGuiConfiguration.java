...
public class TableGuiConfiguration {
    ...
    /**
     * Constructor for a table gui configuration object. The constructor initializes the configuration with the default values
     */
     ...
     *            true: enable moving of table columns
     */
    ...
    /**
     * @return boolean true: use paging
     */
     ...
     *            true: use paging
     */
    public void setPageingEnabled(final boolean pagingEnabled) {
     ...
     *            the number of results diplayed per page
     */
     ...
     *            true: the selected row can't be selected anymore
     */
    ...
    /**
     * @param preferencesOffered
     *            true: table preferences are enabled
     * @param preferencesKey
     *            name of table preferences
     */
     ...
     *            Messaged displayed then table model is empty or null for default message
     */
    ...
    /**
     * @param cssPrefix
     *            the additional CSS class used when rendering the table
     */
