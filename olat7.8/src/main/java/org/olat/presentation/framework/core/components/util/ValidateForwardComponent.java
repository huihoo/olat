 ...
 * <p>
 */
package org.olat.presentation.framework.core.components.util;

import org.olat.presentation.framework.core.UserRequest;
import org.olat.presentation.framework.core.components.Component;
import org.olat.presentation.framework.core.components.ComponentRenderer;
import org.olat.presentation.framework.core.render.RenderUtil;
import org.olat.presentation.framework.core.render.ValidationResult;
import org.olat.presentation.framework.core.translator.Translator;

/**
 * Description:<br>
 * This component forwards any validate calls (which take place after dispatching, but prior to rendering) to the listening controller. Useful when the controller
 * received e.g. a model invalidation from the system even bus. Instead of immediately updating the model from the db or similar, which is expensive, the controller can
 * wait till it receives a validate event.<br>
 * This component does not render anything.<br>
 * the validate method is called just before the rendering of the -whole tree- takes place, so e.g. lazy fetching can be implemented, or issueing a request for a new
 * moduleUri (e.g. for CPComponent, so that the browser loads images correctly).<br>
