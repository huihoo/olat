            ...
            for (int i = 0; i < cnt; i++) {
                ...
                if (i != selPane && cnt > 1) {
                    if (tb.isEnabled(i)) {
                        ...
                        sb.append(" b_disabled\"><div><a href=\"#\" title=\"").append(StringHelper.escapeHtml(translator.translate("disabled"))).append("\">")
                                .append(tabName).append("</a></div></li>");
                    }
                } else {
