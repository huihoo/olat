...
public class IntegerElement extends TextElement {
    ...
    /**
     * Make sure you called isInteger prior to this method. Otherwhise the invalue is invalid and a runtime exception will be thrown
     * 
     * @return int
     */
    public int getIntvalue() {
        if (this.checked)
            ...
            throw new OLATRuntimeException(IntegerElement.class, "You must call isInteger() in the form validate method prior to calling getIntvalue!", null);
    }
