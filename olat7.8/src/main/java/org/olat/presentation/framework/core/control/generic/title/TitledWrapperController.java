...
package org.olat.presentation.framework.core.control.generic.title;
...
/**
 * Description:<br>
 * Wrapper controller to any controller for providing a title and a optional description to the child controller. The title consists of the contextTitle plus the item's
 * title.
 * <P>
...
public class TitledWrapperController extends BasicController implements CloneableController {
     ...
     * </ul>
     * Use the setter methods to modify these configuration or set special css classes
     * 
     * @param ureq
     * @param wControl
     * @param controller
    ...
    public TitledWrapperController(UserRequest ureq, WindowControl wControl, Controller controller, String wrapperCss, TitleInfo titleInfo) {
        ...
        if (StringHelper.containsNonWhitespace(titleInfo.getDescription())) {
            ...
            descriptionController = new ToggleBoxController(ureq, wControl, titleInfo.getPersistedId(), "  ", " ", descriptionContainer);
    ...
    /**
     * @param controller
     *            The new content controller or NULL
     */
    ...
    /**
     * @param contextTitle
     *            The optional context of the title.
     */
    ...
    /**
     * @param titleSize
     *            Size of the title. Use the static TitleInfo.TITLE_SIZE_H3 variables
     */
    ...
    /**
     * @param cssClass
     *            One or multiple CSS classes placed on the H element
     */
    ...
    /**
     * @param useSeparator
     *            true to set a HR element after the title, false to not use the HR element
     */
    private void setSeparatorEnabled(boolean useSeparator) {
