...
import org.olat.presentation.framework.core.control.dragdrop.DragAndDrop;
import org.olat.presentation.framework.core.control.dragdrop.DragAndDropImpl;
import org.olat.presentation.framework.core.control.dragdrop.DragSource;
import org.olat.presentation.framework.core.control.dragdrop.Draggable;
import org.olat.presentation.framework.core.control.dragdrop.DraggableCreator;
import org.olat.presentation.framework.core.control.dragdrop.DropEvent;
import org.olat.presentation.framework.core.control.dragdrop.DroppableImpl;
import org.olat.system.exception.AssertException;

/**
 * Description: <br>
 * The panel implements a place holder component with a stack to hold zero, one or more components. Only the highest component on the stack is shown.
 * 
 * @author Felix Jost
 */
public class Panel extends Container {
    ...
    /**
     * since the Panel does and shown nothing (is only a convenient boundary to put components into, and to swap them), we dispatch the request to the delegate
     * 
     * @param ureq
     */
    @Override
     ...
     * 
     * @param newContent
     *            the newContent. if null, then the panel will be empty
     */
    ...
    /**
     * @return Returns the dragAndDrop (it is created if it was null) as usual, all methods here are not threadsafe
     */
