...
/**
 * Radio buttons are static single selection elements that are rendered as a radio button group instead of a drop down list
 * <P>
...
public class RadioButtonGroupElement extends StaticSingleSelectionElement {
    ...
    /**
     * noLabel means, that there will be no decription text left of the radio buttons. You can use this in a scenario like this: Description StaticHTMLElement describes
     * something O ThisIsThe1stoption O ThisIsThe2ndOption O ThisIsThe3rdOption As you see, there is no second description since the HTML text already described
     * everything. Used e,g, in external page config form.
     */
    boolean noLabel;
    /**
    ...
    /**
     * @param noLabel
     *            Set to true if no description should be displayed.
     */
    ...
    /**
     * @param isAllowed
     *            Set this to true, if HTML should be displayed (and therefore not be escaped).
     */
