...
/**
 * This extends <code>Writer</code> only for the reason that must be used as parameter for <code>StringHelper.escapeHtml</code>.
 * 
 * @author Felix Jost
 */
public class StringOutput extends Writer {
    ...
    /**
     * @Override Writer's method, not used.
     */
    @Override
