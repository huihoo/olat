...
public class VelocityRenderDecorator {
    ...
    /**
     * @param prefix
     *            e.g. abc for "abc647547326" and so on
    ...
    public StringOutput contextHelp(String packageName, String pageName, String hoverTextKey) {
        ...
        if (ContextHelpModule.isContextHelpEnabled()) {
            ...
            if (hooverText != null)
                hooverText = StringEscapeUtils.escapeHtml(hooverText).toString();
     ...
     *            The translation key
     * @param arg1
     *            The argument list as a string array
     * @return
     */
     ...
     *            The translation key
     * @param arg1
     *            The argument list as a list of strings
     ...
     * 
     * @param bundleName
     *            the package name, e.g. 'org.olat.presentation'
     * @param key
     *            the key, e.g. 'my.key'
     * @param args
     *            optional arguments, null if not used
     * @return
     */
    ...
    /**
     * Method to translate a key that comes from another package. This should be used rarely. When a key is used within multiple packages is is usually better to use a
     * fallback translator or to move the key to the default packages.
     * 
     * @param bundleName
     *            the package name, e.g. 'org.olat.presentation'
    ...
    public String filterXSS(String str) {
        try {
            return FilterFactory.filterXSS(str);
        } catch (Exception e) {
            LOG.error("XSS filtering of " + str + " failed because of: ", e);
        }
        return "";
    }
     ...
     * @param wikiMarkupString
     *            The original string written in radeox markup
