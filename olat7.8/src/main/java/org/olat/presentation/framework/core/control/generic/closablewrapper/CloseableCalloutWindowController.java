...
public class CloseableCalloutWindowController extends BasicController {
     ...
     *            The component that should be displayed in the callout window
     * @param targetLink
     *            The link which the callout should popup from. The link object is not used to catch any events, it only used to get the DOM ID of the link for rendering
     *            purpose.
     */
    ...
    public void setDOMTarget(String targetDomID) {
        if (targetDomID == null)
            throw new OLATRuntimeException("Can not set NULL as target DOM ID", null);
        if (calloutVC != null) {
