...
public class LinkFactory {
     ...
     * 
     * @param vc
     *            the VelocityContainer within you put this link
     ...
     * 
     * @param title
     *            - displayed on hovering over the icon - can be null, then no title is displayed
     * @param vc
     * @param listeningController
     ...
     * 
     * @param one
     *            string for name of component, command and i18n key
     * @param vc
     *            the VelocityContainer within you put this link
     * @param listeningController
     * @return the link component
     ...
     * @param cmd
     *            command, null or empty string are not allowed
     * @param key
     *            if it's already translated, use at the next parameter Link.NONTRANSLATED, null is allowed
     * @param presentation
     * @param vc
     *            the VelocityContainer within you put this link
     * @param listeningController
     ...
     * @return the link component
     */
    public static Link createButton(String name, String key, VelocityContainer vc, Controller listeningController) {
        return new Link(name, name, key, Link.BUTTON, vc, listeningController);
    }
