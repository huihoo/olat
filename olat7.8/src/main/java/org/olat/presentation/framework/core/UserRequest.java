...
public class UserRequest {
    ...
    public UserSession getUserSession() {
        ...
        if (result == null) {
            log.warn("getUserSession: null , this=" + this);
        }
        return result;
    }
    ...
    private void parseRequest(HttpServletRequest hreq) {
        ...
        if (nextSlash + 1 < nonParsedUri.length()) {
            ...
            if (moduleURI.indexOf("../") != -1)
                throw new AssertException("a non-normalized url encountered " + moduleURI);
        }
    }
