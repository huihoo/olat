...
public interface RichTextElement extends TextElement {
    ...
    /**
     * Get the raw value of the text element as submitted by the user. Be aware that this method does NOT filter against XSS attacks! Use this only when you manually
     * check for XSS attacks or you allow users at this point to add unsave data including javascript code.
     * 
     * @return
     */
    ...
    /**
     * If the rich text element is shown in an ExtJS component. It need an extra delay to be correctly rendered (a problem appears the second time a rich text is used in
     * an ExtJS window). This is an hack before a better solution.
     * 
     * @param extDelay
     */
