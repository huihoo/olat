...
public class RatingComponent extends Component {
     ...
     *            the current rating
     * @param maxRating
     *            maximum number that can be rated
    ...
    public RatingComponent(String name, float currentRating, int maxRating, boolean allowUserInput) {
        ...
        if (allowUserInput)
            this.explanation = "rating.explanation";
        else
    ...
    public String getRatingLabel(int position) {
        if (position >= ratingLabels.size()) {
            throw new AssertException("Can not get rating at position::" + position + " in rating array of size::" + ratingLabels.size() + " in component::"
                    + getComponentName());
        }
    ...
    public void setLevelLabel(int position, String ratingLabel) {
        if (position >= ratingLabels.size()) {
            throw new AssertException("Can not set rating at position::" + position + " in rating array of size::" + ratingLabels.size() + " in component::"
                    + getComponentName());
        }
