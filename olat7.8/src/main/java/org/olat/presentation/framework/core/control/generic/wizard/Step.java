...
public interface Step {
    /**
     * defines the no-op step, e.q. this should be used in the case where nextStep has to say -> sorry no more steps available. The NOSTEP is to be used instead of
     * <code>null</code>
     */
    ...
    /**
     * descriptive and short title of input mask or info mask presented by this step. i.e. Choose colors, Review Changes, Send E-Mail.
     * 
     * @return
     */
    public FormItem getStepTitle();
