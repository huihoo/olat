...
function updatePreview() {
    ...
    //no script element allowed
    if(latexCode.toLowerCase().indexOf("<script>")==-1 && latexCode.toLowerCase().indexOf("</script>")==-1) {
...
function copyPreviewToScreen() {
    ...
    if (offscreenPreview.down() != null) {
        ...
        // We have nothing, and we do not allow to add script elements to the preview.
        preview.update("");    	
    }
}
