...
/**
 * Description:<br>
 * A Panel which shows a certain content only one render time, and then is hidden until a new content is set. useful for e.g. a message on the screen which should
 * automatically disappear after having been rendered once until a new message appears.
 * <P>
