...
public class DownloadComponent extends Component {
     ...
     *            an optional css icon class. Note that b_with_small_icon_left will be added when this argument is used. Use the render argument when you want to provide
    ...
    /**
     * @param linkCssIconClass
     *            The link icon css class or NULL if no css should be used. Note that b_with_small_icon_left will be added when this argument is used. Use the render
