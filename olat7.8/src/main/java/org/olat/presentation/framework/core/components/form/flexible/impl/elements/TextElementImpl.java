...
import org.olat.presentation.framework.core.components.form.flexible.elements.InlineTextElement;
...
public class TextElementImpl extends AbstractTextElement implements InlineTextElement {
    ...
    /**
     * InlineElementComponent an renderer.
     */
    private void initInlineEditing(String predefinedValue) {
        ...
        AbstractInlineElementComponent aiec = new AbstractInlineElementComponent(this, new ComponentRenderer() {
            ...
            public void render(Renderer renderer, StringOutput sb, Component source, URLBuilder ubu, Translator translator, RenderResult renderResult, String[] args) {
                ...
                inputAsAttributeValue = StringHelper.escapeHtmlAttribute(tmpVal);
                ...
                if (!itei.isEnabled()) {
                    ...
                    if (itei.isInlineEditingOn()) {
                        ...
                        // }
                        sb.append("\" value=\"");
                        sb.append(inputAsAttributeValue);
                        sb.append("\" ");
                        sb.append(" />");
                        ...
                        FormJSHelper.getInlineEditOkCancelJS(sb, id, getSafeJavascriptData(getValue()), itei.getRootForm());
    ...
    private String getSafeJavascriptData(String str) {
    ...
    public void setTranslator(Translator translator) {
        ...
        Translator elmTranslator = PackageUtil.createPackageTranslator(TextElementImpl.class, translator.getLocale(), translator);
