...
package org.olat.presentation.framework.core.components.link;
...
/**
 * Description: Renders the link component depending of features and style. Use {@link LinkFactory} to create {@link Link} objects.
 */
public class LinkRenderer implements ComponentRenderer {
    ...
    public void render(Renderer renderer, StringOutput sb, Component source, URLBuilder ubu, Translator translator, RenderResult renderResult, String[] args) {
        ...
        if (title != null) {
            // title is used as attribute value
            title = StringHelper.escapeHtmlAttribute(title);
        }
        String customDisplayText = link.getCustomDisplayText();
        customDisplayText = StringHelper.escapeHtml(customDisplayText);
        ...
        if (link.isEnabled()) {
            ...
            if (flexiformlink) {
                ...
                ubu.buildURI(sb, new String[] { VelocityContainer.COMMAND_ID }, new String[] { command }, iframePostEnabled ? AJAXFlags.MODE_TOBGIFRAME
                ...
                if (nontranslated && link.hasTooltip && link.getCustomDisplayText() == null) {
                    if (nontranslated) {
                        ...
                        sb.append(" ext:qtip=\"").append(StringHelper.escapeHtmlAttribute(translator.translate(title))).append("\"");
                    }
                }
            }
            ...
            if (title != null) {
                if (!link.hasTooltip) {
                    ...
                    if (nontranslated) {
                        ...
                        sb.append(StringHelper.escapeHtmlAttribute(translator.translate(title))).append("\"");
                    }
                }
            ...
            /**
             * TODO:gs:b may be usefull as well this binds the event to the function call as argument, usefull if event is needed Event.observe("id", "click",
             * functionName.bindAsEventListener(this));
             */
