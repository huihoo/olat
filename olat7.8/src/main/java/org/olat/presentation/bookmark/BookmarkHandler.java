...
/**
 * Description:<br>
 * The bookmark launch handler implements the launching code of a bookmark. The handler must check if the given bookmark must be handled by this handler. It must only
 * launch bookmarks that are launchable by this handler.
 * <P>
...
public interface BookmarkHandler {
     ...
     * 
     * @param bookmark
     *            The bookmark to be launched
     * @param ureq
     *            . The current user request
     * @param wControl
     *            The current window control
     * @return TRUE: this handler was responsible for launching this bookmark. Note that the launching process could have failed e.g. because the bookmark resource does
     *         not exist anymore. FALSE: this handler is not responsible for this bookmark, another handler should try it.
     */
     ...
     */
    public String createJumpInURL(Bookmark bookmark) throws WrongBookmarkHandlerException;
