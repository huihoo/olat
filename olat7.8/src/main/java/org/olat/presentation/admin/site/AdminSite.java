...
package org.olat.presentation.admin.site;
...
public class AdminSite implements SiteInstance {
	 ...
	 * 
	 */
    public AdminSite(final Locale loc) {
    ...
    public MainLayoutController createController(final UserRequest ureq, final WindowControl wControl) {
        final MainLayoutController c = ControllerFactory.createLaunchController(ORES_OLATADMINS, null, ureq, wControl, true);
        return c;
    }
