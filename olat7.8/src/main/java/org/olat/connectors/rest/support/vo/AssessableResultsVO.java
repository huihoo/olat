...
/**
 * Value object representing an individual user's results on an {@link org.olat.lms.course.nodes.AssessableCourseNode}.
 * 
...
public class AssessableResultsVO {
    ...
    public void setResults(final Map<Long, String> results) {
