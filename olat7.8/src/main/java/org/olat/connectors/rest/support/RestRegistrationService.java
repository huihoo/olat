...
/**
 * Description:<br>
 * This service configure the REST Api and give the list of singletons, classes for resource, web services and providers and the list of types for the standard context
 * resolver (mapping xml, json to java objects). All this configuration MUST be done before the REST Servlet starts. After are all configurations needless.
 * <P>
