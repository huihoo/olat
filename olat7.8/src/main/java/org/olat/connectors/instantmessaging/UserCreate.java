...
public class UserCreate extends IQ {
	 ...
	 * 
	 */
    public UserCreate(final String username, final String password, final String email, final String fullname) {
        this.username = username;
        this.password = password;
        this.fullname = StringHelper.escapeXml(fullname);
        this.email = email;
        setType(IQ.Type.SET);
    }
    ...
    public static class Provider implements IQProvider {
        ...
        public IQ parseIQ(final XmlPullParser parser) throws Exception {
            ...
            final UserCreate creator = new UserCreate();
            boolean done = false;
            while (!done) {
