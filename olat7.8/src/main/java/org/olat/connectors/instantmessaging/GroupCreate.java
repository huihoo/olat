...
public class GroupCreate extends IQ {
     ...
     */
    public GroupCreate(final String groupId, final String groupname, final String description) {
        this.groupId = groupId;
        this.groupname = StringHelper.escapeXml(groupname);
        this.description = StringHelper.escapeXml(description);
        setType(IQ.Type.SET);
    }
    ...
    public void setCreated(final boolean success) {
    ...
    public static class Provider implements IQProvider {
        ...
        public IQ parseIQ(final XmlPullParser parser) throws Exception {
            ...
            final GroupCreate creator = new GroupCreate();
            boolean done = false;
            while (!done) {
