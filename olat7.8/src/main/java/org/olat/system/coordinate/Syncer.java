...
public interface Syncer {
     ...
     * 
     * @param ores
     *            the resourceable to sync upon
     * @param action
     *            the code to be executed in the protected region (it is executed synchronously, that is, within the same thread as the caller of this method)
