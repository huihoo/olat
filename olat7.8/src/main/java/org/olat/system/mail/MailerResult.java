...
public class MailerResult {
    ...
    private List<OLATPrincipal> failedIdentites = new ArrayList<OLATPrincipal>();
    private int returnCode = OK;

    /**
     * @return list of identities to which the mail could not be send, e.g. because of an invalid mail address
     */
    public List<OLATPrincipal> getFailedIdentites() {
    ...
    /**
     * Package helper to add an identity to which for whatever reason the mail could not be sent
     * 
     * @param failedIdentity
     */
    void addFailedIdentites(OLATPrincipal failedIdentity) {
