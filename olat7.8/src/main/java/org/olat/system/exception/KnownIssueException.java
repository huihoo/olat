 ...
 * <p>
 * When this exception ends up in a log file, we can then treat this case as a known issue and not let a test fail because of this - plus we have a jira number which
 * should speed up error analysis.
 * 
 * @author Stefan
 */
public class KnownIssueException extends OLATRuntimeException {
     ...
     * Deprecated because is a BAD idea to hide the original exception.
     * 
     * @param logMsg
     */
    @Deprecated
    private KnownIssueException(String logMsg, int jiraNumber) {
    ...
    /**
     * convenience method to retrieve html fragment with link to jira e.g. <a href="http://bugs.olat.org/jira/browse/OLAT-XXXX">OLAT-XXXX</a>
     * 
     * @return
     */
