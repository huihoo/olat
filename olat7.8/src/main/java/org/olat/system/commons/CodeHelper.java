...
public class CodeHelper {
    ...
    public static String getForeverUniqueIDFromGlobalForeverUniqueID(String globalForeverUniqueID) {
        return globalForeverUniqueID.substring(globalForeverUniqueID.lastIndexOf("_") + 1);
    }
}
