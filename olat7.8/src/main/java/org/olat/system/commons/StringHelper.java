...
public class StringHelper {
     ...
     * 
     * @param m
     *            The (hash) map with the key and values
    ...
    /**
     * replaces all newlines and carriage returns with <code> <br/></code> <br/>
     * on windows: \r\n <br/>
     * on linux: \n <br/>
     */
    public static String convertLineBreaksToHTML(String plainText) {
        if (plainText != null && plainText.indexOf("\n") != -1) {
    ...
    /**
     * Wraps whatever external library we are using for "output escaping" <br>
     * 
     * @param str
