...
/**
 * The StatisticUpdateManager is a pod for registering all IStatisticUpdaters and all it does is going through each of the IStatisticUpdaters to call its updateStatistic
 * method.
 * <P>
...
public interface StatisticUpdateService {
     ...
     * 
     * @param updater
     *            the updater to be added to this StatisticUpdateManager
     */
    public void addStatisticUpdater(StatisticUpdaterDao updater);
     ...
     * 
     * @return whether or not the update could be started (returns false when this manager is not enabled or when an update is already ongoing)
     */
