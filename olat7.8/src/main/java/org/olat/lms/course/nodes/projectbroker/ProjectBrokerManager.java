...
public interface ProjectBrokerManager extends DeletableGroupData {
     ...
     * @return
     */
    public boolean enrollProjectParticipant(Identity identity, Project projectAt, ProjectBrokerModuleConfiguration moduleConfig, int nbrSelectedProjects,
     ...
     * @param project
     * @param deleteGroup
     *            true: project group will be deleted too
     * @param courseEnv
     * @param cNode
     */
     ...
     * @return
     */
    public boolean canBeProjectSelectedBy(Identity identity, Project project, ProjectBrokerModuleConfiguration moduleConfig, int nbrSelectedProjects,
            boolean isParticipantInAnyProject);
     ...
     * @param projectBrokerId
     */
    public void signOutFromAllCandidateLists(List<Identity> chosenIdentities, Long projectBrokerId);

    /**
     * Get the state [STATE_ASSIGNED_ACCOUNT_MANAGER | STATE_NOT_ASSIGNED_ACCOUNT_MANAGER | STATE_NOT_ASSIGNED_ACCOUNT_MANAGER_NO_CANDIDATE | STATE_FINAL_ENROLLED |
    ...
    /**
     * Get attachment-file relative path. E.g. course/<COURSE_ID>/projectbroker_attach/<COURSE_NODE>/<PROJECT_ID>
     * 
     * @param project
     * @param courseEnv
     * @param courseNode
    ...
    /**
     * Get attachment-folder relative path (without project-id). THis path can be used to delete all attachment-file for certain project-broker. E.g.
     * course/<COURSE_ID>/projectbroker_attach/<COURSE_NODE>
     * 
     * @param courseEnvironment
     * @param courseNode
     * @return
     ...
     * @return
     */
    public String getDropboxBasePathForProject(Project project, CourseEnvironment courseEnvironment, CourseNode node);
     ...
     */
    public String getReturnboxBasePathForProject(Project project, CourseEnvironment courseEnv, CourseNode node);
    ...
    public boolean isDropboxAccessible(Project project, ProjectBrokerModuleConfiguration moduleConfig);

    List<Project> findProjectsForGoup(Long groupId);

    List<Identity> getTopicTutors(Project project, UserCourseEnvironment userCourseEnv);
