...
public class IsUserFunction extends AbstractFunction {
     ...
     * @param userCourseEnv
     */
    public IsUserFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
    ...
    public Object call(final Object[] inStack) {/*
        ...
        if (!(inStack[0] instanceof String)) {
            return handleException(new ArgumentParseException(ArgumentParseException.WRONG_ARGUMENT_FORMAT, name, "", "error.argtype.username",
                    "solution.example.name.infunction"));
        }
        final String userName = (String) inStack[0];
        /*
