...
public interface CourseConfigManager {
    ...
    /**
     * Delete the configuration for a given course, this means removing it from the persistent area. It is used as part of the course removing operation. Furthermore in
     * connection with a <code>loadConfigFor(...)</code> it can be used to recreate a default <code>CourseConfig</code>.
     * 
     * @param course
     */
    ...
    /**
     * Load the configuration of course. If the configuration is not existing, a new default course configuration is created, initialized with default values and
     * persisted. Otherwise the configuration is loaded from the file system. If the <code>CourseConfig</code>'s version does not match the loaded configuration version a
     * procedure for converting/migrating to the new version is initiated.
     * 
     * @param course
