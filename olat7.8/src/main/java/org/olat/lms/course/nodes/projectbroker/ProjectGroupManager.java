...
public interface ProjectGroupManager {
     ...
     * @param identity
     */
    public abstract BusinessGroup getAccountManagerGroupFor(CoursePropertyManager cpm, CourseNode courseNode, ICourse course, String groupName, String groupDescription,
            Identity identity);
     ...
     * 
     * @param projectGroup
     *            Change name and description of this group
     * @param initialGroupName
     *            New group-name, if the group name already exists, append a number e.g. ' _2' for uniqueness
     * @param groupDescription
     ...
     *            Identity who did the action
     * @param autoSignOut
     * @param isAcceptSelectionManually
     * @return list of accepted candidates (not all may have been accepted due to technical problems, synchronized processes etc.)
     */
    public List<Identity> acceptCandidates(List<Identity> identities, Project project, Identity actionIdentity, boolean autoSignOut, boolean isAcceptSelectionManually);
    ...
    /**
     * Check if a certain identity has the role of project-manager for certain project. Project-managers can edit, delete there projects. They can manage participants.
