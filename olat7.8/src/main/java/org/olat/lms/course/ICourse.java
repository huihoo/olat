...
public interface ICourse extends OLATResourceable {
    ...
    /**
     * @return the container to the coursefolder of this course (e.g. "COURSEBASEPATH/coursefolder/") including containers of course elements "Folder" (listed under
     *         subfolder '_courseelementdata')
     */
    public VFSContainer getCourseFolderContainer();

    /**
     * @see http://bugs.olat.org/jira/browse/OLAT-3026
     * @return the container to the coursefolder (and ONLY the course folder itself) of this course
     */
