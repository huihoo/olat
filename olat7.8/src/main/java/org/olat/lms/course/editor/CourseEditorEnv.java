...
public interface CourseEditorEnv {
    ...
    /**
     * validates the condition expression within the condition interpreter. If the condition expression is syntactically and semantically correct the method returns true,
     * false otherwise.<BR>
     * </BR> The valid soft references found are accessible via the condition expression, and also the complete error summary for the condition expression.
     * 
     * @param condExpr
     * @return
     */
    ...
    /**
     * The specified visibility, accessability and score rules defined for a course node reference other couse nodes ids. This references together with the course tree
     * structure build a directed graph. An important precondition for publishing changes is the cycle freeness of this directed graph.
     * 
     * @return
     */
    ...
    public Long getRepositoryEntryId(); // used for building BusinessPathToCourse
