...
public class Condition implements Serializable, Cloneable {
     ...
     * @param string
     */
    public void setConditionExpression(final String string) {
        condition = string;
    }
    ...
    /**
     * @param easyModeBeginDate
     *            The easyModeBeginDate to set.
     */
    public void setEasyModeBeginDate(final String easyModeBeginDate) {
        if (easyModeBeginDate != null && easyModeBeginDate.equals("")) {
            this.easyModeBeginDate = null;
        } else {
            this.easyModeBeginDate = easyModeBeginDate;
        }
    }
    ...
    /**
     * @param easyModeEndDate
     *            The easyModeEndDate to set.
     */
    public void setEasyModeEndDate(final String easyModeEndDate) {
        if (easyModeEndDate != null && easyModeEndDate.equals("")) {
            this.easyModeEndDate = null;
        } else {
            this.easyModeEndDate = easyModeEndDate;
        }
    }
    ...
    /**
     * @param easyModeGroupAccess
     *            The easyModeGroupAccess to set.
     */
    public void setEasyModeGroupAccess(final String easyModeGroupAccess) {
        if (easyModeGroupAccess != null && easyModeGroupAccess.equals("")) {
            this.easyModeGroupAccess = null;
        } else {
            this.easyModeGroupAccess = easyModeGroupAccess;
        }
    }
    ...
    /**
     * @param easyModeGroupAreaAccess
     *            The easyModeGroupAreaAccess to set.
     */
    public void setEasyModeGroupAreaAccess(final String easyModeGroupAreaAccess) {
        if (easyModeGroupAreaAccess != null && easyModeGroupAreaAccess.equals("")) {
            this.easyModeGroupAreaAccess = null;
        } else {
            this.easyModeGroupAreaAccess = easyModeGroupAreaAccess;
        }
    }
    ...
    /**
     * @param easyModeCoachesAndAdmins
     *            true: access only for coaches and admins
     */
    public void setEasyModeCoachesAndAdmins(final boolean easyModeCoachesAndAdmins) {
     ...
     */
    public void setEasyModeAlwaysAllowCoachesAndAdmins(final boolean easyModeAlwaysAllowCoachesAndAdmins) {
     ...
     */
    public void setEasyModeNodePassedId(final String easyModeNodePassedId) {
     ...
     */
    public void setEasyModeCutValue(final String easyModeCutValue) {
    ...
    public String getConditionFromEasyModeConfiguration() {
        ...
        if (getEasyModeGroupAccess() != null) {
            ...
            final String[] groups = getEasyModeGroupAccess().split(",");
            if (groups.length > 1) {
                sb.append("(");
            }
        ...
        if (getEasyModeGroupAreaAccess() != null) {
            ...
            final String[] areas = getEasyModeGroupAreaAccess().split(",");
            if (areas.length > 1) {
                sb.append("(");
            }
        ...
        if (attributeConditions != null) {
            ...
            for (final ExtendedCondition ec : attributeConditions) {
                if (extNeedsConnector) {
                    sb.append((attributeconditionsConnectorIsAND) ? " & " : " | ");
                } else {
                    extNeedsConnector = true;
                }
    ...
    public void setConditionId(final String condId) {
        conditionId = condId;
    }
    ...
    protected Object clone() {
        try {
            final Condition retVal = (Condition) super.clone();
            ...
            throw new AssertException("could not clone condition " + this, e);
        }
    }
     ...
     */
    public void setAttributeConditions(final List<ExtendedCondition> extendedConditions) {
    ...
    /**
     * @param conditionsConnectorIsAND
     *            Set to true, if the conditions connector is AND, to false otherwise.
     */
    public void setAttributeConditionsConnectorIsAND(final Boolean conditionsConnectorIsAND) {
