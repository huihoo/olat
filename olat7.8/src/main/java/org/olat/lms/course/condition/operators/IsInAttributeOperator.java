 ...
 */
public class IsInAttributeOperator extends AbstractOperator {

    public transient final String OPERATOR = "isInAttribute";
    public transient final String OPERATORKEY = "isin";
    public transient final String DISPLAY = "operator.isInAttribute";
