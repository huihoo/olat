...
/**
 * Special condition-interpreter for assessment tool group- / course-structure-selection. This condition-interpreter evalute only group conditions and insert dummy
 * function for all other conditions.
 * 
...
public class OnlyGroupConditionInterpreter extends ConditionInterpreter {
     ...
     * @param userCourseEnv
     */
    public OnlyGroupConditionInterpreter(final UserCourseEnvironment userCourseEnv) {
        super();
        uce = userCourseEnv;
        //
...
class DummyBooleanFunction extends AbstractFunction {
    ...
    public DummyBooleanFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
...
class DummyDateFunction extends AbstractFunction {
    ...
    public DummyDateFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
...
class DummyDoubleFunction extends AbstractFunction {
    ...
    public DummyDoubleFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
...
class DummyIntegerFunction extends AbstractFunction {
    ...
    public DummyIntegerFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
...
class DummyStringFunction extends AbstractFunction {
    ...
    public DummyStringFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
...
class DummyVariable extends AbstractVariable {
     ...
     * @param userCourseEnv
     */
    public DummyVariable(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
