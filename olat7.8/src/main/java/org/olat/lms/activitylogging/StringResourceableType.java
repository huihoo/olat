 ...
 * assessmentID. In the latter case we do not have an OlatResourceable at the time where the LoggingResourceable is added to the IUserActivityLogger - otherwise it would
 * be preferable to add an OlatResourceable always.
 * <p>
...
public enum StringResourceableType implements ILoggingResourceableType {
    ...
    /** the param part of the URI during a QTI test - equivalent to what was passed to IQDisplayController.log.audit before **/
    qtiParams,
