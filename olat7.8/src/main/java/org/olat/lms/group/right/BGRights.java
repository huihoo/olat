...
/**
 * Description:<BR>
 * Generic callback interface to get a list of all available rights and a translator that can translate the keys stored in the list to internationalized strings.
 * <P>
