...
public class BusinessGroupAddResponse {
    ...
    private final List<Identity> addedIdentities;
    /* Output-list of Identity which are already in group */
    private final List<Identity> identitiesAlreadyInGroup;
    /* Output-list of Identity which are added */
    private final List<Identity> identitiesWithoutPermission;
