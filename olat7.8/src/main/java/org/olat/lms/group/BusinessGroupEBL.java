...
public class BusinessGroupEBL {
     ...
     * @return
     */
    public boolean deleteBuddyGroup(Identity identity, BusinessGroup businessGroup, String ownersListTitle, String participantsListTitle) {
        ...
        businessGroupService.deleteBusinessGroupWithMail(businessGroup, everybody, identity);
        return true;
    }
