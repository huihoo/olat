...
/**
 * Contains the info for sending a confirmation about an action regarding topic managers group (add, remove topic manager) <br/>
 * 
 * Initial Date: Oct 30, 2012 <br>
 * 
 * @author Branislav Balaz
 */
public class TopicManagerGroupConfirmationInfo extends TopicGroupConfirmationInfo {

    private TopicManagerGroupConfirmationInfo(GROUP_CONFIRMATION_TYPE groupConfirmationType, List<RecipientInfo> allRecipientInfos, Identity originatorIdentity,
    ...
    public static TopicManagerGroupConfirmationInfo createTopicManagerGroupConfirmationInfo(GROUP_CONFIRMATION_TYPE groupConfirmationType,
        ...
        return new TopicManagerGroupConfirmationInfo(groupConfirmationType, allRecipientInfos, originatorIdentity, courseName, courseRepositoryEntryId, dateTime,
