...
public interface QTIItemObject {
    ...
    /**
     * R - stands for Radio Button (SCQ) C - stands for Check box (MCQ odr K-Prim) B - stands for Blank (FIB) A - stands for Area (ESS)
     */
    ...
    /**
     * @return String --> "R" Radio Button (SCQ) --> "C" Check box (MCQ odr K-Prim) --> "B" Blank (FIB) --> "A" Area (ESS)
     */
    public TYPE getItemType();

    /**
     * @return response_label or response_str ident: - in case of ItemWithResponseStr --> response_str ident - in case of ItemWithResponseLid --> response_label ident
     */
