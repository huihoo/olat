...
public interface ItemInput {
    ...
    /**
     * returns a List of Strings with the corresponding answers, e.g. for a multiple choice with multiple response it could be mr01 = { "A", "C", "D"} if the user chose
     * a,c, and d from the five answers with values a,b,c,d,e,f
     * 
     * @param varName
