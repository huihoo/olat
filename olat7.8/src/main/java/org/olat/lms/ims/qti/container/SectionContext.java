...
import org.olat.lms.ims.qti.container.qtielements.SectionFeedback;
...
public class SectionContext implements Serializable {
    ...
    public void setUp(AssessmentInstance assessInstance, Element el_section, Switches sw) {
        ...
        // ----------------------- selection
        List<Element> el_items = new ArrayList<Element>();
     ...
     * 
     * @param currentItemContextPos
     *            The currentItemContextPos to set
     */
