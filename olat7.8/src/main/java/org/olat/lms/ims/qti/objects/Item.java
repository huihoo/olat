 ...
 * @author rkulow
 */
public class Item implements QTIObject, UsedByXstream {
    ...
    public void addToElement(final Element root) {
        ...
        // OBJECTIVES
        QTIEditHelperEBL.addObjectives(item, objectives);
     ...
     * 
     * @param itempostconditions
     *            The itempostconditions to set
     */
     ...
     * 
     * @param itempreconditions
     *            The itempreconditions to set
     */
