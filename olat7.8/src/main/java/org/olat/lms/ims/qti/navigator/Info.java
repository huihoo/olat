...
public class Info implements Serializable {
     ...
     * 
     * @param renderItems
     *            The renderItems to set
     */
    public void setRenderItems(final boolean renderItems) {
     ...
     *            The feedback to set
     */
    public void setFeedback(final boolean itemfeedback) {
     ...
     *            The solution to set
     */
    public void setSolution(final boolean solution) {
     ...
     * 
     * @param currentOutput
     *            The currentOutput to set
     */
    public void setCurrentOutput(final Output currentOutput) {
