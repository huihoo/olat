...
import org.olat.lms.ims.qti.container.qtielements.AssessFeedback;
...
public class AssessmentContext implements Serializable {
     ...
     * 
     * @param currentSectionPos
     *            The currentSectionPos to set
     */
    public void setCurrentSectionPos(int currentSectionPos) {
        if (currentSectionPos >= sectionContexts.size()) {
