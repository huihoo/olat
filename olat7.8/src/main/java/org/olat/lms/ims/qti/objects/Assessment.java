 ...
 * @author rkulow
 */
public class Assessment implements QTIObject, UsedByXstream {
    ...
    public void addToElement(final Element root) {
        ...
        // OBJECTIVES
        QTIEditHelperEBL.addObjectives(assessment, objectives);
     ...
     * 
     * @param assessmentcontrols
     *            The assessmentcontrols to set
     */
     ...
     * 
     * @param assessfeedbacks
     *            The assessfeedbacks to set
     */
     ...
     * 
     * @param assessproc_extension
     *            The assessproc_extension to set
     */
    ...
    public boolean containsEssayQuestions() {
        for (final Iterator<Section> i = this.sections.iterator(); i.hasNext();) {
