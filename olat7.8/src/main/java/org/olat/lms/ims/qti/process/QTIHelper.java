...
import org.olat.lms.ims.qti.process.elements.BooleanEvaluable;
import org.olat.lms.ims.qti.process.elements.ExpressionBuilder;
import org.olat.lms.ims.qti.process.elements.QTI_and;
import org.olat.lms.ims.qti.process.elements.QTI_item;
import org.olat.lms.ims.qti.process.elements.QTI_not;
import org.olat.lms.ims.qti.process.elements.QTI_or;
import org.olat.lms.ims.qti.process.elements.QTI_other;
import org.olat.lms.ims.qti.process.elements.QTI_respcondition;
import org.olat.lms.ims.qti.process.elements.QTI_resprocessing;
import org.olat.lms.ims.qti.process.elements.QTI_varequal;
import org.olat.lms.ims.qti.process.elements.QTI_vargt;
import org.olat.lms.ims.qti.process.elements.QTI_vargte;
import org.olat.lms.ims.qti.process.elements.QTI_varinside;
import org.olat.lms.ims.qti.process.elements.QTI_varlt;
import org.olat.lms.ims.qti.process.elements.QTI_varlte;
import org.olat.lms.ims.qti.process.elements.ScoreBooleanEvaluable;
import org.olat.lms.ims.qti.process.elements.section.QTI_and_selection;
import org.olat.lms.ims.qti.process.elements.section.QTI_and_test;
import org.olat.lms.ims.qti.process.elements.section.QTI_not_selection;
import org.olat.lms.ims.qti.process.elements.section.QTI_not_test;
import org.olat.lms.ims.qti.process.elements.section.QTI_or_selection;
import org.olat.lms.ims.qti.process.elements.section.QTI_or_test;
import org.olat.lms.ims.qti.process.elements.section.QTI_selection_metadata;
import org.olat.lms.ims.qti.process.elements.section.QTI_variable_test;
...
public class QTIHelper {
    ...
    public static Document getDocument(final LocalFileImpl pathToXml) {
        ...
        if (tuple != null && ((Long) tuple[0]).compareTo(lmf) == 0) {
            ...
            log.info("Audit:Document Cache Hit for [[" + key + "]]");
            if (log.isDebugEnabled()) {
            ...
            log.info("Audit:load , parse and cache Document for [[" + key + "]]");
    ...
    private static Document getDocument(final InputStream is) {
        ...
        try {
            ...
            log.error("Error while parsing QTI xml file!", e);
            doc = null;
        } finally {
            try {
                if (is != null) {
