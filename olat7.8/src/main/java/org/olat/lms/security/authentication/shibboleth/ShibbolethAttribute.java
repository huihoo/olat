...
public final class ShibbolethAttribute {
    ...
    ShibbolethAttribute(final String name, final String value) {
    ...
    public static ShibbolethAttribute createFromUserRequestValue(final String name, final String rawRequestValue) {
        ...
        try {
            ...
            final String utf8Value = new String(rawRequestValue.getBytes("ISO-8859-1"), "UTF-8");
    ...
    private static boolean isInvalidValue(final String value) {
