...
public class IdentityEnvironment implements Serializable {
    ...
    public void setAttributes(Map<String, String> attributes) {
        if (this.attributes != null)
            throw new AssertException("can only set attributes once");
        if (identity == null)
            throw new AssertException("must set identity before setting attribues");
    ...
    public void addAttributes(Map<String, String> addAttribues) {
        if (this.attributes == null)
            throw new AssertException("set attributes first");
        // identity must be not null, which is asserted because setAttributes must be called first.
    ...
    public void setIdentity(Identity identity) {
        if (this.identity != null)
            throw new AssertException("can only set identity once!");
