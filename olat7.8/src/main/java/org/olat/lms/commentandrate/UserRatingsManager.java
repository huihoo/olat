...
/**
 * Description:<br>
 * The user ratings manager provides methods to rate any given OLATResourceable object. To use this manager, make sure a proper implementation for the bean
 * 'UserRatingsManager' is defined in the spring configuration.
 * <P>
...
public abstract class UserRatingsManager extends BasicManager {
    ...
    /**
     * Use only inside commentAndRating package! Otherwise use CommentsAndRatingServiceFactory Factory method to create a ratings manager for the given OLATResourceable.
     ...
     * @return
     */
    public static final UserRatingsManager getInstance(OLATResourceable ores, String subpath, UserCommentsDao userCommentsDao) {
        UserRatingsManager ratingServiceFactory = (UserRatingsManager) CoreSpringFactory.getBean(UserRatingsManager.class);
        return ratingServiceFactory.createRatingsManager(ores, subpath, userCommentsDao);
    }

    /**
     * Factory method to create a new instance of the ratings service for the given resource
     * 
     * @param ores
     * @param subpath
     * @return
     */
    protected abstract UserRatingsManager createRatingsManager(OLATResourceable ores, String subpath, UserCommentsDao userCommentsDao);
     ...
     */
    public abstract UserRating updateRating(UserRating rating, int newRatingValue);
