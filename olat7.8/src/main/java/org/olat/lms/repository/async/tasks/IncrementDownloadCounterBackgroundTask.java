...
public class IncrementDownloadCounterBackgroundTask extends AbstractBackgroundTask {
    ...
    public IncrementDownloadCounterBackgroundTask(final RepositoryEntry repositoryEntry) {
    ...
    public void executeTask() {
        ...
        if (RepositoryServiceImpl.getInstance().lookupRepositoryEntry(repositoryEntry.getKey()) != null) {
            ...
            if (lcManager.lookupLifeCycleEntry(RepositoryDeletionDao.SEND_DELETE_EMAIL_ACTION) != null) {
                ...
                LifeCycleManager.createInstanceFor(reloadedRe).deleteTimestampFor(RepositoryDeletionDao.SEND_DELETE_EMAIL_ACTION);
            }
