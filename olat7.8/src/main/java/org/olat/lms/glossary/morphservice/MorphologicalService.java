...
public interface MorphologicalService {
     ...
     * 
     * @param partOfSpeech
     *            possible values, see: assumePartOfSpeech()
     * @param word
     *            a single word or a wordgroup
     ...
     * 
     * @param glossTerm
     * @return part of speech, which can be: - a for an adjective "schön" - n for a noun "Haus" - an for adjective and noun "schönes Haus"
     */
    public String assumePartOfSpeech(String glossTerm);

    /**
     * Get the Status from the reply arrived from the morphological service status can either be: - known Flexions were found in Lexicon - guessed Flexions were generated
     * with heuristics - error Couldn't find anything or service error / unavailable
     * 
     * @return
     */
