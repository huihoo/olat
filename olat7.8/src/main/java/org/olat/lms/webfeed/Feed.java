...
public class Feed implements OLATResourceable, Serializable {
     ...
     * @param resource
     */
    protected Feed(final OLATResourceable resource) {
    ...
    /**
     * @param isExternal
     *            The isExternal to set. (Valid argument values are true, false (their corresponding boolean object) or null)
     */
