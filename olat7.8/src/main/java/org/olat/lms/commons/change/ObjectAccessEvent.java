 ...
 * <p>
 */
package org.olat.lms.commons.change;

import org.olat.system.commons.resource.OLATResourceable;
import org.olat.system.commons.resource.OLATResourceableEvent;

/**
 * Description:<br>
 * an event which must be fired whenever a business object / olatresourceable changed.<br>
 * <P>
...
public class ObjectAccessEvent extends OLATResourceableEvent {
    ...
    /**
     * @param action
     *            how it changed or was read (use constants of changemanager class (c,r,u,d,a)
     * @param ores
     *            the olat resourceable that changed
     */
