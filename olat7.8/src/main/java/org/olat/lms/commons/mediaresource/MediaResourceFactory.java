...
public class MediaResourceFactory {
    ...
    /**
     * Allow private browser caching of <seconds> seconds hours. After that period the browser <br>
     ...
     * <br>
     * the bevaviour of this method is that it simply overwrites or sets a new http-response-header:<br>
     * response.setHeader("Cache-Control", "private, max-age=21600, s-maxage=21600");<br>
     * <br>
     * 
     * @param originalMediaResource
     *            the mediaResource to be cache-enabled
     * @param seconds
     *            determines how many seconds a browser may cache this mediaresource before revalidating it
