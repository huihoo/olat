 ...
 * information regarding copyright ownership. The ASF licenses this file to You under the Apache License, Version 2.0 (the "License"); you may not use this file except in
 ...
 */
package org.olat.lms.commons.textservice.nutch;
...
import org.olat.lms.commons.textservice.nutch.NGramProfile.NGramEntry;
 ...
 * 
 * <a href="http://www.w3.org/WAI/ER/IG/ert/iso639.htm">ISO 639 Language Codes</a>
 * 
 * @author Sami Siren
...
public class LanguageIdentifier {
     ...
     * @return The 2 letter <a href="http://www.w3.org/WAI/ER/IG/ert/iso639.htm">ISO 639 language code</a> (en, fi, sv, ...) of the language that best matches the
     *         specified content.
     */
    ...
    /**
     * Identify language from input stream. This method uses the platform default encoding to read the input stream. For using a specific encoding, use the
     * {@link #identify(InputStream, String)} method.
     * 
     * @param is
     *            is the input stream to analyze.
     * @return The 2 letter <a href="http://www.w3.org/WAI/ER/IG/ert/iso639.htm">ISO 639 language code</a> (en, fi, sv, ...) of the language that best matches the content
