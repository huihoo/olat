 ...
 * <p>
 */
package org.olat.lms.commons.util.collection;
...
/**
 * <h3>Description:</h3> Some helper method to deal with arrays
 * <p>
...
public class ArrayHelper {
    ...
    /**
     * Helper to sort two string arrays. The arrays must have the same length and correspond to each other. Use sortAscending to indicate that sorting should be done on
     * the values of the first array or the second one. Use sortAscending to indicate the sort order. <br />
     * Internally, when comparing the two stings, the string.compareTo() method is used. <br />
     ...
     * @param afterFirstArray
     *            true: use first array to define sorting; false: use second one
     * @param sortAscending
     *            true: sort ascending; false: sort descending
     * @param caseSensitive
     *            true: sort case sensitive; false: sort case insensitive
     */
    public static void sort(final String[] first, final String[] second, final boolean afterFirstArray, final boolean sortAscending, final boolean caseSensitive) {
        if (first.length != second.length) {
            throw new AssertException("Can not sort arrays that have different length! first::" + first.length + " second::" + second.length);
        }
     ...
     * @param addAtTheEnd
     *            true: add new value at last possition of array; false: add new value at first position of array.
     * @return The new array containing the values from the old array and the new array
     */
