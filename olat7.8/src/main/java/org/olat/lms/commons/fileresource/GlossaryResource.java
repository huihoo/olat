...
public class GlossaryResource extends FileResource {
    ...
    public static final FilenameFilter GLOSSARY_FILENAME_FILTER = new FilenameFilter() {
        ...
        public boolean accept(final File arg0, final String arg1) {
            if (arg1.equals(GLOSSARY_DEFAULT_FILEREF) || arg1.equals(GLOSSARY_OLD_FILEREF)) {
                return true;
            } else {
                return false;
            }
    ...
    /**
     * @param dir
     *            containing the glossary. the dir must already be unzipped
     * @return true if of type GlossaryResource, false otherwhise
     */
    public static boolean validate(final File dir) {
        if (dir != null) {
            if (!dir.isDirectory()) {
            ...
            final File[] glossaryFiles = dir.listFiles(GLOSSARY_FILENAME_FILTER);
            if (glossaryFiles != null && glossaryFiles.length == 1) {
                return true;
            }
        }
        return false;
