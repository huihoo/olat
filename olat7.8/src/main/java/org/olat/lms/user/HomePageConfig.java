...
/**
 * Description: <br>
 * The HomePageConfig class represents a configuration for a Homepage. It is persisted as an xml file in the ???. Loading and saving of configuration files is managed
 * through the HomePageConfigManagerImpl.
 * <p>
 * A HomePageConfig has a class wide <code>CURRENTVERSION</code>, an integer denoting the most actual code version of the HomePageConfig. The attribute
 ...
 * <li><code>version &lt; CURRENTVERSION</code><br>
 * demands for resolving version differences, as the loaded HomePageConfig may contain outdated configuration information</li>
 * </ul>
 * <P>
 ...
 */
public class HomePageConfig implements OLATResourceable, UsedByXstream {
    ...
    public void resolveVersionIssues() {
        if (version < CURRENTVERSION) {
            ...
            if (version == 3) {
                ...
                final boolean addressEnabled = isEnabled("ADDRESS");
     ...
     */
    public void setEnabled(final String propertyName, final boolean enabled) {
     ...
     */
    public boolean isEnabled(final String propertyName) {
        final Boolean bool = (Boolean) configuration.get(propertyName);
        if (bool == null) {
            return false;
        } else {
     ...
     * @param id
     */
    public void setResourceableId(final Long id) {
    ...
    public Long getResourceableId() {
        final Long id = (Long) configuration.get(KEY_RESOURCEABLEID);
        return id;
    }
    ...
    public String getUserName() {
        final String userName = (String) configuration.get(KEY_USERNAME);
        if (userName.equals("")) {
            throw new AssertException("No username defined in " + HomePageConfigManager.HOMEPAGECONFIG_XML);
        }
        return userName;
    }
     ...
     * @param textAboutMe
     */
    public void setTextAboutMe(final String textAboutMe) {
