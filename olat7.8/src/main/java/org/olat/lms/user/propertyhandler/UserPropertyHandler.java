...
public interface UserPropertyHandler extends ItemValidatorProvider {
    ...
    /**
     * @param user
     *            the user for which we want to get the value
     * @param locale
     *            the current users locale or NULL if default locale should be used.
    ...
    /**
     * @param user
     *            The user for which we want to set the value
     * @param value
     *            The new value or NULL to remove the value
     */
     ...
     * @param user
     *            The user containing data to be prefilled or NULL if it should be left empty
     * @param usageIdentifyer
     *            The identifyer of the form where this form element is used
     * @param isAdministrativeUser
     *            true: Form element will be set to administrative mode. false: the element is set to user mode. In some cases the field is then read-only
     ...
     * @param isAdministrativeUser
     *            true: Form element will be set to administrative mode. false: the element is set to user mode. In some cases the field is then read-only
     * @param formItemContainer
     *            Container to which Form Item has to be added
     ...
     * 
     * @param ui
     *            The form element previously created with the getFormElement method
     * @param user
     *            The user that contains the data
     * @deprecated Use FlexiForms instead of the old forms.
     */
    @Deprecated
     ...
     *            The form element previously created with the getFormElement method
     * @param formContext
     *            Map containing some variables used in this form context, e.g. for cross form value checks. NULL to not use any form context variables
     ...
     * 
     * @param formItem
     *            The flexi form item previously created with the addFormItem method
     * @param formContext
     *            Map containing some variables used in this form context, e.g. for cross form value checks. NULL to not use any form context variables
     * @return true: the entered value is ok; false: the entered value is not accepted (Validation error)
     */
     ...
     *            Callback to get the error key in case of validation=false
     * @param local
     *            The display users locale
     ...
     * @param displayValue
     * @param locale
     *            The locale to be used to parse the display value
     * @return
     */
