 ...
 * @author guido
 */
public class DialogPropertyElements implements UsedByXstream {
    ...
    public DialogPropertyElements(final String propertyCategory) {
    ...
    /**
     * @param dialogPropertyElements
     *            The dialogPropertyElements to set.
     */
    ...
    public void addElement(final DialogElement element) {
