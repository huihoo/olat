...
/**
 * This comparator is intended to compare two wiki pages by their page name. The comparison is done with respect to the current locale. (The Serializable interface is
 * recommended.)
 * <P>
