...
public interface WikiSecurityCallback {
    ...
    /**
     * @return true if admin or allowed by preconditions of used in collaboration group context where everything is allowed
     */
    public boolean mayEditAndCreateArticle();

    /**
     * @return true if admin or resource owner or used in collaboration group context where everything is allowed
     */
