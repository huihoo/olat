...
public class AbstractOlatDocument implements Serializable {
    ...
    private static final long serialVersionUID = -2750528680392569233L;
    ...
    /**
     * The list of identities who can see the document. It's an optimized check access for private documents.
     * 
    ...
    /**
     * Add generic metadata. It is strongly recommended not to use anything else than the doublin core metadata namespace here. See {@link http
     * ://en.wikipedia.org/wiki/Dublin_Core} for more information.
     * <p>
     * A metadata element consists of a key-value pair. It is possible to have more than one value for a key. In this case use the method multiple times with the same
     * key.
     * <p>
     * Example:<br>
    ...
    public synchronized void addMetadata(String key, String value) {
        if (key == null || !StringHelper.containsNonWhitespace(value))
            return;
     ...
     * 
     * @param key
     *            The metadata key, e.g. DC.subject
