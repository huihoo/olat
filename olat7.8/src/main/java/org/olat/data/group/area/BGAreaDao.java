...
public interface BGAreaDao {
    ...
    /**
     * Copies all group areas from the original context to the target context. The method returns a hash map with all original areas as key and the newly created areas as
     * value.
     * 
     * @param origBgContext
     *            Context containing the orignial areas
     * @param targetBgContext
     *            Context where the areas should be created
     ...
     */
    public abstract List<BGArea> findBGAreasOfBusinessGroup(BusinessGroup group);
     ...
     */
    public abstract List<BGArea> findBGAreasOfBGContext(BGContext groupContext);
