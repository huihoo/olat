...
public class OLATResourceImpl extends PersistentObject implements OLATResource {
    ...
    OLATResourceImpl(Long id, final String typeName) {
    ...
    OLATResourceImpl(final OLATResourceable resourceable) {
    ...
    public Long getResourceableId() {
        final Long val = getResId();
        if (val == null) {
            throw new AssertException("hibernate should never set id to null, but to zero instead");
        }
     ...
     * @param id
     */
    private void setResId(final Long id) {
        resId = id;
    }
     ...
     * @param typeName
     */
    private void setResName(final String typeName) {
        resName = typeName;
    }
    ...
    public String toString() {
        final StringBuilder desc = new StringBuilder().append(" OLATResource(").append(this.getKey()).append(")[").append(this.getResourceableTypeName()).append("(")
                .append(this.getResourceableId()).append(")").append("], ");
