 ...
 * <p>
 */
package org.olat.data.portfolio.restriction;
...
public class CollectRestriction extends PersistentObject {
    ...
    public CollectRestriction(final CollectRestriction cr) {
        artefactType = cr.artefactType;
        amount = cr.amount;
        restriction = cr.restriction;
    }

    public CollectRestriction(final String artefactType, final int amount, final String restriction) {
     ...
     * 
     * @param artefactType
     *            The artefactType to set.
     * @uml.property name="artefactType"
     */
    public void setArtefactType(final String artefactType) {
        this.artefactType = artefactType;
    }
    ...
    public boolean equals(final Object obj) {
        if (this == obj) {
            ...
            final CollectRestriction cr = (CollectRestriction) obj;
    ...
    public boolean isValid() {
        if (StringHelper.containsNonWhitespace(getRestriction()) && StringHelper.containsNonWhitespace(getArtefactType()) && getAmount() > 0)
            return true;
        return false;
    }
