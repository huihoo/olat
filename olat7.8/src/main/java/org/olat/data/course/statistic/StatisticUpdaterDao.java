...
/**
 * Could be renamed into StatisticUpdaterDao
 * <p>
 * 
...
public interface StatisticUpdaterDao {
     ...
     * 
     * @param fullRecalculation
     *            when set to true the statisticupdater should do a complete recalc of all stats, rather than updating since the last call to updateStatistic
     * @param from
     *            update the statistics starting at the given from date - note that this is never null irrespective of fullRecalculation true or false
     * @param until
     *            update the statistics ending at the given until date - this is never null
     * @param statisticUpdateManager
     ...
     */
    void updateStatistic(boolean fullRecalculation, Date from, Date until);
