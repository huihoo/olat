...
public class PublisherDao {
    ...
    /**
     * @return returns null if no publisher found.
     */
    ...
    /**
     * This should delete the publisher together with its subscriptions and notificationEvents, the subscriptions are deleted explicitly. <br>
     * A subscription has 2 parents: a publisher and a subscriber, it has to be removed from both of them.
     */
