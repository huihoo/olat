...
/**
 * Hibernate class representing a <i>log line</i> - a row in the user activity logging table.
 * <p>
...
public class LoggingObject extends PersistentObject {
    ...
    public String toString() {
        return "LoggingObject[" + actionVerb + " " + actionObject + " by user " + userName + " by class " + sourceClass + ","
                + (resourceAdminAction ? "isAdminAction" : "isUserAction") + ", businessPath=" + businessPath + ", userProperty1=" + userProperty1 + ", userProperty2="
                + userProperty2 + ", userProperty3=" + userProperty3 + ", userProperty4=" + userProperty4 + ", userProperty5=" + userProperty5 + ", userProperty6="
                + userProperty6 + ", userProperty7=" + userProperty7 + ", userProperty8=" + userProperty8 + ", userProperty9=" + userProperty9 + ", userProperty10="
                + userProperty10 + ", userProperty11=" + userProperty11 + ", userProperty12=" + userProperty12 + ", greatGrandParentResType=" + greatGrandParentResType
                + ", greatGrandParentResId=" + greatGrandParentResId + ", greatGrandParentResName=" + greatGrandParentResName + ", grandParentResType="
                + grandParentResType + ", grandParentResId=" + grandParentResId + ", grandParentResName=" + grandParentResName + ", parentResType=" + parentResType
                + ", parentResId=" + parentResId + ", parentResName=" + parentResName + ", targetResType=" + targetResType + ", targetResId=" + targetResId
     ...
     * 
     * @param sessionId
     *            the id of the session - which is directly stored to the database
     * @param identityKey
     *            TODO
     * @param identityName
     *            TODO
     * @param actionCrudType
     *            the crudAction type
     * @param action
     *            - the actual log message
     */
    public LoggingObject(String sessionId, Long identityKey, String identityName, String actionCrudType, String actionVerb, String actionObject, boolean isLogAnonymous) {
        if (sessionId == null) {
            throw new IllegalArgumentException("sessionId must not be null");
        }
        if (identityKey == null || (!isLogAnonymous && identityName == null)) {
     ...
     * 
     * @param the
     *            LoggingResourceable which should be stored in the greatGrandParent field
     */
    public void setGreatGrandParentResourceInfo(String type, String id, String name) {
        setGreatGrandParentResType(type);
        setGreatGrandParentResId(id);
        setGreatGrandParentResName(name);
    }
     ...
     * 
     * @param the
     *            LoggingResourceable which should be stored in the grandParent field
     */
    public void setGrandParentResourceInfo(String type, String id, String name) {
        setGrandParentResType(type);
        setGrandParentResId(id);
        setGrandParentResName(name);
    }
     ...
     * 
     * @param the
     *            LoggingResourceable which should be stored in the parent field
     */
    public void setParentResourceInfo(String type, String id, String name) {
        setParentResType(type);
        setParentResId(id);
        setParentResName(name);
    }
     ...
     * 
     * @param the
     *            LoggingResourceable which should be stored in the targetResource field
     */
    public void setTargetResourceInfo(String type, String id, String name) {
        setTargetResType(type);
        setTargetResId(id);
        setTargetResName(name);
    }
