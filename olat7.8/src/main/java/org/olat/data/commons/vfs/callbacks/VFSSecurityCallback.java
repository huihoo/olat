...
package org.olat.data.commons.vfs.callbacks;
 ...
 * 
 * @author Mike Stock Comment: Implementations of this interface serve the VFS to decide whether read/write/list/delete is allowed for the current item. The callbacks a
 *         re inherited by children in case they do not have a callback on their own.
 */
