...
public class ExportUtil {
    ...
    /**
     * Creates a file in a Directory and writes a string to this file. If the file already exists an AssertExeption is thrown.
     * 
     * @param fileName
     * @param content
    ...
    public static void writeContentToFile(String fileName, String content, File exportDirectory, String enc) {
        ...
        if (f.exists()) {
            throw new AssertException("File " + fileName + " already exists!");
        }
