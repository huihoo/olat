...
/**
 * Description:<br>
 * Log handler that logs to a virtual file system leaf. The handler opens the file for each log entry and closes it after that immediately. (in order to not waste too
 * many unix filehandles)
 * <P>
