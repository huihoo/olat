...
public class LocalFolderImpl extends LocalImpl implements VFSContainer {
     ...
     * 
     * @param folderFile
     *            The real file of type directory wrapped by this VFSContainer
     */
    ...
    protected LocalFolderImpl(File folderfile, VFSContainer parent) {
        ...
        if (!alreadyExists && !succesfullCreated)
            throw new AssertException("Cannot create directory of LocalFolderImpl with reason (exists= ): " + alreadyExists + " && created= " + succesfullCreated
                    + ") path: " + folderfile.getAbsolutePath());
    }
    ...
    private VFSStatus delete(boolean deleteContainer) {
