 ...
 * @author guido
 */
public class CheckForOLATLocalPropertiesFile extends PropertyPlaceholderConfigurer {
    ...
    protected CheckForOLATLocalPropertiesFile() {
        ...
        if (!overwritePropertiesRes.exists()) {
            ...
            if (catalinaHome == null) {
                String msg = INTRO + "There is no " + localProps + " file in the classpath and I cannot figure out where to save one."
            ...
            throw new StartupException(INTRO + "\n\nOLAT Created automatically an empty " + localProps + " file for you at \"" + props.getAbsolutePath()
