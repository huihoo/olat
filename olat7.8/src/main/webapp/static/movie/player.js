var BPlayer = {
	...
	insertFlashPlayer : function (address,domId,width,height,start,duration,provider,streamer,autostart,repeat,controlbar) {
		...
		// used new player.swf (issue OLAT-6930), previously used movieViewer.swf
		// see also README.txt
		playerUrl += "movie/tinyMCE/player.swf";
		
		// added (issue OLAT-1925) 
		...
		if (swfobject.hasFlashPlayerVersion("9")) {
     		var fn = function() {
        		...
        		var par = { flashvars: flashvars, wmode: wmode };
        		var id = domId;
