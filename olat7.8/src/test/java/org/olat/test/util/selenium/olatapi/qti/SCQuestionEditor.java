...
/**
 * This is a Single choice QuestionEditor with 2 modes: Test and Questionnaire. (The class might be splitted later in specific types.)
 * <p>
 * Used for tests/questionnaires editing. The Questionnaire functionality is a subset of the Test mode.
 * 
...
public class SCQuestionEditor extends QuestionEditor {
    ...
    /**
     * Edits the answer with the answerIndex for the selected SINGLE_CHOICE while in Question/answers tab of the current selected question. The answerIndex must be
     * greater that 0.
     * 
     * @param newText
     * @param answerIndex
    ...
    /**
     * Only for tests! This SHOULD NOT be called for a questionnaire editor.! Selects the correct answer for the current selected SINGLE_CHOICE question.
     * 
     * @param answerIndex
     */
