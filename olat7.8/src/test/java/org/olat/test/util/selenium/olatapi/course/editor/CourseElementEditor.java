...
public class CourseElementEditor extends OLATSeleniumWrapper {
    ...
    public enum ACCESS_TYPE {
        ACCESS, READ_ONLY, READ_AND_WRITE, MODERATE, CREATE_EDIT_WIKI, PRESENT
    }// MISSING FOR FILE_DIALOG, TASK, TOPIC_ASSIGNMENT,CALENDAR
    ...
    /**
     * Append condition to the expert mode. Cases: 1. append condition only if the expert mode is already selected, 2. append condition in any case, that is select the
     * expert mode before.
     * 
