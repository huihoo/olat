...
public class OLATWorkflowHelper extends OLATSeleniumWrapper {
    ...
    /*
     * public HelpCourse getHelp() throws Exception{ selenium.click("ui=home::topNav_olatHelp()"); Thread.sleep(10000);
     * 
     * //select window System.out.println(" title: " + selenium.getAllWindowTitles()[0]); System.out.println(" title: " + selenium.getAllWindowTitles()[1]);
     * selenium.selectWindow(selenium.getAllWindowTitles()[0]);
     * 
     * Thread.sleep(10000); return new HelpCourse(selenium); }
     */
