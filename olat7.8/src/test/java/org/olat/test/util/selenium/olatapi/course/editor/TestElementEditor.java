...
public class TestElementEditor extends CourseElementEditor {
    ...
    /**
     * Configure Layout. There is only a partial coverage of the possible configuration.
     * 
     * @param allowMenuNavigation
     *            should be null if default, true or false otherwise
     ...
     * @param allowSuspend
     *            should be null if default, true or false otherwise
     * @param maxNumApproaches
     *            greater the 0 if set to some value
     * @param displayResultsOnTestHomepage
     *            should be null if default, true or false otherwise
     */
    public void configureTestLayout(Boolean allowMenuNavigation, Boolean showMenuNavigation, Boolean allowCancel, Boolean allowSuspend, int maxNumApproaches,
            Boolean displayResultsOnTestHomepage) {
        if (selenium.isElementPresent("ui=courseEditor::content_bbTest_tabTestConfiguration()")) {
            selenium.click("ui=courseEditor::content_bbTest_tabTestConfiguration()");
            selenium.waitForPageToLoad("30000");
        }
        ...
        if (displayResultsOnTestHomepage != null && displayResultsOnTestHomepage
                && !selenium.isChecked("ui=courseEditor::content_bbTest_layoutParameters_displayResultsOnTestHomepage()")) {
            selenium.click("ui=courseEditor::content_bbTest_layoutParameters_displayResultsOnTestHomepage()");
        } else if (displayResultsOnTestHomepage != null && !displayResultsOnTestHomepage
                && selenium.isChecked("ui=courseEditor::content_bbTest_layoutParameters_displayResultsOnTestHomepage()")) {
        ...
        selenium.click("ui=courseEditor::content_bbTest_layoutParameters_save()");
        // selenium.waitForPageToLoad("30000");
