...
/**
 * 
 * abstraction for the ePortfolio artefact collect wizard possible steps in wizard are: 1. Inhalt erfassen 2. Metadaten erfassen 3. Tags angeben 4. Urheberrecht 5.
 * Reflexion erfassen 6. Mappe auswählen not all of them are available depending on artefact-type
 * 
