...
/**
 * Simple wrapper object around login information to log into OLAT.
 * <p>
 * The information provided here should be sufficient to create a selenium session with it and log into OLAT. Hence we need the hostname of the selenium server and the
 * hostname + login details of the OLAT server.
 * 
 * @author Stefan
 * 
 */
public class OlatLoginInfos {
    ...
    public OlatLoginInfos(String seleniumHostname, String seleniumBrowserId, String fullOlatServerUrl, String username, String password) throws MalformedURLException {
