...
/**
 * This is a Multiple choice QuestionEditor with 2 modes: Test and Questionnaire. (The class might be splitted later in specific types.)
 * <p>
...
public class MCQuestionEditor extends QuestionEditor {
    ...
    /**
     * Edits the answer with the answerIndex for the MULTIPLE_CHOICE, while in Question/answers tab of the current selected question. The answerIndex must be greater that
     * 0.
     * 
     * @param newText
     * @param answerIndex
    ...
    /**
     * Only for tests! Selects the correct answer for the current selected MULTIPLE_CHOICE question.
     * 
     * @param answerIndex
     */
