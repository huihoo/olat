...
public class CPResourceEditor extends ResourceEditor {
    ...
    /**
     * Selects the page with this title, if visible. As with selecting the node the subtree opens.
     * 
     * @param title
    ...
    /**
     * Add page, after selecting the parent page, assuming that this is visible. Renames page.
     * 
     * @param parentTitle
     * @param title
     * @param content
    ...
    /**
     * Inserts image, steps: click symbol "insert/edit image" <br/>
