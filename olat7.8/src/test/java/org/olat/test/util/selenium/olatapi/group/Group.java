...
public class Group extends OLATSeleniumWrapper {
    ...
    /**
     * TODO: LD: check this out!!! Use carefully this method. This starts a course if the group was achieved via the My groups portlet, else if the group was achieved via
     * the GroupManager, this doesn't return a CourseRun.
     * <p>
