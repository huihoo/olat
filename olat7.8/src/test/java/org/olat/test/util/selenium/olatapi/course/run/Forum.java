...
public class Forum extends OLATSeleniumWrapper {
    ...
    /**
     * Deletes the topic with this title. Assumes that the Forum node is selected.
     * 
     * @param title
     */
    ...
    /**
     * Type in a new forum message assuming that we already have an open message editor. Save message.
     * 
     * @param title
     * @param body
     */
