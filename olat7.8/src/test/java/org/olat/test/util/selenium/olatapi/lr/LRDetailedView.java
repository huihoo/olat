...
public class LRDetailedView extends OLATSeleniumWrapper {
    ...
    /**
     * Deletes this learning resource, if possible. If not possible to delete this LR, go back to the Learning resources, and throw new CannotExecuteException.
     * 
     * @return
    ...
    /**
     * Modify properties. Modify access if necessary.
     * 
     * @param accessLabel
     */
    ...
    /**
     * Try to edit the course who was already been open, and got disposed. The user sees the "Close and restart course" button.
     * 
     * @return
     */
    ...
    /**
     * The user tries to open the courseEditor but it is locked. The caller of this method expects to find the course locked, so it should not open the CourseEditor.
     * 
    ...
    /**
     * Assign new owners. It selects all users received by filtering with userName.
     * 
     * @param userName
     */
     ...
     * 
     * @param userName
     * @return Returns Boolean.TRUE if the owner was successfully removed, Boolean.FALSE if the owner is the last one in group, and null if none of the above is true.
     */
     ...
     *            could be null, keeps the old description
     */
    ...
    public void closeCourse(boolean cleanCatalog, boolean cleanGroup) {
        ...
        selenium.waitForPageToLoad("30000");
        // email notification step was removed from this workflow
        // selenium.click("ui=learningResources::dialog_buttonNext()");
        // selenium.waitForPageToLoad("30000");
    }
