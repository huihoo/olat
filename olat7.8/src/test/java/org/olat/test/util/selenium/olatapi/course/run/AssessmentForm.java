...
/**
 * This is the AssessmentForm page abstraction. TODO: LD: add methods for comments, and test if setComments/getComments work!
 * 
...
public class AssessmentForm extends OLATSeleniumWrapper {
    ...
    /**
     * Only type the score. Call save to commit the change.
     * 
     * @param score
     */
    ...
    /**
     * Only set passed info. Call save to commit the change.
     * 
     * @param passed
     */
