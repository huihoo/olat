...
/**
 * This is a KPrim QuestionEditor used only for tests editing. (The class might be splitted later in specific types.)
 * 
...
public class KPrimQuestionEditor extends QuestionEditor {
    ...
    /**
     * Edits the answer with the answerIndex for the selected KPRIM, while in Question/answers tab of the current selected question. The answerIndex must be greater that
     * 0.
     * 
     * @param newText
     * @param answerIndex
