...
public class CourseWizardVisibiltyTest extends BaseSeleneseTestCase {
    ...
    public void testVisibility() {
        ...
        assertTrue("Acess rule does not match " + LRDetailedView.ACCESS_ALL_REGISTERED + ", it is " + detail.getAccessString(),
                detail.getAccessString().equals(LRDetailedView.ACCESS_ALL_REGISTERED));
        ...
        assertTrue("assessment " + ASSESSMENT_NAME + " is not present but should be!",
                run.isElementPresent("ui=course::menu_courseNode(titleOfNode=" + ASSESSMENT_NAME + ")"));
