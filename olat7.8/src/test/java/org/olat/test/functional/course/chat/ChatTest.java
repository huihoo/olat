 ...
 * (13. Check whether "[TIME] seleniumstudent: [hat sich ausgeloggt]" is displayed in browser 1) -> removed 14. Seleniumauthor logs back in. 15. Seleniumstudent goes to
 * course and opens course chat <br/>
 ...
 * 18. Both write a message "hello". 19. Assert that memberlist is updated so that both seleniumauthor and seleniumstudent are listed<br/>
