...
/**
 * 
 * Tests the LTI BB: insert, configure, launch. <br/>
 * <p>
 * Test setup:<br/>
 * import Course "Course_with_all_bb.zip" enter title "LTIUseTestCourse" enter description "Edit And Configure LTI Test Course"
 * <p>
 * Test case: <br/>
 * 
 * ------------- as author ------------------- <br/>
