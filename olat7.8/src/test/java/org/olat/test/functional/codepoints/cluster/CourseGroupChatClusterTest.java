...
public class CourseGroupChatClusterTest extends BaseSeleneseTestCase {
    ...
    public void testCourseChat() throws Exception {
        ...
        CodepointRef beforeSyncA = codepointClient_A
                .getCodepoint("org.olat.commons.coordinate.cluster.ClusterSyncer.doInSync-before-sync.org.olat.instantMessaging.groupchat.GroupChatJoinTask.run");
        beforeSyncA.setHitCount(0);
        beforeSyncA.enableBreakpoint();

        codepointClient_B = context.createCodepointClient(2);
        CodepointRef beforeSyncB = codepointClient_B
                .getCodepoint("org.olat.commons.coordinate.cluster.ClusterSyncer.doInSync-before-sync.org.olat.instantMessaging.groupchat.GroupChatJoinTask.run");
        beforeSyncB.setHitCount(0);
        beforeSyncB.enableBreakpoint();

        CodepointRef inSyncA = codepointClient_A
                .getCodepoint("org.olat.commons.coordinate.cluster.ClusterSyncer.doInSync-in-sync.org.olat.instantMessaging.groupchat.GroupChatJoinTask.run");
        inSyncA.setHitCount(0);

        CodepointRef inSyncB = codepointClient_B
                .getCodepoint("org.olat.commons.coordinate.cluster.ClusterSyncer.doInSync-in-sync.org.olat.instantMessaging.groupchat.GroupChatJoinTask.run");
        ...
        // open course chat
        /*
         * selenium_1.mouseMoveAt("ui=courseChat::openCourseChat()", "300,300"); selenium_1.click("ui=courseChat::openCourseChat()");
         */
        ...
        // open course chat
        /*
         * selenium_2.mouseMoveAt("ui=courseChat::openCourseChat()", "300,300"); selenium_2.click("ui=courseChat::openCourseChat()");
         */
