 ...
 * <p>
 * Test case: <br/>
 * Tutor (node 1) opens the AssessmentTool of the COURSE_NAME, starts the bulk assessment wizard and adds score values for a ASSESSMENT_ELEM_NAME course element for 3
 * users enrolled into the group. The scores are: 2, 3, and 4 for STUDENT1, STUDENT2, STUDENT3. <br/>
 * STUDENT2 asserts his score in course run (COURSE_NAME) for the ASSESSMENT_ELEM_NAME element, and in the efficiency statement (Home/Evidences of achievement) after he
 * logins on the cluster node 2
 * 
...
public class BulkAssessmentTest extends BaseSeleneseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        /*
         * OlatServerSetupHelper.deleteEvidencesOfAchievement(COURSE_NAME_PREFIX, olatLoginInfos1); OlatServerSetupHelper.deleteEvidencesOfAchievement(COURSE_NAME_PREFIX,
         * olatLoginInfos2); OlatServerSetupHelper.deleteEvidencesOfAchievement(COURSE_NAME_PREFIX, olatLoginInfos3);
