...
/**
 * 
 * Tests if subscription to a learning group with just one place is locked if many students enrol simultaneously. <br/>
 * Test setup: <br/>
 ...
 * 7. Check that only one student gets into group, all other four get appropriate error message that group is already full. <br/>
