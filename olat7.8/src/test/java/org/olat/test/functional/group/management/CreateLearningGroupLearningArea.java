...
/**
 * 
 * Checks if enrolment course element with learning groups and learning areas works, part of test suite GroupManagementCombiTest.java. <br/>
 * Test setup: <br/>
...
public class CreateLearningGroupLearningArea extends BaseSeleneseTestCase {
    ...
    public void testCreateLearningGroupLearningAreaTest() throws Exception {
        ...
        assertFalse("Could not create group. It was already there: learning group selenium 1",
                group1.isTextPresent("This group name is already being used in this context, please select another one."));
