...
/**
 * 
 * Test if user roles can be changed and the changes apply for user. <br/>
 * Test setup: <br/>
 * -
 * <p>
 * Test case: <br/>
 ...
 * 4. User USER_NAME logs in and checks if he has the according authoring rights but no rights for administrator, group and user management. <br/>
...
public class UserRolesTest extends BaseSeleneseTestCase {
    ...
    public void testUserRoles() throws Exception {
        ...
        assertTrue("Asserts that the current user doesn't not have enough rights to edit user",
                olatWorkflowUserManager.getUserManagement().cannotEditUser(context.getStandardAdminOlatLoginInfos().getUsername()));
