...
/**
 * Tests file upload for Folder, SinglePage, Forum, Wiki and FileDialog. <br/>
 * <p>
 * Test setup:<br/>
 ...
 * Go to forum and create a new message with two file attachments - check if uploaded properly and delete again <br/>
 * Go to wiki and upload a pdf file to be linked in the wiki - check if there <br/>
...
public class UploadFilesInCourseTest extends BaseSeleneseTestCase {
    ...
    /**
     * Deletes resource with the given name, having the administrator as author. Filter for the author as well, else won't work for selenium load.
     * 
     * @param workflow
     * @param title
     */
