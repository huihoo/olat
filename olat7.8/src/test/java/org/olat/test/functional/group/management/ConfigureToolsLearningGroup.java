...
/**
 * 
 * Adds all collaborative tools to learning group and checks their configuration, part of test suite GroupManagementCombiTest.java. <br/>
 * Test setup: <br/>
 * -
 * <p>
 * Test case: <br/>
...
public class ConfigureToolsLearningGroup extends BaseSeleneseTestCase {
    ...
    public void testConfigureToolsLearningGroupTest() throws Exception {
        ...
        group2.startCourse();
        assertTrue(group2.isTextPresent("Course element of the type Enrollment"));
