...
/**
 * Tests that all inputs in AssessmentForm (AssessmentTool) are correctly stored and seen by the student in different cluster nodes.<br/>
 * 
 * Test setup: <br/>
 * 1. import course <br/>
 ...
 * 
 * Test case: <br/>
 * Tests whether all inputs in AssessmentForm are correctly stored and correctly seen by the tutor in AssessmentTool and the student in course run and in the
 * "Evidence of achievement". The AssessmentForm is used for assessing: Test, Task and Assessment course elements.
 * 
...
public class AssessmentFormTest extends BaseSeleneseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        /*
         * OlatServerSetupHelper.deleteEvidenceOfAchievement(COURSE_NAME, olatLoginInfos1); OlatServerSetupHelper.deleteAllCoursesNamed(COURSE_NAME);
         */
