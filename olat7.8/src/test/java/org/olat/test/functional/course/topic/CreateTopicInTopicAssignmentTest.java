...
/**
 * 
 * Tests the new bb topic assignment. Step 2: Create topics <br/>
 * <p>
 * Test setup:<br/>
 ...
 * 
 * Testcase:<br/>
 * 1. log in as TUTOR1 2. go to learning resources, search form 3. search for TOPIC_ASSIGNMENT_COURSE and open course run 4. go to bb TOPIC_ASSIGNMENT_1 5. check if the
 * button "create topic" is available 6. check if text "No Topics for this Topic assignment available." is present 7. click "create topic" 8. title: "Topic_Tutor1",
 * description "Description Topic of Tutor 1" 9. check "do you want to limit the vacancies" and edit 1. 10. Save 11. Log out TUTOR1 12. log in as TUTOR2 13. go to
 * learning resources, search form 14. search for TOPIC_ASSIGNMENT_COURSE and open course run 15. go to bb TOPIC_ASSIGNMENT_1 16. check if the button "create topic" is
 * available 17. check if "Topic_Tutor1" is available 18. click "create topic" 19. title: "Topic_Tutor2", description "Description Topic of Tutor 2" 20. check
 * "do you want to limit the vacancies" and edit 2. 21. Save 22. Log out TUTOR2 23. log in as TUTOR3 24. go to learning resources, search form 25. search for
 * TOPIC_ASSIGNMENT_COURSE and open course run 26. go to bb TOPIC_ASSIGNMENT_1 27. check if the button "create topic" is available 28. check if "Topic_Tutor1" and
 * "Topic_Tutor2" are available 29. click "create topic" 30. title: "Topic_Tutor3", description "Description Topic of Tutor 3" 31. check
 * "do you want to limit the vacancies" and edit 3. 32. Save 33. go again to TOPIC_ASSIGNMENT_1 34. check if all topics are available "Topic_Tutor1", "Topic_Tutor2",
 * "Topic_Tutor3" 35. check if in column "in charge" TUTOR1, 2 and 3, respectively, are listed 36. check if in the colum "topic status" the first two topics have value
 * "vacancies", the third "no participants to check" 37. check if in column "number of filled vacancies" is 0 out of 1, 2 and 3 respectively 38. check if "select" link is
 * available for all 3 topics 39. Log out
 * 
 * </p>
 * 
 * @author sandra
