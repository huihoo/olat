...
/**
 * 
 * admin starts course editor of a course, author tries to export/download the same course at the same time <br/>
 * <p>
 * Test setup:<br/>
...
public class CourseEditor_concurrencyEditAndExportTest extends BaseSeleneseTestCase {
    ...
    public void testCourseEditor_concurrencyEditAndExportTest() throws Exception {
...

        {
            ...
            SeleniumHelper.waitUntilTextPresent(lRDetailedView2.getSelenium(), "This course is currently locked by " + user1.getUsername() + " due to editing purposes.",
                    20);
        }
