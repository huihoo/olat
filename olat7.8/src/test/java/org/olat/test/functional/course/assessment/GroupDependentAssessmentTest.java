...
/**
 * 
 * Assessment course element test. <br/>
 * 
 * Test case: The test proves that the tutor of group1 has access to grading the newly inserted element, which is only accessible for group2. <br/>
 * Administrator adds new Assessment course element in course and configures it. (min, max score, passed cut value, etc.) and allows visibility/access only to the
 * GROUP_NAME_2. Course gets published. <br/>
 * Tutor of group1 assesses student - participant of group 1 - for the latest introduced course element. <br/>
 * Student checks the score/passed info in "Evidence of achievement" even if he does't have access to that element in course run.
 * 
...
public class GroupDependentAssessmentTest extends BaseSeleneseTestCase {
    ...
    /*
     * private final String STUDENT2 = "selenium_student2"; private final String TUTOR = "selenium_tutor";
     */
    ...
    public void setUp() throws Exception {
        ...
        /*
         * OlatServerSetupHelper.deleteEvidenceOfAchievement(COURSE_NAME, olatLoginInfos1); OlatServerSetupHelper.deleteEvidenceOfAchievement(COURSE_NAME,
         * olatLoginInfos2); OlatServerSetupHelper.deleteAllCoursesNamed(COURSE_NAME);
         */
