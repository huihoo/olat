...
/**
 * Folder test class (See: OLAT-4394); tests the basic functionality of a folder. TODO: LD: see TODOs below.
 * 
 * Test case: <br/>
...
public class FolderTest extends BaseSeleneseTestCase {
    ...
    public void testPersonalFolder() {
        ...
        assertNotNull("Word.doc was not found!", doc);
     ...
     */
    /*
     * private void testStorageFolder() { OLATWorkflowHelper workflow = Context.getContext().getOLATWorkflowHelper(Context.getContext().getStandardAdminOlatLoginInfos());
     * //create course CourseEditor courseEditor = workflow.getLearningResources().createCourseAndStartEditing(COURSE_NAME, COURSE_DESCRIPTION);
     * 
     * //insert single page, create html page and assign to single page SinglePageEditor singlePageEditor =
     * (SinglePageEditor)courseEditor.insertCourseElement(CourseElemTypes.SINGLE_PAGE, true, "single page2");
     * singlePageEditor.setDescription("This is the second course TS090533 Description"); singlePageEditor.createHTMLPage("second_html_descr",
     * "a not very long content that serves as an example too");
     * 
     * //delete html-page in the storage folder Folder storageFolder = courseEditor.storageFolder(); storageFolder.deleteItem("second_html_descr.html"); }
     */
