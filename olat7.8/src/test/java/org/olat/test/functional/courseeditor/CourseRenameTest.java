...
/**
 * Tests the course title change and publish. Test setup & test case: Admin creates a clone of "Demo course wiki" course, publishes it, changes the title, publishes
 * again, asserts if the course title was changed. Cleanup.
 * 
 * 
 * @author lavinia
 * 
