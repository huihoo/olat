...
/**
 * 
 * Tests course import with all building blocks, and asserts that all bb are visible. <br/>
 * <p>
 * Test case: <br/>
 * Import course with all references <br/>
 * Open course <br/>
 * Check all course elements: podcast extern, podcast intern, blog extern, blog intern, topic assignment, email, calender, show preview <br/>
...
public class CourseImportWithAllBBTest extends BaseSeleneseTestCase {
    ...
    public void testCourseImport() throws Exception {
        ...
        /*
         * courseRun.selectCourseElement("Single page - inline"); Thread.sleep(5000); courseRun.getSelenium().selectFrame("//iframe[contains(@src,'first.html')]");
         * assertTrue(courseRun.isTextPresent("This is the first page")); courseRun.getSelenium().selectFrame("relative=top");
         */
        ...
        Thread.sleep(1000);
        courseRun.getSelenium().selectFrame("//iframe[contains(@src,'http://www.uzh.ch/')]");
        assertTrue(courseRun.getSelenium().isTextPresent("Impressum"));
        courseRun.getSelenium().selectFrame("relative=top");
    ...
    /**
     * Deletes all resource with input resourceTitle and author.
     * <p>
     * Fill in the search form with resourceTitle and author, search, select entry with resourceTitle title if any found, and delete resource and go back to the seach
     * form.
     * 
