 ...
 * Delete groups <br/>
 * create groups again, but one more. example: gr1comma, gr2comma, gr3comma <br/>
 * close course <br/>
 * </p>
 * 
 * @author alberto
...
public class EnrolmentCreateGroupsWithCSVTest extends BaseSeleneseTestCase {
    ...
    public void testEnrolmentCreateGroupsWithCSV() throws Exception {
        ...
        enrolmentEditor = (EnrolmentEditor) courseEditor.selectCourseElement("Enrollment");
