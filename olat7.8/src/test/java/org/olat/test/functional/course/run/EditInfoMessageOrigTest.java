 ...
 */
public class EditInfoMessageOrigTest extends BaseSeleneseTestCase {
    ...
    /**
     * Login, create an empty, logout, login, go to Learning resources, select Courses, select "Messages Course", Show content, open Course Editor, insert a Info message
     * course element, publish course, add messages, count if the messages are there, show older messages, count the messages, show current messages, count the messages.
     * 
     * @throws Exception
     */
    // @Test
    ...
    /**
     * Login with the standard admin and the standard author, open "Messages Course", open course building block "Messages", standard admin edit a message, author try to
     * edit the same message, and try to delete it. The main goal of this test is to check if the lock are correctly set and released.
     * 
     * @throws Exception
     */
    ...
    public void testConcurrentEditMessage() throws Exception {
        ...
        infoRun1.dialogOk();
        // author cancel editing
        infoRun2.cancel();
        System.out.println("admin finds message: isMessageAlreadyEdited");
        ...
        infoRun1.cancel();
        System.out.println("author finds message: isMessageAlreadyEdited");
