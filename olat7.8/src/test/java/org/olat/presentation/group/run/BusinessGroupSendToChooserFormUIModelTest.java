...
public class BusinessGroupSendToChooserFormUIModelTest {
    ...
    public void shouldCreateAContactMessageWithThreeContactlists() {
        ...
        // exercise
        BusinessGroupSendToChooserFormUIModel sendToChooserFormUIModel = new BusinessGroupSendToChooserFormUIModel(peterBichselAsFromIdentity, ownerGroup,
                participantGroup, waitingList);
        ContactMessage contactMessage = sendToChooserFormUIModel.getContactMessage();
