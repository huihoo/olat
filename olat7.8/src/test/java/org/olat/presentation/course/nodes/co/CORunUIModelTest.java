...
public class CORunUIModelTest {
    ...
    public void testInitializationOfCourseContactMessageWithEmptyValues() {
        ...
        CourseContactMessageUIModel courseContactMessageUIModel = new CourseContactMessageUIModel(mSubject, mBody, emailListConfig, grpList, areaList,
                courseOLATResourceable, courseGroupManager, partipsConfigured, coachesConfigured, translator);
    ...
    public void testContactRunWithEmptyCourseContactMessage() {
        ...
        // exercise
        CourseContactMessageUIModel emptyCourseContactMessageUIModel = new CourseContactMessageUIModel(mSubject, mBody, emailListConfig, grpList, areaList,
                courseOLATResourceable, courseGroupManager, partipsConfigured, coachesConfigured, translator);
