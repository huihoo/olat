...
public class ObjectMother {
    ...
    private static OLATPrincipal createUserPrincipalMockFrom(String userName, final String userFirstName, final String userLastName, final String userEmail,
            final String userInstitutionalEmail) {
