...
public class BaseSecurityITCase extends OlatTestCase {
    ...
    public void testSecurityGroup() {
        ...
        final Identity ident2 = baseSecurityManager.createAndPersistIdentity("gugus", null, AUTHENTICATION_PROVIDER_OLAT, "uuu", Encoder.bCryptEncode("ppp"));
    ...
    public void testGetIdentitiesByPowerSearch() {
        ...
        userProperties.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "678"); // per default the % is only attached at the end of the query.
        results = baseSecurityManager.getIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null, null, null, null);
        assertTrue(results.size() == 0);
        results = baseSecurityManager.getVisibleIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null);
        assertTrue(results.size() == 0);
        ...
        userProperties = new HashMap<String, String>();
        userProperties.put(UserConstants.INSTITUTIONALNAME, "uz");
        userProperties.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "%678");
        results = baseSecurityManager.getIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null, null, null, null);
        ...
        userProperties = new HashMap<String, String>();
        userProperties.put(UserConstants.INSTITUTIONALNAME, "uz");
        userProperties.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "12-345-678");
        results = baseSecurityManager.getIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null, null, null, null);
        assertTrue(results.size() == 2);
        results = baseSecurityManager.getVisibleIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null);
        assertTrue(results.size() == 1);
        ...
        userProperties = new HashMap<String, String>();
        userProperties.put(UserConstants.INSTITUTIONALNAME, "uz");
        userProperties.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "888");
        results = baseSecurityManager.getIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null, null, null, null);
        assertTrue(results.size() == 0);
        results = baseSecurityManager.getVisibleIdentitiesByPowerSearch(null, userProperties, true, null, null, null, null, null);
        assertTrue(results.size() == 0);
    ...
    public void testGetIdentitiesByPowerSearchWithUserPropertiesAndIntersectionOption() {
        ...
        final Identity multiPropeIdentity = baseSecurityManager.createAndPersistIdentityAndUser("multipropuser", multiPropUser, AUTHENTICATION_PROVIDER_OLAT,
                "multipropuser", Encoder.bCryptEncode("ppp"));
    ...
    public void testMultipleUserPropertiesSearches() {
        ...
        userService.setUserProperty(multiPropUser, UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "multiinst2");
        ...
        final Identity twoPropeIdentity = baseSecurityManager.createAndPersistIdentityAndUser(firstNameTwoPropUser, twoPropUser, AUTHENTICATION_PROVIDER_OLAT,
                firstNameTwoPropUser, Encoder.bCryptEncode("ppp"));
        ...
        userProperties.put(UserConstants.INSTITUTIONALNAME, "multiinst2");
        userProperties.put(UserConstants.INSTITUTIONALEMAIL, "multiinst2@lustig.com");
        userProperties.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "multiinst2");
    ...
    private Identity getOrCreateTestIdentityWithAuth(final String name, final String authProvider) {
        ...
        if (ident != null) {
            ...
            userService.setUserProperty(user, UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "12-345-678-908");
            ident = baseSecurityManager.createAndPersistIdentityAndUser(name, user, authProvider, name, Encoder.bCryptEncode("ppp"));
            return ident;
        }
    }
    ...
    @Test
    public void createAndPersistAuthentication_withNewCredential() {
        String credential = "plainstringpassword";
        final Identity identity = baseSecurityManager.createAndPersistIdentity("newusername", null, AUTHENTICATION_PROVIDER_OLAT, "authusername", credential);
        List<Authentication> authentications = baseSecurityManager.getAuthentications(identity);
        assertTrue(authentications.size() > 0);
        Authentication authentication = authentications.get(0);
        assertTrue(credential.equals(authentication.getNewCredential()));
        assertTrue(authentication.getCredential() == null);

        Authentication storedAuthentication = baseSecurityManager.findAuthentication(identity, AUTHENTICATION_PROVIDER_OLAT);
        assertTrue(credential.equals(storedAuthentication.getNewCredential()));
        assertTrue(storedAuthentication.getCredential() == null);
        assertNotNull(storedAuthentication.getCreationDate());
        assertNotNull(storedAuthentication.getLastModified());
    }
