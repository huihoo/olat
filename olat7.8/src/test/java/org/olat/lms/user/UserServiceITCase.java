...
public class UserServiceITCase extends OlatTestCase {
    ...
    public void setup() throws Exception {
        ...
        if (securityManager.findIdentityByName("judihui") == null) {
            ...
            userService.setUserProperty(u1, UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "id.uzh.ch");
        ...
        if (securityManager.findIdentityByName("migros") == null) {
            ...
            userService.setUserProperty(u2, UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "id.uzh.ch");
        ...
        if (securityManager.findIdentityByName("salat") == null) {
            ...
            userService.setUserProperty(u3, UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "id.uzh.ch");
    ...
    public void testUmFindUserByInstitutionalUserIdentifier() throws Exception {
        ...
        searchValue.put(UserConstants.INSTITUTIONAL_MATRICULATION_NUMBER, "id.uzh.ch");
