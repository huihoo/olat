...
public class ObjectMother {
    ...
    public static Identity createIdentity(String name) {
        UserImpl newUser = TestUserFactory.createTestUserForJunit("first_" + name, "last_" + name, name + "@email.tst");
        IdentityImpl identity = TestIdentityFactory.createTestIdentityForJunit(name, newUser);
        return identity;
    }
