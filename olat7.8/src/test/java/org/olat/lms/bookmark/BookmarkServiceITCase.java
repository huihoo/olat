 ...
 */
public class BookmarkServiceITCase extends OlatTestCase {
    ...
    public void testFindBookmarksByIdentity() {
        ...
        final List bookmarkList = bm1.findBookmarksByIdentity(s1);
    ...
    public void testFindBookmarksByIdentityAndType() {
        ...
        bm1.createAndPersistBookmark(bo4);
        bm1.createAndPersistBookmark(bo5);
        final List bookmarkList = bm1.findBookmarksByIdentity(s1, olatres.getResourceableTypeName());
        assertNotNull(bookmarkList);
    ...
    public void setUp() throws Exception {
        ...
        if (BookmarkServiceITCase.isInitialized == false) {
            BookmarkServiceITCase.isInitialized = true;
        }
