 ...
 */
public class EPStructureToArtefactITCase extends OlatTestCase {
    ...
    public void createStructureToArtefactLink() {
        ...
        final PortfolioStructure structure = epFrontendManager.createAndPersistPortfolioStructureElement(null, "struc-to-art-el", "structure-to-artefact-element");
        ...
        final List<AbstractArtefact> linkedArtfeacts = epFrontendManager.getArtefacts(structure);
    ...
    public void addArtefactsToStructure() {
        ...
        // create artefact
        final AbstractArtefact artefact1 = epFrontendManager.createAndPersistArtefact(ident1, "Forum");
    ...
    public void saveArtefact() {
        ...
        final Date collectionDate = cal.getTime();
        ...
        // test if the link is persisted
        final AbstractArtefact retrievedArtefact = epFrontendManager.loadArtefactByKey(artefact.getKey());
    ...
    public void testArtefactsPaging() {
        ...
        final PortfolioStructure structureEl = epFrontendManager.createAndPersistPortfolioStructureElement(null, "paged-structure-el", "paged-structure-element");

        final List<AbstractArtefact> children = new ArrayList<AbstractArtefact>();
        for (int i = 0; i < 20; i++) {
            AbstractArtefact artefact = epFrontendManager.createAndPersistArtefact(ident1, "Forum");
        ...
        final List<AbstractArtefact> childrenSubset = epStructureManager.getArtefacts(structureEl, 15, 10);
    ...
    public void moveUpArtefact() {
        ...
        final PortfolioStructure structureEl = epFrontendManager.createAndPersistPortfolioStructureElement(null, "move-up-structure-el-1", "move-up-structure-element");
        ...
        final List<AbstractArtefact> persistedChildren1 = epFrontendManager.getArtefacts(structureEl);
        ...
        dbInstance.commitAndCloseSession();
        // check that all is the same
        final List<AbstractArtefact> persistedChildren2 = epFrontendManager.getArtefacts(structureEl);
        ...
        dbInstance.commitAndCloseSession();
        // check that all is the same
        final List<AbstractArtefact> persistedChildren3 = epFrontendManager.getArtefacts(structureEl);
    ...
    public void moveDownArtefact() {
        // save parent and 5 children
        final PortfolioStructure structureEl = epFrontendManager.createAndPersistPortfolioStructureElement(null, "move-down-structure-el-1",
                "move-down-structure-element");
    ...
    public void collectRestrictionTestByAdding() {
        ...
        final AbstractArtefact artefact1 = epFrontendManager.createAndPersistArtefact(ident1, ForumArtefact.FORUM_ARTEFACT_TYPE);
        ...
        final AbstractArtefact artefact3 = epFrontendManager.createAndPersistArtefact(ident1, ForumArtefact.FORUM_ARTEFACT_TYPE);
        artefact3.setTitle("collect-restriction-3");
        assertTrue(epFrontendManager.addArtefactToStructure(ident1, artefact3, structureEl));

        final AbstractArtefact artefact4 = epFrontendManager.createAndPersistArtefact(ident1, ForumArtefact.FORUM_ARTEFACT_TYPE);
        ...
        final List<AbstractArtefact> retrievedArtefacts = epFrontendManager.getArtefacts(structureEl);
