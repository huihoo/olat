 ...
 * @author guido
 */
@ContextConfiguration(loader = MockServletContextWebContextLoader.class, locations = { "classpath:org/olat/lms/commons/scheduler/scheduler.xml" })
public class SchedulerITCase extends AbstractJUnit4SpringContextTests {
