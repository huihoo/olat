...
public class NotificationConcurrencyPublishEventNGTest extends AbstractTestNGSpringContextTests {
    ...
    public void publishEventOneSubscriptionsForOnePublisher() {
        ...
        System.out.println("publishEventOneSubscriptionsForOnePublisher - numEvents: " + numEvents);
