...
public class XSSFilterTest {
    ...
    @Test
    public void test_disallow_script_tags_2() {
        testsToRun = 1;
        String badString = "abb<script>alert('XSS');</script>a";
        t(badString, "abba");
    }
    ...
    public void test_links() {
        ...
        t("<a target=\"_blank\" href=\"http://www.frentix.com\" onclick=\"javascript:alert('hallo');\" title=\"a good link\" class=\"b_link_extern\">a complicated link</a>",
                "<a class=\"b_link_extern\" href=\"http://www.frentix.com\" target=\"_blank\" title=\"a good link\">a complicated link</a>");
    }
    ...
    public void test_tiny_lists() {
        ...
        t("<ol style=\"font-size: 20pt;\">\n<li>numbered list</li>\n<li>adf</li>\n<li>asdfa</li>\n</ol>",
                "<ol style=\"font-size: 20.0pt;\"> <li>numbered list</li> <li>adf</li> <li>asdfa</li> </ol>");
    }
    ...
    public void test_tiny_tables() {
        ...
        t("<table border=\"1\" style=\"width: 268px; height: 81px;\" class=\"b_table\">\n<caption>bliblablue</caption>\n<tbody>\n<tr>\n<td>\n<p>adsfadsf</p>\n</td>\n<td>asdf</td>\n</tr>\n<tr>\n<td>asf</td>\n<td>\n<p>asdf</p>\n</td>\n</tr>\n</tbody>\n</table>",
                "<table border=\"1\" class=\"b_table\" style=\"width: 268.0px;height: 81.0px;\"> <caption>bliblablue</caption> <tbody> <tr> <td> <p>adsfadsf</p> </td> <td>asdf</td> </tr> <tr> <td>asf</td> <td> <p>asdf</p> </td> </tr> </tbody> </table>");
        t("<tr style=\"background-color: rgb(46, 147, 209);\">\n<td style=\"border: 1px solid rgb(240, 68, 14);\">asf</td>\n<td>\n<p>asdf</p>\n</td>\n</tr>",
                "<tr style=\"background-color: rgb(46,147,209);\"> <td style=\"border: 1.0px solid rgb(240,68,14);\">asf</td> <td> <p>asdf</p> </td> </tr>");
    }
    ...
    @Test
    public void filterXSS_escapes_umlauts() {
        String anyString = "für";
        String filteredString = FilterFactory.filterXSS(anyString);

        // System.out.println("anyString: " + anyString);
        // System.out.println("filteredString: " + filteredString);

        assertTrue(filteredString.indexOf("&uuml;") != -1);

    }

    @Test
    public void filterXSS_keeps_style() {
        String badString = "<b>styled</b><script>alert('XSS');</script>text";
        String filteredString = FilterFactory.filterXSS(badString);

        // System.out.println("badString: " + badString);
        // System.out.println("filteredString: " + filteredString);

        assertTrue(filteredString.indexOf("<script>") == -1);
        assertTrue(filteredString.indexOf("script") == -1);
        assertTrue(filteredString.indexOf("<b>styled</b>") != -1);
    }
