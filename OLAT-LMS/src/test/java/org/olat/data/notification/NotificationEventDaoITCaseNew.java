...
public class NotificationEventDaoITCaseNew extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void setup() {
        ...
        subscriber_2 = createTestSubscriber("test2");
    ...
    public void createAndSaveEvent() {
        ...
        } else if (event.getSubscription().getSubscriber().getIdentity().getName().equals("test2")) {
    ...
    public void testEquals_SameObjects() {
        ...
        assertTrue("Wrong equals implementation, different types are recognized as equals ", testNotificationEvent.equals(testNotificationEvent));
    }

    @Test
    @Ignore
    public void testEquals_SameSubscriptionAndCreatedDate() {
        NotificationEvent notificationEvent = createTestNotificationEvent(0);
        NotificationEvent otherSameNotificationEvent = mock(NotificationEvent.class);
        when(otherSameNotificationEvent.getCreationDate()).thenReturn(notificationEvent.getCreationDate());
        when(otherSameNotificationEvent.getSubscription()).thenReturn(notificationEvent.getSubscription());
        when(otherSameNotificationEvent.getStatus()).thenReturn(notificationEvent.getStatus());
        assertTrue("Wrong equals implementation, same objects are NOT recognized as equals ", notificationEvent.equals(otherSameNotificationEvent));
    }
