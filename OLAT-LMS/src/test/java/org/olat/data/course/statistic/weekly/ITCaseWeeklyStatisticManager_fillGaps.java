...
import org.olat.data.course.statistic.weekly.WeeklyStatisticDaoImpl;

@Ignore("TEST-TO-FIX: cg/6.4.2011: Likely no error from layer-refactoring (problem with week/year and year-change; locale start-day-of-week)")
public class ITCaseWeeklyStatisticManager_fillGaps extends TestCase {

    private WeeklyStatisticDaoImpl manager_;

    @Override
    protected void setUp() throws Exception {
        manager_ = new WeeklyStatisticDaoImpl();
    }
