...
public class ITCaseLoggingVersionManagerImpl extends OlatTestCase {

    private LoggingVersionDao loggingVersionManager_;

    @Before
    public void setUp() throws Exception {
        loggingVersionManager_ = new LoggingVersionDaoImpl();
    }
