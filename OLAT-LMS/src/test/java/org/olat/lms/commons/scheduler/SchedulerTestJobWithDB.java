...
/**
 * <h3>Description:</h3> Test job that makes a database call. Please note that almost all olat jobs will have implicit database calls! To be save, always use the
 * JobWithDB!!
 * <p>
...
public class SchedulerTestJobWithDB extends JobWithDB {
    ...
    public void executeWithDB(JobExecutionContext arg0) throws JobExecutionException {
        ...
        try {
            DBFactory.getInstance(false).find("from org.olat.data.basesecurity.Identity");
            ...
            List resuList = DBFactory.getInstance(true).find("from org.olat.data.basesecurity.Identity");
