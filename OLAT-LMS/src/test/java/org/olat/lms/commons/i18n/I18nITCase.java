...
import org.olat.presentation.i18n.InlineTranslationInterceptHandlerController;
import org.olat.presentation.i18n.InlineTranslationLinkBuilder;
import org.olat.presentation.i18n.LocalizationMarkupHtmlReplacer;
...
public class I18nITCase extends OlatTestCase {
    ...
    private static final String testSourceBundle = "org.olat.lms.commons.i18n.junittestdata.devtools.source";
    private static final String testTargetBundle = "org.olat.lms.commons.i18n.junittestdata.devtools.target";
    private static final String testMoveTargetBundle = "org.olat.lms.commons.i18n.junittestdata.movetarget.source";
    private static final String testNewBundle = "org.olat.lms.commons.i18n.junittestdata.new";
    private static final String bundleName = "org.olat.lms.commons.i18n.junittestdata";
    ...
    public void testSearchForBundleNamesContainingI18nFiles() {
        ...
        assertTrue(foundBundles.contains("org.olat.presentation"));
        assertTrue(foundBundles.contains("org.olat.presentation.framework.core"));
        assertTrue(foundBundles.contains("org.olat.presentation.framework.layout.fullWebApp"));
    ...
    public void testGetPropertyFile() {
        if (I18nModule.isTransToolEnabled()) {
            File baseDir = I18nModule.getPropertyFilesBaseDir(i18nMgr.getLocaleOrDefault("de"), "org.olat.presentation");
            File file = i18nMgr.getPropertiesFile(i18nMgr.getLocaleOrDefault("de"), "org.olat.presentation", baseDir);
            assertTrue(file.exists());
            // test get metadata file
            file = i18nMgr.getPropertiesFile(null, "org.olat.presentation", baseDir);
            assertNotNull(file);
            try {
    ...
    public void testGetSaveOrUpdateAndDeleteProperties() {
        ...
        Properties props = i18nMgr.getResolvedProperties(i18nMgr.getLocaleOrDefault("de"), "org.olat.presentation");
        assertNotNull(props);
    ...
    public void testGetBundleAndKeyPriority() {
        ...
        // default values
        metadataProperties = i18nMgr.getPropertiesWithoutResolvingRecursively(null, bundleName + ".subtest");
        assertNotNull(metadataProperties);
        assertTrue(metadataProperties.size() == 0);
        assertEquals(I18nManager.DEFAULT_BUNDLE_PRIORITY, i18nMgr.getBundlePriority("bla.bla")); // default priority
        assertEquals(I18nManager.DEFAULT_KEY_PRIORITY, i18nMgr.getKeyPriority(metadataProperties, "no.need.to.translate.this", bundleName + ".subtest"));
    }
    ...
    public void testCountI18nItemsAndBundles() {
        ...
        // count bundles tests
        assertEquals(0, i18nMgr.countBundles("org.olat.presentation.i18n.nonexisting", true));
        assertEquals(1, i18nMgr.countBundles("org.olat.presentation.i18n", true));
        // finds 4: regular: i18n.devtools, i18n.ui; from junit tests: i18n.junittestdata, i18n.junittestdata.subtest
        assertEquals(4, i18nMgr.countBundles("org.olat.presentation.framework.i18n", true));
        assertEquals(0, i18nMgr.countBundles("org.olat.presentation.framework.i18n", false));
        assertEquals(1, i18nMgr.countBundles("org.olat.presentation.framework.i18n.ui", false));
        ...
        assertEquals(3, i18nMgr.countI18nItems(testLocale, bundleName, false));
        assertEquals(10, i18nMgr.countI18nItems(testLocale, bundleName, true));
    }
    ...
    public void testFindInKeysAndFindInValues() {
        ...
        assertEquals(1, i18nMgr.findI18nItemsByValueSearch("Bitte f*llen Sie dieses Feld aus", testLocale, testLocale, "org.olat.presentation", false).size());
        // escape reserved regexp keywords
        assertEquals(1, i18nMgr.findI18nItemsByValueSearch("LMS", testLocale, testLocale, "org.olat.presentation", false).size());
        assertEquals(1, i18nMgr.findI18nItemsByValueSearch("MS", testLocale, testLocale, "org.olat.presentation", false).size());
        assertEquals(3, i18nMgr.findI18nItemsByValueSearch("*Learning", testLocale, testLocale, "org.olat.presentation", false).size());
    ...
    public void testFindMissingI18nItems() {
        ...
        assertEquals(0, i18nMgr.findMissingI18nItems(sourceLocale, targetLocale, bundleName + ".notexists", true).size());
        assertEquals(0, i18nMgr.findMissingI18nItems(sourceLocale, targetLocale, bundleName + ".notexists", false).size());
    ...
    public void testInlineTranslationReplaceLocalizationMarkupWithHTML() {
        ...
        Translator inlineTrans = PackageUtil.createPackageTranslator(InlineTranslationInterceptHandlerController.class, i18nMgr.getLocaleOrNull("de"));
        ...
        String plainVanillaWrapped = i18nMgr.getLocalizedString(bundleName, testKey, null, i18nMgr.getLocaleOrNull("de"), false, false);
        ...
        InlineTranslationLinkBuilder.buildInlineTranslationLink(args, inlineTransLink, inlineTrans, inlineTranslationURLBuilder);
        // Plain vanilla text
        String convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(plainVanillaWrapped, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinLink, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinLinkAndSpan, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinMultipleLinks, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinInput, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinCheckbox, inlineTranslationURLBuilder, inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinMultipleLinksAndInput, inlineTranslationURLBuilder,
                inlineTrans);
        ...
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedWithinAttribute, inlineTranslationURLBuilder, inlineTrans);
        ...
        String translatedUltimate = translatedWithinMultipleLinksAndInput + rawtext1 + translatedWithinAttribute + translatedWithinMultipleLinksAndInput + rawtext2
                + translatedWithinInput + translatedWithinLinkAndSpan;
        convertedToHTMLMarkup = LocalizationMarkupHtmlReplacer.replaceLocalizationMarkupWithHTML(translatedUltimate, inlineTranslationURLBuilder, inlineTrans);
    ...
    public void testResolvePropertiesInternalKeys() {
        String bundleNameTemp = bundleName + ".subtest";
        Locale locale = Locale.GERMAN;
        // first tests with cache enabled
        i18nMgr.setCachingEnabled(true);
        assertEquals("Hello world, this is just a test", i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test", null, locale, false, true));
        assertEquals("Hello world, this is just a test (dont translate it)", i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test2", null, locale, false, true));
        // test with . and ,
        assertEquals("Hello world, this is just a test. Really dont translate it, because this is just a test.",
                i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test3", null, locale, false, true));
        // a combined word
        assertEquals("Hello world, this is obersuperduper", i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test4", null, locale, false, true));
        // a endless loop that can't be resolved
        assertEquals("Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop "
                + "Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop "
                + "Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop "
                + "Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop "
                + "Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop " + "Loop $" + bundleName
                + ".subtest:recursive.test5", i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test5", null, locale, false, true));
        ...
        assertEquals("Hello world, this is obersuperduper", i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test4", null, locale, false, true));
        // a endless loop that can't be resolved
        assertEquals("Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop Loop $" + bundleName + ".subtest:recursive.test5",
                i18nMgr.getLocalizedString(bundleNameTemp, "recursive.test5", null, locale, false, true));
