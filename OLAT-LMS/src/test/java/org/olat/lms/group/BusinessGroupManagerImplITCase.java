...
public class BusinessGroupManagerImplITCase extends OlatTestCase {
    ...
    public void setUp() throws Exception {
        ...
        /*
		 * Membership in ParticipiantGroups............................. id1 owns BuddyGroup one with participiantGroup:={}........... id2 owns BuddyGroup two
		 * with participiantGroup:={id3,id4} id3 owns BuddyGroup three participiantGroup:={id2}, ownerGroup:={id3,id1}
         */
    ...
    /**
	 * Test existence of BuddyGroups inserted in the setUp phase................ this test rather tests the findXXX methods............................... so if the
	 * setup was ok, and this test also fulfilled, then it means that createAndPersistBuddyGroup works, and also the findXXX methods.
     * 
     * @throws Exception
     */
    @Test
    ...
    public void testMoveIdenityFromWaitingListToParticipant() throws Exception {
        ...
        final List<Identity> identities = new ArrayList<Identity>();
        identities.add(wg4);
        businessGroupService.moveIdenityFromWaitingListToParticipant(identities, wg1, bgWithWaitingList, flags);
        // Check position of 'wg2'
    ...
    private void setupWaitingList(final BusinessGroupService businessGroupService) {
        if (businessGroupService.findBusinessGroupsOwnedBy(BusinessGroup.TYPE_LEARNINGROUP, id1, null).size() == 0) {
			...
			wg1 = baseSecurity.createAndPersistIdentity("bg_wg1", UserWg1, AUTHENTICATION_PROVIDER_OLAT, "bg_wg1",
					Encoder.encrypt("wg1"));
			final User UserWg2 = userService.createAndPersistUser("FirstName_wg2", "LastName_wg2", "wg2_junittest@olat.uzh.ch");
			wg2 = baseSecurity.createAndPersistIdentity("bg_wg2", UserWg2, AUTHENTICATION_PROVIDER_OLAT, "bg_wg2",
					Encoder.encrypt("wg2"));
			final User UserWg3 = userService.createAndPersistUser("FirstName_wg3", "LastName_wg3", "wg3_junittest@olat.uzh.ch");
			wg3 = baseSecurity.createAndPersistIdentity("bg_wg3", UserWg3, AUTHENTICATION_PROVIDER_OLAT, "bg_wg3",
					Encoder.encrypt("wg3"));
			final User UserWg4 = userService.createAndPersistUser("FirstName_wg4", "LastName_wg4", "wg4_junittest@olat.uzh.ch");
			wg4 = baseSecurity.createAndPersistIdentity("bg_wg4", UserWg4, AUTHENTICATION_PROVIDER_OLAT, "bg_wg4",
					Encoder.encrypt("wg4"));
        }
