 ...
 * @author guretzki
 */
public class NotificationTypeHandlerSelectorTest {

    private NotificationTypeHandlerSelector typeHandlerSelectorTestObject;
    ...
    public void setup() {
        ...
        typeHandlerSelectorTestObject = new NotificationTypeHandlerSelector();
    ...
    public void getTypeHandlerFrom_Forum() {
        ...
        NotificationTypeHandler forumTypeHandler = typeHandlerSelectorTestObject.getTypeHandlerFrom(publisherData);
