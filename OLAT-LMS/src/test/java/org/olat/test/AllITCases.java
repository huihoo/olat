...
/**
 * Description:<br>
 * JUnit suite runner There are basically three types of tests: Tests that extend from the olatTestCase (testcase loads a full olat before running the tests -- very slow
 * and is an integration test) Tests that load their own little spring context with @ContextConfiguration (that's how it should be done) Tests that do not need any Spring
 * context As tests with @ContextConfiguration can taint the context from olattestcase they must be placed on the end of the list!
 * <P>
...
import org.olat.lms.notifications.NotificationsManagerITCase;
...
import org.olat.lms.search.document.file.FileDocumentFactoryITCase;
...
@Suite.SuiteClasses({ FileUtilsITCase.class, ZipUtilITCase.class, BaseSecurityITCase.class, NoteITCase.class, UserServiceITCase.class,
        ...
        WikiUnitITCase.class, CookbookDiffTest.class, PropertyITCase.class, FileDocumentFactoryITCase.class, CatalogServiceImplTest.class, BookmarkServiceITCase.class,
        NotificationsManagerITCase.class, RegistrationServiceITCase.class, ProjectBrokerManagerITCase.class, DBITCase.class, CPManagerITCase.class,
        FeedManagerImplITCase.class, IdentityITCase.class, LDAPLoginITCase.class, MarkingITCase.class, SpringInitDestroyVerficationITCase.class,
        ITCaseLoggingVersionManagerImpl.class, UserCommentsAndRatingsITCase.class, UserNodeAuditManagerITCase.class, ShibbolethAttributeTest.class,
        PortfolioModuleITCase.class, EPArtefactManagerITCase.class, EPFrontendManagerITCase.class, EPStructureManagerITCase.class, EPStructureToArtefactITCase.class,
        InfoManagerITCase.class, SimpleTagProposalManagerITCase.class, SingleVMLockerTest.class, TaggingManagerITCase.class, LockingServiceITCase.class,
        NoDependencyBetweenLearningServiceITCase.class,
        /**
