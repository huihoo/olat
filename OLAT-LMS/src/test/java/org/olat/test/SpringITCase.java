...
/**
 * <h3>Description:</h3> Test if the spring loading mechanism works
 * <p>
...
public class SpringITCase extends AbstractJUnit4SpringContextTests {
    ...
    public void testSpringLoadConfigManuallyAsClasspathResource() {
        try {
            final Resource resource = new ClassPathResource("/serviceconfig/com/frentix/spring/test/_spring/olatextconfig.xml");
    ...
    public void testSpringLoadSingleResource() {
        try {
            final Resource resource = applicationContext.getResource("/com/frentix/spring/test/testresource.png");
            assertTrue(resource != null && resource.exists());
        } catch (final Exception e) {
            fail(e.getMessage());
        }
    ...
    public void testSpringLoadMultipleResourcesWithWildcard() {
        try {
            final Resource[] resources = applicationContext.getResources("/com/frentix/spring/test/*.png");
