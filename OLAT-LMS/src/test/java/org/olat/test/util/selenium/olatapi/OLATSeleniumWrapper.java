...
public class OLATSeleniumWrapper extends Assert {
    ...
    /**
     * Helper method. Use this instead of the selenium object.
     * 
     * @param text
     * @return
     */
    ...
    /**
     * Helper method Use this instead of the selenium method
     * 
     * Check for the Element with given locator
     * 
     * @param locator
     *            The locator for the element to check for
    ...
    /**
     * Helper method. Only selects the iframe and types the text, back to the top frame. No save, finish is called.
     * 
     * @param text
     */
