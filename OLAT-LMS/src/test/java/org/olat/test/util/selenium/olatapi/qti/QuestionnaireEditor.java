...
/**
 * Subclass of the TestEditor. It allows to add section nodes or question nodes of the type: SINGLE_CHOICE, MULTIPLE_CHOICE, GAP_TEXT, and ESSAY. It offers an
 * EssayQuestionEditor more than the TestEditor.
 * 
...
public class QuestionnaireEditor extends TestEditor {
    ...
    /**
     * Checks the question type. QUESTION_TYPES: SINGLE_CHOICE, MULTIPLE_CHOICE, GAP_TEXT, and ESSAY.
     * 
