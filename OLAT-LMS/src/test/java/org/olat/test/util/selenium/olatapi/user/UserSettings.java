...
public class UserSettings extends OLATSeleniumWrapper {
     ...
     * 
     * @param firstname
     *            , could be null if the change is not desired.
    ...
    /**
     * Sets users roles. If a parameter is null, the role state doesn't change.
     * 
     * @param isUserManager
     *            , if null, no change, else on/off accordingly with the boolean value.
     * @param isGroupManager
     * @param isAuthor
     * @param isSysAdmin
     * @param isLearningResourceAdmin
     */
    public void setRoles(Boolean isUserManager, Boolean isGroupManager, Boolean isAuthor, Boolean isSysAdmin, Boolean isLearningResourceAdmin) {
