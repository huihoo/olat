...
public class BlogResource extends ResourceEditor {
    ...
    /**
     * This edits an existing entry, therefore if description or content are null, they don't get changed. The title cannot be null.
     * 
     * @param title
     * @param description
     * @param content
    ...
    /**
     * Include external blog. Suppose that a valid feedURL is provided.
     * 
     * @param title
     * @param description
     * @param feedURL
