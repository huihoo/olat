...
/**
 * This is a Gap-text or FILL-in-BLANK QuestionEditor with 2 modes: Test and Questionnaire. (The class might be splitted later in specific types.)
 * <p>
...
public class FIBQuestionEditor extends QuestionEditor {
    ...
    /**
     * Only for tests! Inserts the solution text in the blank field of the selected GAP_TEXT question.
     * 
     * @param newText
    ...
    /**
     * Only for tests! Question/answer tab of the GAP_TEXT question type.
     * 
     * @param elemIndex
     */
