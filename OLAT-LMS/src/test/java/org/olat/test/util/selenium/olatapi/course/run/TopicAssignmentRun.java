...
public class TopicAssignmentRun extends CourseElement {
     ...
     */
    @Deprecated
    public TopicEditor createTopic(String title, String description, String faculty, String registrationStartDate, String registrationEndDate, String dueStartDate,
            String dueEndDate, boolean limitVacancies, int vacanciesNumber, String attachment, boolean emailNotification) {
