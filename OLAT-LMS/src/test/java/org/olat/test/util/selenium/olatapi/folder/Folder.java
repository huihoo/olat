...
/**
 * Generic Folder abstraction for the FolderRunController. Supposed to be used from: Personal folder, Storage folder in course editor, Folder node in course run, etc.
 * 
...
public class Folder extends OLATSeleniumWrapper {
    ...
    /**
     * Creates a file with a given name in the current container. It checks if the filename is valid and returns true if valid, false otherwise. Closes the overlay.
     * 
     * @param fileName
     */
