...
public class CourseRun extends OLATSeleniumWrapper {
    ...
    /**
     * Selects root, it must start with: title. (Warning: the titles are truncated! if they are longer than 22 chars)
     * 
     * @param title
     * @return
     */
    ...
    /**
     * Selects course element. CourseRun page still valid (returns void). Use this if the type of the selected element doesn't matter.
     * 
     * @param title
     */
    ...
    /**
     * Closes the CourseRun tab. (Leaves the CourseRun context.) Get to the previous selected tab
     * 
     */
