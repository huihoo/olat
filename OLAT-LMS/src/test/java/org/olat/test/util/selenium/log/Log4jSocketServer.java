            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        System.out.println("[Log4jSocketServer] Connected to client at " + socket.getInetAddress());
                        ...
                        Thread thread = new Thread(socketNode, "SimpleSocketServer-" + port);
                    ...
                    thread_ = null;
                    for (Iterator<Socket> it = socketNodeSockets_.iterator(); it.hasNext();) {
