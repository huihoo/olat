...
/**
 * 
 * Tests attempts settings of a test integrated in a course. <br/>
 * Test setup: <br/>
 * -
 * <p>
 * Test case: <br/>
...
public class CheckTestAttempts extends BaseSeleneseTestCase {
    ...
    public void testIntegrateTestAndCheckAttempts() throws Exception {
        ...
        courseRunAuthor.getGroupManagement().createGroupAndAddMembers(GROUP_NAME, context.getStandardAuthorOlatLoginInfos().getUsername(),
                context.getStandardStudentOlatLoginInfos().getUsername());
