...
/**
 * 
 * Tests the new bb topic assignment. Step 1: Configuration. <br/>
 * <p>
 * Test setup:<br/>
 ...
 * 
 * Testcase:<br/>
 * 1. log in as AUTHOR 2. go to learning resources 3. search for TOPIC_ASSIGNMENT_COURSE from test setup 4. edit content of TOPIC_ASSIGNMENT_COURSE 5. add bb topic
 * assignment, name it TOPIC_ASSIGNMENT_1 6. go to tab configuration 7. limit number or project per student to 2 8. check the two other dependent checkboxes, save 9. go
 * to tab persons in charge 10. add TUTOR1, TUTOR2, TUTOR3 as topic authors (leave all other config options as default) 11. publish TOPIC_ASSIGNMENT_COURSE, set access to
 * all registered users 12. log out
 * </p>
 * 
 * @author sandra
 * 
...
public class CreateAndConfigureTopicAssignmentTest extends BaseSeleneseTestCase {
    ...
    public void testCreateAndConfigureTopicAssignment() throws Exception {
        ...
        TopicAssignmentEditor topicAssignmentEditor = (TopicAssignmentEditor) courseEditor.insertCourseElement(CourseEditor.CourseElemTypes.TOPIC_ASSIGNMENT, true,
                TopicAssignmentSuite.TOPIC_ASSIGNMENT_1);
