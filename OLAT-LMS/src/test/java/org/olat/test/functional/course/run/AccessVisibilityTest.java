...
/**
 * 
 * Tests course elements with access and visibility restrictions. <br/>
 * Test setup: <br/>
...
public class AccessVisibilityTest extends BaseSeleneseTestCase {
    ...
    public void testAccessVisibility() throws Exception {
        ...
        AssessmentForm assessmentForm = courseRun1.getAssessmentTool()
                .getAssessmentFormAsPerUser(context.getStandardStudentOlatLoginInfos(1).getUsername(), "Assessment");
