...
/**
 * Tests that the org.olat.lms.course.nodes.FOCourseNode.doInSync codepoint is reached. <br/>
 * 
 * Test case: <br/>
 * Opens a new Forum topic in a clean "Demo Course" with no forum threads into the "Forum" node. Asserts codepoint reached.
 * 
