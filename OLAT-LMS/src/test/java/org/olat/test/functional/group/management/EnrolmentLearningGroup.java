...
/**
 * 
 * Student subscribes to waiting list and moves up to regular group member when other student cancels his enrolment, part of test suite GroupManagementCombiTest.java. <br/>
 * Test setup: <br/>
 ...
 * 2. Student 1 enrols and checks if he is on waiting list. Logout of Student 1<br/>
 * 3. Student 2 opens course COURSE_NAME and navigates to same enrolment course element. <br/>
 * 5. Student 2 cancels enrolment. Logout of Student 2<br/>
...
public class EnrolmentLearningGroup extends BaseSeleneseTestCase {
    ...
    public void testEnrolmentLearningGroupTest() throws Exception {
		...
		EnrolmentRun enrolmentRun1 = courseRun1.selectEnrolment("Enrollment");
		...
		EnrolmentRun enrolmentRun2 = courseRun2.selectEnrolment("Enrollment");
		...
		courseRun3.selectCourseElement("Enrollment");
