...
/**
 * 
 * Tests granting and revoking tutoring rights for one or more groups and assessing students in such groups. <br/>
 * <p>
 * Test setup: <br/>
 * Expects a special "AssessmentTool" course must be imported. Same tutor is tutoring two groups, each group has one student. <br/>
 * <p>
