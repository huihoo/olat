...
/**
 * 
 * Author adds the questionnaire element to a course and tests the different configurations in the questionnaire run, part of test suite CombiQuestionnaireTest.java. <br/>
 * Test setup: <br/>
 * -
 * <p>
 * Test case: <br/>
 ...
 * 3. Author sets configuration options: allow menu navigation, show menu navigation, allow cancel, do not allow suspend. <br/>
 * 5. Author publishes course. <br/>
 * 6. Student opens course COURSE_NAME and starts questionnaire QUESTIONNAIRE_NAME and checks if the above configuration options are effective. <br/>
 * 7. Student edits answers and finishes questionnaire.<br/>
 * 8. Student tries to start questionnaire for the second time, check if message that questionnaire was already solved is shown. <br/>
 * 
 * @author sandra
 * 
 */
public class IntegrateQuestionnaireAndCheckAttempts extends BaseSeleneseTestCase {
    ...
    public void testCreateQuestionnaireCheckAttempts() throws Exception {
        ...
        CourseEditor courseEditor = olatWorkflow.getLearningResources().createCourseAndStartEditing(CombiQuestionnaireTest.COURSE_NAME,
                CombiQuestionnaireTest.COURSE_DESCRIPTION);
        ;

        // author adds questionnaire
        QuestionnaireElementEditor questionnaireElementEditor = (QuestionnaireElementEditor) courseEditor.insertCourseElement(CourseEditor.CourseElemTypes.QUESTIONNAIRE,
                true, "Questionnaire");
