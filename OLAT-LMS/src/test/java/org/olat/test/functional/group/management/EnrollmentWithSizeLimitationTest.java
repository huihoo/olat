 ...
 * define a learning group with a place limitation (assert that the place limitation is saved), waiting list and automatic adding. Add users until the group is full,
 * remove one user, assert that the first on the waiting list is included in the group <br/>
 * </p> Test case: <br/>
...
public class EnrollmentWithSizeLimitationTest extends BaseSeleneseTestCase {
    ...
    public void testEnrolmentWaitingList() throws Exception {
		...
		EnrolmentRun enrolmentRun_0 =  courseRun_0.selectEnrolment("Enrollment");
		...
		EnrolmentRun enrolmentRun_1 = courseRun_1.selectEnrolment("Enrollment");
		...
		enrolmentRun_1 = courseRun_1.selectEnrolment("Enrollment");
    ...
    private CourseRun selectEnrolment(OlatLoginInfos student, String courseName) {
		...
		courseRun.selectCourseElement("Enrollment");
        return courseRun;
    }
