 ...
 * 12. move "renamed page copy" to the same hierarchy as the "fi&rst paäge" <br/>
 * ??? possible to drag&drop with selenium? 13. delete "renamed page copy" <br/>
