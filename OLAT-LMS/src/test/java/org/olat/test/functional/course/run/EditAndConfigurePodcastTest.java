...
/**
 * 
 * Tests the Podcast BB and Podcast Editor. Also tests issue OLAT-5767 <br/>
 * <p>
 * Test setup: <br/>
 ...
 * <p>
 * Test case: <br/>
 * *--- AS AUTHOR: ---* login as author and go to tab learning resources <br/>
 ...
 * click "Finish" <br/>
 * close editor <br/>
 * *--- AS STUDENT: ---* login as student and go to tab learning resources <br/>
 * click "Search form" <br/>
 * enter "EditPodcastCourse" <br/>
 * run course <br/>
 * select BB "Podcast intern" <br/>
 * assure is visible "A modified Podcast Entry Description" <br/>
 * click on "Add episode" enter title "A Studi Podcast" <br/>
 ...
 * *--- CONTINUE AS AUTHOR: ---* select BB "Podcast intern" <br/>
 * assure is visible "audio" and "A Student Podcast Entry Description" <br/>
 * click on "Add episode" enter title "My Second Podcast" enter desription "Can students still read this Podcast" <br/>
 * select mp3 audio file <br/>
 * click on "Publish" <br/>
 * assure is visible "Can students still read this Podcast" <br/>
 * *--- CONTINUE AS STUDENT: ---* select BB "Podcast intern" <br/>
 * assure is visible "Can students still read this Podcast" <br/>
 * *--- CONTINUE AS AUTHOR: ---* go to tab learning resources <br/>
 * click "Search form" <br/>
