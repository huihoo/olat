 ...
 * It is also supposed that there is a learning group associated with this course which contains at least one student and one tutor. <br/>
 * 
 * Test case: <br/>
...
public class AssessmentTest extends BaseSeleneseTestCase {
    ...
    /**
     * Tests the update of the scoreEvaluation (score/passed) in course for a student, and for a tutor in AssessmentTool after a change in the score calculation rule
     * (CourseEditor/Score). This assumes that the passed cut value for this course is 10. The value will be next increased to 15 so the student should see the correct
     * passed/failed information in her "Evidence of achievement".
     */
