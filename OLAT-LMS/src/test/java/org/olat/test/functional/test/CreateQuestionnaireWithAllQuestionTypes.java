...
/**
 * 
 * Author creates questionnaire with all question types, part of test suite CombiQuestionnaireTest.java. <br/>
 * Test setup: <br/>
 * -
 * <p>
 * Test case: <br/>
...
public class CreateQuestionnaireWithAllQuestionTypes extends BaseSeleneseTestCase {
    ...
    public void testCreateQuestionnaireCheckAttempts() throws Exception {
        ...
        QuestionnaireEditor questionnaireEditor = olatWorkflowHelper.getLearningResources().createQuestionnaireAndStartEditing(CombiQuestionnaireTest.QUESTIONNAIRE_NAME,
                CombiQuestionnaireTest.QUESTIONNAIRE_DESCRIPTION);
