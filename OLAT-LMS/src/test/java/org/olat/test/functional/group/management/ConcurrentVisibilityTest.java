...
/**
 * 
 * Tests if group dependent visibility restrictions on course elements work depending on group membership. <br/>
 * Test setup: <br/>
...
public class ConcurrentVisibilityTest extends BaseSeleneseTestCase {
    ...
    public void testConcurrentVisibility() throws Exception {
        ...
        /*
         * courseRun1.selectCourseElement("Folder"); selenium1 = courseRun1.getSelenium();
         */
        ...
        for (int second = 0;; second++) {
            if (second >= 60)
                fail("timeout");
            try {
                if (root.getSelenium().isTextPresent(
                        "Your access rights have been altered in the meantime. Therefore you cannot select the course element required anymore.")) {
