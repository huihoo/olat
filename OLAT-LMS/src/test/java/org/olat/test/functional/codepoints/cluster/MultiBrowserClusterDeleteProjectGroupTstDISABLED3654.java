...
public class MultiBrowserClusterDeleteProjectGroupTstDISABLED3654 extends BaseSeleneseTestCase {
    ...
    public void testMultiBrowserClusterNewLearningArea() throws Exception {
        ...
        CodepointRef createAreaCpA = codepointClientA.getCodepoint("org.olat.lms.group.BusinessGroupManagerImpl.deleteBusinessGroupWithMail");
        ...
        CodepointRef createAreaCpB = codepointClientB.getCodepoint("org.olat.lms.group.BusinessGroupManagerImpl.deleteBusinessGroupWithMail");
        ...
        // one of the two should probably get a warning saying that the group was deleted by someone else at the same time - or nothing, since it was successfully deleted
        // - just not by the person him/herself...
