...
/**
 * Performance test; it measures the time needed to open course, click few times (numOfIterations) in course, close course, and repeat for all courses on the first page
 * (LearningResources/Courses).
 * 
...
public class OpenAllCoursesOnFirstPageTest extends BaseSeleneseTestCase {
    ...
    /**
     * Open learning resources, select courses menu item select each course on first page, repeat testIteration. When course run is open select first courseElemIterations
     * elements, and close course tab.
     * 
     * @throws Exception
     */
