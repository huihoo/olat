...
/**
 * Interface for account creation of an instant messaging account on a suitable server. Change spring config at module instant messaging to choose an other implementation
 * at startup. An instance of the implemenation is created at startup by the InstantMessagingModule.init() method.
 * 
 * @author guido
 */
