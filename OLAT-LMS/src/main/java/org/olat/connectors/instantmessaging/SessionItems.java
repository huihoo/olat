 ...
 * also used for chat/groupchat stuff. With this class we use the IM server to get information of all users clusterwide.
 * <P>
...
public class SessionItems extends IQ {
    ...
    private final List<ConnectedUsersListEntry> sessions = new ArrayList<ConnectedUsersListEntry>();
