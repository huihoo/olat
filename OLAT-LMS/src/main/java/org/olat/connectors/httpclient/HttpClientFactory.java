...
/**
 * <h3>Description:</h3> The HttpClientFactory creates multithreaded jakarta commons HttpClients that feature SSL capability with support for unsigned SSL certificates. <br>
