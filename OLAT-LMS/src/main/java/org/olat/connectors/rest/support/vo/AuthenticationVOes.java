...
/**
 * Description:<br>
 * This an helper class for the WADL documentation. Don't use it in the REST API!!!
 * <P>
...
public class AuthenticationVOes {
    ...
    public void setAuthentications(final List<AuthenticationVO> authentications) {
