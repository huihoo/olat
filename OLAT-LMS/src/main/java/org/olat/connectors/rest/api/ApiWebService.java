 ...
 * <p>
 */
package org.olat.connectors.rest.api;
...
public class ApiWebService {
    ...
    public Response getHtmlDoc() {
        final InputStream in = ApiWebService.class.getResourceAsStream("../../../../application.html");
    ...
    @Path("doc/{filename}")
    @Produces("image/jpeg")
    public Response getImage1(@PathParam("filename") final String filename) {
        final InputStream in = ApiWebService.class.getResourceAsStream("_content/" + filename);
        return Response.ok(in).build();
    }
    ...
    @Path("{filename}")
    @Produces("image/jpeg")
    public Response getImage2(@PathParam("filename") final String filename) {
        final InputStream in = ApiWebService.class.getResourceAsStream("_content/" + filename);
        return Response.ok(in).build();
    }
