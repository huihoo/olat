...
public class CourseElementWebService extends AbstractCourseNodeWebService {
    ...
    public Response getTaskConfiguration(@PathParam("courseId") final Long courseId, @PathParam("nodeId") final String nodeId) {
        ...
        final Boolean isDropboxConfirmationMailEnabled = (Boolean) moduleConfig.get(TACourseNode.CONF_DROPBOX_ENABLEMAIL);
        ...
        final String dropboxConfirmationText = moduleConfig.getStringValue(TACourseNode.CONF_DROPBOX_CONFIRMATION);
    ...
    public class TaskFullConfig implements FullConfigDelegate {
        ...
        public void configure(final ICourse course, final CourseNode newNode, final ModuleConfiguration moduleConfig) {
            ...
            if (enableDropboxConfirmationMail != null) {
                moduleConfig.set(TACourseNode.CONF_DROPBOX_ENABLEMAIL, enableDropboxConfirmationMail);
            }
            if (dropboxConfirmationText != null) {
                moduleConfig.setStringValue(TACourseNode.CONF_DROPBOX_CONFIRMATION, dropboxConfirmationText);
            }
