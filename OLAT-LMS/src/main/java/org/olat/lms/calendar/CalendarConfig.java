...
public class CalendarConfig {
    ...
    public CalendarConfig() {
        this("Calendar", CalendarRenderWrapper.CALENDAR_COLOR_BLUE, true);
    }

    public CalendarConfig(final String displayName, final String calendarCSS, final boolean visible) {
