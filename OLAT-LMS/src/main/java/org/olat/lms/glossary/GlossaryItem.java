...
public class GlossaryItem implements Comparable<Object> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GlossaryItem) {
            ...
            if (getGlossTerm().equalsIgnoreCase(glossItem.getGlossTerm())) {
                return true;
            }
        }
        return false;
