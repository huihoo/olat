...
/**
 * Description:<br>
 * Connects to a morphological service and lets retrieve flexions for a word. This is a variant to be used with german glossaries and is only compatible with the defined
 * service.
 * <P>
...
public class MorphologicalServiceDEImpl implements MorphologicalService {
	 ...
	 * 
	 */
    protected MorphologicalServiceDEImpl() {
    ...
    public String assumePartOfSpeech(String glossTerm) {
        ...
        if (glossTerm.split(" ").length > 1 && firstChar.equals(firstChar.toLowerCase()))
            return "an";
