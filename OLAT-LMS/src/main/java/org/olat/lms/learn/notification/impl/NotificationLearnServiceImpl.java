...
public class NotificationLearnServiceImpl extends LearnBaseService implements NotificationLearnService {
    ...
    public NotifyStatistics notifySubscribers() {
        return notificationService.notifySubscribers();
    }
    ...
    @Override
    public void sendNotification(List<Identity> identities, SubscriptionContext subscriptionContext, PublisherData publisherData) {
        // TODO Auto-generated method stub
