...
public interface NotificationLearnService extends LearnService {
    ...
    Subscription subscribe(NotificationSubscriptionContext subscriptionContext); // TODO: need publisher-data ?
     ...
     * Mitteilungen
     */
    void sendNotification(List<Identity> identities, SubscriptionContext subscriptionContext, PublisherData publisherData);
