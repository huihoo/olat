...
/**
 * Description:<br>
 * Conjuction between a wiki implementation and the wikiMarkupComponent. The component asks the wikiImpl wheather a page already exists or not to render the link
 * appropriate.
 * 
 * <P>
