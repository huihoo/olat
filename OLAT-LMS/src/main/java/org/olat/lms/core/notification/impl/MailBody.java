...
public class MailBody {
    ...
    public MailBody(List<NotificationEventTO> eventToList, Translator translator, String olatWebUrl, UriBuilder uriBuilder2) {
        ...
        mailBodyInfo = new MailBodyInfo(translator, olatWebUrl);
