...
public class PublishEventTO {
    ...
    // TODO: REVIEW: bb/01.03.2012 class should be immutable and so thread-safe (final instance variables, no setters etc.)
    private Identity creator;
    private PublisherTO publisher;

    private String contextTitle; // e.g. course title
    private String sourceTitle; // e.g. forum title
    private String sourceEntryTitle; // e.g. message title
    ...
    // public static PublishEventTO getValidInstance(ContextType contextType, Long contextId, String contextTitle, Long subcontextId, String sourceType, Long
    // sourceId,
    // String sourceTitle, String sourceEntryTitle, String sourceEntryId, Identity creator, EventType eventType) {
    //
    // PublishEventTO event = new PublishEventTO(contextTitle, sourceTitle, sourceEntryTitle, sourceEntryId, creator, eventType);
