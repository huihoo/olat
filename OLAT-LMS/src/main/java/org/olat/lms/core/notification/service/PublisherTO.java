...
public class PublisherTO {
    ...
    public static PublisherTO createNewPublisherTOInCourse(Long contextId, Long subcontextId) {
        ...
        return new PublisherTO(ContextType.COURSE, contextId, subcontextId, null, new Long(0));
    }
    ...
    private void validate() {
        ...
        // TODO: OLAT-1011: cg/12.03.2012 We will have only course context, should check only not null because it is an enum ?
