...
/**
 * Description:<br>
 * The comment and rating service offers GUI elements to comment and rate OLATResourceable objects. The objects can be specified even more precise by providing an
 * optional sub path
 * <p>
 * Get an instance of this service by calling the ServiceCreatorFactory and then call the init method to initialize the service for your resource:
 * 
 * <pre>
...
public interface CommentAndRatingService {
    ...
    /**
     * Get the user comments manager. This is normally not used by code from other packages.
     * 
     * @return
     */
    ...
    /**
     * Create a user comments controller that show the number of comments. In the initial view the comments are not visible. When clicking on the number of comments the
    ...
    /**
     * Create a minimized user comments controller that only shows the number of comments and allows the user rate the resource on a scale of 1-5. The link information
    ...
    /**
     * Create a user comments controller that show the number of comments and allows the user rate the resource on a scale of 1-5. In the initial view the comments are
     * not visible. When clicking on the number of comments the comments are displayed.
     * 
     * @param ureq
     * @param wControl
     * @return
    ...
    /**
     * Delete all comments and ratings for this resource and subpath configuration. See also the deleteAllIgnoringSubPath() method.
     * 
    ...
    /**
     * Delete all comments and ratings for this resource while ignoring the resource sub path. Use this when you delete the resource and not an element within the
     * resource.
     * 
     * @param int number of deleted comments and ratings
     */
