...
/**
 * TODO: Class Description for QtiResultService
 * 
 * <P>
 ...
 * @author guretzki
 */
public interface QTIResultService {
     ...
     */
    public abstract List selectResults(final Long olatResource, final String olatResourceDetail, final Long repositoryRef, final int type);
