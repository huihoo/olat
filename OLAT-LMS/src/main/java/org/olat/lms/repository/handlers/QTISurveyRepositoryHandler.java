 ...
 */
@Component
public class QTISurveyRepositoryHandler extends QTIRepositoryHandler {
    ...
    @Autowired
    SurveyFileResource fr;

    /**
     * Default constructor.
     */
    protected QTISurveyRepositoryHandler() {
        super();
    }
    ...
    public Controller createEditorController(final OLATResourceable res, final UserRequest ureq, final WindowControl wControl) {
        ...
        final List referencees = referenceService.getReferencesTo(res);
