...
import org.olat.lms.course.wizard.create.CourseCreationMailHelper;
...
public class CourseRepositoryHandler implements RepositoryHandler {
    ...
    private static final String PACKAGE = PackageUtil.getPackageName(RepositoryServiceImpl.class);
