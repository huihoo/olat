 ...
 */
@Component
public class BlogRepositoryHandler implements RepositoryHandler {
	 ...
	 * 
	 */
    protected BlogRepositoryHandler() {
    ...
    public boolean readyToDelete(final OLATResourceable res, final UserRequest ureq, final WindowControl wControl) {
        ...
        if (referencesSummary != null) {
            final Translator translator = PackageUtil.createPackageTranslator(IAddController.class, ureq.getLocale());
