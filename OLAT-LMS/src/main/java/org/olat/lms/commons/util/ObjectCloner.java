...
public class ObjectCloner {
    ...
    /**
     * Determines the size of an object in bytes when it is serialized. <br>
     * This should not be used for anything other than optimization testing since it can be memory and processor intensive. <br>
     * 
