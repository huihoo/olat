...
public enum LmsSpringBeanTypes implements BeanType {
    basicManager(BasicManager.class), notificationsHandler(NotificationsHandler.class), notificationsUpgrade(NotificationsUpgrade.class), repositoryHandler(
            RepositoryHandler.class), bookmarkHandler(BookmarkHandler.class), userDataDeletable(UserDataDeletable.class);
