...
/**
 * Description:<br>
 * A temporary media resource that uses another name for the download than the actual name of the file. This is handy when the file has a temporary filename. The mime
 * type is computed from the provided file name.
 * <p>
 * The file is delivered as attachment. Use the FileMediaResource to deliver a file inline.
 * <P>
...
public class NamedFileMediaResource extends FileMediaResource {
     ...
     *            The description or NULL (no linebreak, will be used as Content-Description)
     * @param deleteAfterDelivery
     *            true: file will be deleted from disk when release() is called (after delivery); false: file remains untouched after delivery
     */
