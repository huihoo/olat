...
/**
 * <h3>Description:</h3> The I18nItem represents a unique identifiable translation item within the system consisting of
 * <ul>
 * <li>the bundle e.g. (org.olat.presentation)</li>
 * <li>the key (my.example.title)</li>
 * <li>the locale (de)</li>
 * </ul>
 * To get the translated value for such a string, use the i18nManager.getI18nValue() method
 * <p>
