 ...
 * <p>
 */
package org.olat.lms.commons.scheduler;
...
/**
 * <h3>Description:</h3> This abstract class implements the regular Quartz job interface and allows the user to implement an alternative execute method. This abstract
 * class should be used whenever the job does some hibernate calls using the DBFactory.
 * <p>
...
public abstract class JobWithDB extends QuartzJobBean {
    // A logger instantiated for the implementing class of this abstract class
