...
public enum LearnServices {
    ...
    businessGroupService(BusinessGroupService.class), userService(UserService.class), baseSecurity(BaseSecurity.class), calendarService(CalendarService.class), importCalendarManager(
            ImportCalendarManager.class), // TODO: integrate import-part to calendar-service
    repositoryService(RepositoryServiceImpl.class), helloWorldService(HelloWorldLearnService.class), notificationLearnService(NotificationLearnService.class);
