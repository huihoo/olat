...
public class RepositoryEntryIndexerFactory {
    ...
    private final Map handlerMap = new HashMap(10);

    static {
        INSTANCE = new RepositoryEntryIndexerFactory();
    }
    ...
    public void registerIndexer(final Indexer indexer) {
     ...
     * @return Singleton.
     */
    public static RepositoryEntryIndexerFactory getInstance() {
        return INSTANCE;
    }
     ...
     */
    public Indexer getRepositoryEntryIndexer(final RepositoryEntry re) {
        final OLATResourceable ores = re.getOlatResource();
        if (ores == null) {
            throw new AssertException("RepositoryEntry has no OlatResource [re.getOlatResource()==null].");
        }
     ...
     * @return the handler or null if no appropriate handler could be found
     */
    public Indexer getRepositoryEntryIndexer(final String resourceableTypeName) {
