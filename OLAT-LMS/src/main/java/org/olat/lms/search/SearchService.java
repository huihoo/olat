...
public interface SearchService {
     ...
     *            Lucene query string
     * @param identity
     *            Idenity of searching-user
     * @param roles
     *            Roles of searching-user
     * @param doHighlighting
     *            Highlights founded text fragements in result
    ...
    /**
     * Change index-interval of running system immediately to reduce system load. Overwrites the config parameter 'indexInterval'. The value will not be stored persistent
     * and will be lost at next restart.
     * 
     * @param indexInterval
     *            New index-interval.
     */
