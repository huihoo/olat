...
public class PortfolioRepositoryIndexer extends AbstractIndexer implements Indexer {
    ...
    @Override
    public void doIndex(final SearchResourceContext resourceContext, final Object object, final OlatFullIndexer indexWriter) throws IOException, InterruptedException {
