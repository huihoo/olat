...
import org.olat.lms.core.notification.impl.AbstractNotificationTypeHandler;
 ...
 */
@Component
public class FolderNotificationTypeHandler extends AbstractNotificationTypeHandler {
    ...
    public PublishEventTO createPublishEventTO(SubscriptionContext subsContext, Long resourceableId, Identity identity, String fileRelPath, String fileName,
        ...
        System.out.println("TEST createPublishEventTO setSourceEntryId with relPath=" + fileRelPath);
