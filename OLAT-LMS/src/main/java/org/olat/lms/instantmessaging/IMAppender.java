...
/**
 * Allows sending log messages to instant messaging recipients over a jabber server. See log4j.properties for configuration issues.
 * <P>
...
public class IMAppender extends AppenderSkeleton {
    ...
    private final List recipientsList = new ArrayList();
    ...
    public void setRecipients(final String recipients) {
        ...
        final StringTokenizer stockenizer = new StringTokenizer(recipients, DELIMITER);
    ...
    public void setChatroom(final boolean chatroom) {
     ...
     * <p>
     * It checks whether there is an output chat available and also if there is a set layout. If these checks fail, then the boolean value <code>false</code> is returned.
     */
    ...
    /**
     * The IMAppender requires a layout. Hence, this method returns <code>true</code>.
     */
    @Override
