...
import org.olat.presentation.course.editor.NodeConfigFormController;
...
public abstract class GenericCourseNode extends GenericNode implements CourseNode {
    ...
    public RepositoryEntry getReferencedRepositoryEntry(final boolean strict) {
        ...
        final RepositoryEntry entry = getRepositoryService().lookupRepositoryEntryBySoftkey(repositorySoftkey, strict);
        return entry;
    }
    ...
    private RepositoryService getRepositoryService() {
        final RepositoryService repoService = RepositoryServiceImpl.getInstance();
        return repoService;
    }
