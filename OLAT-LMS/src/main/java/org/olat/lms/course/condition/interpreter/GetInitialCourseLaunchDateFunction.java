...
/**
 * Description:<br>
 * Function to get the users initial launch date for this course. If no course has taken place so far, the date will have a future date value.
 * <P>
...
public class GetInitialCourseLaunchDateFunction extends AbstractFunction {
     ...
     * @param userCourseEnv
     */
    public GetInitialCourseLaunchDateFunction(final UserCourseEnvironment userCourseEnv) {
        super(userCourseEnv);
    }
    ...
    public Object call(final Object[] inStack) {
        ...
        final PropertyImpl firstTime = pm.findCourseNodeProperty(node, identity, null, ICourse.PROPERTY_INITIAL_LAUNCH_DATE);
        if (firstTime != null) {
