...
public class ArgumentParseException extends RuntimeException {
     ...
     * @param msg
     */
    public ArgumentParseException(final String msg) {
        super(msg);
    }
     ...
     */
    public ArgumentParseException(final int errNo, final String functionName, final String wrongArgs, final String whatsWrong, final String solutionProposal) {
        this.errNo = errNo;
