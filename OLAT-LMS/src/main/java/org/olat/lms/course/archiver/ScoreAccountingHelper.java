...
public class ScoreAccountingHelper {
     ...
     */
    public static List loadUsers(final CourseEnvironment courseEnv) {
        final List identites = new ArrayList();
        ...
        while (iter.hasNext()) {
            ...
            final List ids = securityManager.getIdentitiesOfSecurityGroup(participants);
     ...
     */
    public static List loadAssessableNodes(final CourseEnvironment courseEnv) {
     ...
     * @param nodeList
     */
    private static void collectAssessableCourseNodes(final CourseNode node, final List nodeList) {
