...
public class COCourseNode extends AbstractAccessableCourseNode implements UsedByXstream {
	...
	private ContactRunUIModel createUIModelFromModuleConfiguration(CourseGroupManager cgm, OLATResourceable courseOLATResourceable, Translator translator, Identity identity) {
		...
		CourseContactMessageUIModel courseContactMessageUIModel = new CourseContactMessageUIModel(mSubject, mBody, emailListConfig, grpList, areaList, courseOLATResourceable, cgm, partipsConfigured, coachesConfigured, translator);
