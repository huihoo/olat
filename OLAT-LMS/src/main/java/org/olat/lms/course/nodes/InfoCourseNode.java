...
import org.olat.lms.notifications.NotificationServiceImpl;
...
public class InfoCourseNode extends AbstractAccessableCourseNode implements UsedByXstream {
    ...
    public void cleanupOnDelete(ICourse course) {
        ...
        getNotificationService().delete(subscriptionContext);
    ...
    private NotificationService getNotificationService() {
        return CoreSpringFactory.getBean(NotificationServiceImpl.class);
    }
}
