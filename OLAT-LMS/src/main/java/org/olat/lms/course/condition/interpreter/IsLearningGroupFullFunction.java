...
public class IsLearningGroupFullFunction extends AbstractFunction {
     ...
     * @param userCourseEnv
     */
    public IsLearningGroupFullFunction(final UserCourseEnvironment userCourseEnv, final String fnName) {
        super(userCourseEnv);
    }
    ...
    public Object call(final Object[] inStack) {
        ...
        return cgm.isLearningGroupFull(groupName, ores) ? ConditionInterpreter.INT_TRUE : ConditionInterpreter.INT_FALSE;
    }
