...
/**
 * Initial Date: Feb 6, 2004 Description:<br>
...
public abstract class AbstractFunction extends FunctionCB {
     ...
     * @param userCourseEnv
     */
    public AbstractFunction(final UserCourseEnvironment userCourseEnv) {
    ...
    /**
     * the exception handle method for each function. It checks the condition interpreters mode, e.g. if it is used in the editor environment or in the run.
     * 
     * @param e
     * @return default value of function
     */
    protected Object handleException(final Exception e) {
