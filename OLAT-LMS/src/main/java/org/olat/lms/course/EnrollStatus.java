...
public class EnrollStatus {
    ...
    private MailerResult mailerResult;
    ...
    /**
     * @return Returns the mailerResult.
     */
    public MailerResult getMailerResult() {
        return mailerResult;
    }

    /**
     * @param mailerResult
     *            The mailerResult to set.
     */
    public void setMailerResult(MailerResult mailerResult) {
        this.mailerResult = mailerResult;
    }
}
