...
public class InLearningGroupFunction extends AbstractFunction {
    ...
    public Object call(final Object[] inStack) { /*
        ...
        return cgm.isIdentityInLearningGroup(ident, groupName, getUserCourseEnv().getCourseEnvironment().getCourseOLATResourceable()) ? ConditionInterpreter.INT_TRUE
                : ConditionInterpreter.INT_FALSE;
    }
