...
public class Output implements Serializable {
     ...
     * 
     * @param el_response
     *            The el_response to set
     */
    public void setEl_response(final GenericQTIElement el_response) {
     ...
     * @param el_resolved
     */
    public void addItem_El_response(final Element el_answerchosen, final Element el_new_response) {
    ...
    public Element getItemFeedback(final int which) {
        return ((Element[]) itemresponses.get(which))[1];
    }

    public Element getItemAnswerChosen(final int which) {
