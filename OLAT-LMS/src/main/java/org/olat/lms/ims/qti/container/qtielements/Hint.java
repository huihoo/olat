...
public class Hint extends GenericQTIElement {
     ...
     * @param el_hint
     */
    public Hint(final Element el_hint) {
        super(el_hint);
        final String fbstyle = el_hint.attributeValue("feedbackstyle");
        if (fbstyle != null) {
            if (fbstyle.equals("Complete")) {
                ...
                throw new AssertException("Invalid feedbackstyle in hint element " + getIdent() + ": " + fbstyle);
            }
        }
    }
