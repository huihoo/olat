...
public class FIBResponse extends Response {
     ...
     * @param string
     */
    public void setCorrectBlank(final String string) {
        correctBlank = string;
    }
    ...
    /**
     * Sets case sensitiveness of this response. String can be 'Yes' or 'No'. In any other cases, including string==null, the case will be set to 'Yes'.
     * 
     * @param string
     */
    public void setCaseSensitive(final String string) {
        if (string != null && string.equals(CASE_NO)) {
            caseSensitive = CASE_NO;
        } else {
            caseSensitive = CASE_YES; // default
        }
    }

    /**
     * Returns the size for this fib blank. If size is set to 0, the default size is returned
     * 
    ...
    /**
     * Returns the maxLength for this fib blank. If maxLength is set to 0, the default maxLength is returned
     * 
    ...
    /**
     * Sets the size. If the given int is 0 the default size is used instead
     * 
     * @param i
     */
    ...
    /**
     * Sets se size to the given string value. If string is null or a not stored in this column attribute.It the attribute is null the size is set to the default size
     * value
     * 
     * @param i
     */
    public void setSizeFromString(final String value) {
        if (value == null) {
            size = SIZE_DEFAULT;
            return;
        }
     ...
     * @param i
     */
    public void setMaxLengthFromString(final String value) {
        if (value == null) {
            maxLength = MAXLENGTH_DEFAULT;
            return;
        }
