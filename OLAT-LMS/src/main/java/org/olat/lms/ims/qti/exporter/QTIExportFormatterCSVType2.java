...
public class QTIExportFormatterCSVType2 extends QTIExportFormatter {
    ...
    public QTIExportFormatterCSVType2(final Locale locale, final IdentityAnonymizerCallback anonymizerCallback, final String sep, final String emb, final String esc,
