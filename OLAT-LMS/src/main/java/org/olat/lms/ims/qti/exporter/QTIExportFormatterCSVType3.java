...
public class QTIExportFormatterCSVType3 extends QTIExportFormatter {
    ...
    public QTIExportFormatterCSVType3(final Locale locale, final IdentityAnonymizerCallback anonymizerCallback, final String sep, final String emb, final String esc,
    ...
    public void openReport() {
        ...
        if (mapWithExportItemConfigs == null) {
            ...
            mapWithExportItemConfigs = qTIItemConfigurations.getQTIItemConfigs(qtiItemObjectList);
        }
