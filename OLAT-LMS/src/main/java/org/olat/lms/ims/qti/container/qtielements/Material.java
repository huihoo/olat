...
public class Material extends GenericQTIElement {
     ...
     * @param el_material
     */
    public Material(final Element el_material) {
        super(el_material);
    }
    ...
    public void render(final StringBuilder buffer, final RenderInstructions ri) {
        ...
        final Integer flowMatClass = (Integer) ri.get(RenderInstructions.KEY_FLOW_MAT);
        if (flowMatClass != null) {
            iFlowMatClass = flowMatClass.intValue();
        }
