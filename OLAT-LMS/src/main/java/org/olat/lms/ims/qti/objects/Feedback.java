...
public class Feedback implements QTIObject {
     ...
     *            The material to set
     */
    public void setMaterials(final List materials) {
    ...
    public void addToElement(final Element root) {
        ...
        final Element feedback = root.addElement(rootName + "feedback");
        ...
        for (final Iterator i = this.materials.iterator(); i.hasNext();) {
