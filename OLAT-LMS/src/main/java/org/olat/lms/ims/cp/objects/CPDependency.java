...
public class CPDependency extends DefaultElement implements CPNode {
     ...
     * 
     * @param identifierRef
     *            the identifierRef of this dependency
     */
    ...
    public boolean validateElement() {
        if (this.identifierRef == null || this.identifierRef.equals("")) {
            throw new OLATRuntimeException(CPOrganizations.class, "Invalid IMS-Manifest (missing \"identifierref\" attribute in dependency element )", new Exception());
        }
        return true;
    }
