...
public class ForumRTFFormatter extends ForumFormatter {
    ...
    private final ForumService fm = (ForumService) CoreSpringFactory.getBean("forumService");
    ...
    final Pattern PATTERN_CSS_O_FOQUOTE = Pattern
            .compile(
    ...
    private final String HIDDEN_STR = "VERBORGEN";
    ...
    public void visit(final INode node) {
        ...
        sb.append(" \\par}");
        // attachment(s)
        final OlatRootFolderImpl msgContainer = fm.getMessageContainer((Long) (getMetainfo(ForumFormatter.MANDATORY_METAINFO_KEY)), mn.getKey());
