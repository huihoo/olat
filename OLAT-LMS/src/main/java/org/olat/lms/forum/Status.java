...
/**
 * Description:<br>
 * Encapsulates the status of a <code>Message</code>, and converts the statusCode integer into a meaningful Status object, and vice versa.
 * <P>
...
public class Status {
     ...
     */
    public static Status getStatus(final int statusCode) {
     ...
     * @return
     */
    public static int getStatusCode(final Status status) {
        int statusCode = 0;
        if (status.isMoved()) {
            statusCode += 8;
        }
