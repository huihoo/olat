...
/**
 * TODO: Class Description for ForumServiceImpl
 * 
 * <P>
...
public class ForumServiceImpl implements ForumService {
    ...
    public OlatRootFolderImpl getMessageContainer(Long forumKey, Long messageKey) {
        return forumDao.getMessageContainer(forumKey, messageKey);
    }
    ...
    /**
     * TODO: delegate impl to the forumDao.
     * 
     * @param forumKey
     * @return
     */
    public OlatRootFolderImpl getForumContainer(final Long forumKey) {
        return forumDao.getForumContainer(forumKey);
    }

    public String getFileSize(final Long forumKey) {
