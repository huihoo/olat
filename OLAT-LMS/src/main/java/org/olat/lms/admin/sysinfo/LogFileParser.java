...
public class LogFileParser {
     ...
     * [spring]
     */
	private LogFileParser(String configuredLogDir, String configuredUserDataDir) {
		// TODO Oliver: what about configuring logfiles?
    ...
    /**
     * extracts the errormessage from a line in the logfile and formats it for the html
     * 
     * @param s
     * @return errormsg
     */
    private static String extractErrorAsHTML(String s[]) {
        ...
        if (s.length == 6) {
            ...
            sb.append("<tr><td valign=\"top\"><b>Cause&nbsp;</b></td><td>" + s[5].trim().replaceAll(" at ", "<br />at ").replaceAll(">>>", "<br /><br />&gt;&gt;&gt;")
                    + "</td></tr>");
            sb.append("</table>");
        } else if (s.length == 9) {
            // the new Tracing
            ...
            sb.append("<tr><td valign=\"top\"><b>Cause&nbsp;</b></td><td>" + s[8].trim().replaceAll(" at ", "<br />at ").replaceAll(">>>", "<br /><br />&gt;&gt;&gt;")
                    + "</td></tr>");
            sb.append("</table>");
        } else {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                if (counter == 0) {
                    ...
                    errormsg.add(line);
                    counter--;
                } else if (line.matches("ERROR") || line.matches("WARN")) {
