...
public interface BusinessGroupService {
     ...
     * @return
     */
    public BusinessGroupAddResponse moveIdenityFromWaitingListToParticipant(List<Identity> chosenIdentities, Identity identity, BusinessGroup currBusinessGroup,
            BGConfigFlags flags);
     ...
     * @param mailIdentity
     */
    MailerResult deleteBusinessGroupWithMail(BusinessGroup businessGroupTodelete, List contactLists, Identity mailIdentity);
