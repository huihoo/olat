...
/**
 * TODO: Class Description for GroupDeletionService
 * 
 * <P>
...
public interface GroupDeletionService {
     ...
     * @param mailTemplate
     * @param templateChanged
     * @param keyEmailSubject
     * @param keyEmailBody
     * @param identity
     * @param translator
     * @return
     */
    public String sendDeleteEmailTo(List selectedGroups, MailTemplate mailTemplate, boolean templateChanged, String keyEmailSubject, String keyEmailBody,
