...
/**
 * Description:<BR>
 * Objects of this class contain configration flags for the various business group controllers. See the BGControllerFactory to see which group type has which
 * configuration.
 * <P>
