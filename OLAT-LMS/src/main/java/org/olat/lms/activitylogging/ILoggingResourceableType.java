 ...
 * <p>
 * Implementation-Note: This is a parent interface of OlatResourceableType (for OlatResourceables) and StringResourceableType (for simple Strings). Both are simple enums
 * - and in order to be able to have a parent interface for two enums this interface requires name() - which is the only method used by users of this
