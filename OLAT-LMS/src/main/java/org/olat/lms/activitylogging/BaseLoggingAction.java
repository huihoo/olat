 ...
 * <li>Note that typeList is mandatory yet is set later via a setTypeList call - this is due to the way the LoggingAction definition is done</li>
 * </ul>
...
public class BaseLoggingAction implements ILoggingAction {
     ...
     * <p>
     * Note that this is usually done via a static field - i.e. instances of LoggingActions are not recommended to be instanciated dynamically!
     * 
     * @param resourceAdminAction
     *            whether or not this logging action is for the eyes of an admin only (true) or also for users (false)
     * @param action
     *            one of the four crudAction types
     * @param logMessage
     *            the actual log message - should follow the default pattern (e.g. LEARNING_RESOURCE_OPEN)
     */
     ...
     * <p>
     * Note that this can only be set once and should not be null! Also note that even though this is a mandatory field it is not passed to via the constructor - this in
     * order to simplify and beautify the way LoggingActions are created
     * 
     * @param typeList
     *            not null ResourceableTypeList for this action
     ...
     * 
     * @return the crudAction (create, retrieve, update, delete) action type - directly propagates to the DB later
     */
    @Override
    ...
    /**
     * Sets the optional name of the field in which this instance is held - for DEBUGging only - this field id will be issued when there are problems with this
     * ILoggingAction's ResourceableTypeList later
     * 
     * @param javaId
     *            the java field id - or anything else which helps in your DEBUGging case - this field id will be issued when there are problems with this
     *            ILoggingAction's ResourceableTypeList later
     **/
