 ...
 * <p>
 */
package org.olat.system.event.businfo;
...
/**
 * Description:<br>
 * Helper class for the cluster mode to keep track and sum data about listeners cnt on a olat event bus channel. listener count on a channel is used as an informative
 * message mostly for authors (e.g. to decide whether or not they want to publish a course which invalidates the course and thus kicks out all users of this course.) in
 * the cluster mode, the clusterInfoEvent from a node also contains information about how many listeners listen to a resource. summing up all listeners from all nodes
...
public class BusListenerInfos {
     ...
     * 
     * @param nodeId
     *            the nodeId of the cluster to which the buslistenerinfo belongs to.
     * @param info
     *            the buslistenerInfo
     */
