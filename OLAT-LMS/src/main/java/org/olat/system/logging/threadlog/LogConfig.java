...
/**
 * Configures a ThreadLocalAwareLogger with a priority and an appender.
 * <P>
...
class LogConfig {
     ...
     * 
     * @param priority
     *            the priority - this or the appender is allowed to be null, but not both
     * @param appender
     *            the appender - this or the priority is allowed to be null, but not both
     */
