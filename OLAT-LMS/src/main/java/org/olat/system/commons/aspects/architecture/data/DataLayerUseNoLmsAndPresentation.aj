 ...
 *
 */
public aspect DataLayerUseNoLmsAndPresentation {
	
	pointcut scope():
		within(org.olat.data..*);
	...
	declare warning
		...
		: "DataLayerUseNoLmsAndPresentation: You are not allowed to use classes from the lms/presentation layers in the data layer!";
