...
public class SystemPropertiesLoader implements Initializable {
    ...
    protected List<OLATProperty> getMergedProperties() {
        return (List<OLATProperty>) new ArrayList<OLATProperty>(mergedProps.values());
    }
    ...
    protected List<OLATProperty> getOverwriteProperties() {
        return (List<OLATProperty>) new ArrayList<OLATProperty>(overwritePropertiesSorted.values());
    }

    protected List<OLATProperty> getOlatdataOverwriteProperties() {
        return (List<OLATProperty>) new ArrayList<OLATProperty>(systemConfigurationPropertiesSorted.values());
    }

    protected List<OLATProperty> getMavenProperties() {
        return (List<OLATProperty>) new ArrayList<OLATProperty>(mavenPropertiesSorted.values());
    }
