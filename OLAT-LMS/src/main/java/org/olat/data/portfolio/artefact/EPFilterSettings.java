...
public class EPFilterSettings {
    ...
    private final List<Object> filterList = new ArrayList<Object>();
    ...
    /**
     * @param tagFilter
     *            The tagFilter to set.
     */
    public void setTagFilter(final List<String> tagFilter) {
     ...
     */
    public void setTypeFilter(final List<String> typeFilter) {
     ...
     */
    public void setTextFilter(final String textFilter) {
    ...
    /**
     * @param dateFilter
     *            must be two dates (from, to), where the first is before second.
     */
    public void setDateFilter(final List<Date> dateFilter) {
    ...
    public boolean isFilterEmpty() {
        if (getTagFilter().isEmpty() && getTypeFilter().isEmpty() && getTextFilter().equals("") && getDateFilter().isEmpty() && !noTagFilterSet) {
            return true;
        }
        return false;
    }
    ...
    public EPFilterSettings cloneAfterFullText() {
        final EPFilterSettings clone = new EPFilterSettings();
        if (tagFilter != null) {
