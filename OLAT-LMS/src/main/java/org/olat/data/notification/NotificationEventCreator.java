...
public class NotificationEventCreator {
    ...
    // have @Transactional(propagation = Propagation.REQUIRES_NEW) only if this is run via ThreadPoolExecutor
    // @Transactional(propagation = Propagation.REQUIRES_NEW)
    NotificationEvent createAndSaveNotificationEvent(Map<String, String> attributes, Subscription subscription) {
        System.out.println("createAndSaveNotificationEvent");
        /** TODO: REVIEW PUBLISH PERFORMANCE (removed obsolete): bb/11.03.2012 **/
