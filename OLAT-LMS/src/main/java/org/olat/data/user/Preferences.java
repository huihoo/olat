...
/**
 * Description: Interface for a user preferences object. This is a component object of an OLAT user.
 * 
...
public interface Preferences extends Serializable {
    ...
    /**
     * Set users language settings with locale as parameter.
     * 
     * @param l
     *            new language
     */
    ...
    /**
     * Instant Messaging preferences When enabled the presence messages are shown public on the user list. Only visible in settings if module is loaded
     * 
