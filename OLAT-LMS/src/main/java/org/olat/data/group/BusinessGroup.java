...
public interface BusinessGroup extends Persistable, CreateInfo, ModifiedInfo, OLATResourceable {
    ...
    /**
     * @param name
     *            The group display name. Must never be NULL
     */
    ...
    /**
     * @param description
     *            the description of this group. Might be NULL
     */
     ...
     *            true: enable automaticly close ranks form waiting list to participant list.
     */
