...
/**
 * Description:<br>
 * Helper class created to concatenate DB specific connection properties (<code>java.util.Properties</code>) with the DB common hibernate properties within the Spring
 * config.
 * <P>
...
public class DBVendorHibernatePropertiesSimplification extends Properties {
	 ...
	 * 
	 */
    protected DBVendorHibernatePropertiesSimplification() {
        super();
    }
     ...
     */
    protected DBVendorHibernatePropertiesSimplification(Properties firstKeyValues) {
        super();
