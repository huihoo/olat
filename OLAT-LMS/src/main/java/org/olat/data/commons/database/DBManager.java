...
class DBManager extends BasicManager {
    ...
    /**
     * Hibernate Update method. Use this in a transactional context by using your current transaction object.
     * 
     * @param trx
    ...
    void updateObject(DBTransaction trx, Object o) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("update (trans " + trx.hashCode() + ") class " + o.getClass().getName() + " = " + o.toString());
            }
    ...
    /**
     * Hibernate Delete method. Use this in a transactional context by using your current transaction object.
     * 
     * @param trx
     *            The current db transaction
     * @param o
    ...
    void deleteObject(DBTransaction trx, Object o) {
        ...
        try {
            getSession().delete(o);
            if (log.isDebugEnabled()) {
                log.debug("delete (trans " + trx.hashCode() + ") class " + o.getClass().getName() + " = " + o.toString());
            }
        } catch (HibernateException e) { // we have some error
            trx.setErrorAndRollback(e);
            setError(e);
    ...
    /**
     * Hibernate Save method. Use this in a transactional context by using your current transaction object.
     * 
     * @param trx
     *            The current db transaction
     * @param o
    ...
    void saveObject(DBTransaction trx, Object o) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("save (trans " + trx.hashCode() + ") class " + o.getClass().getName() + " = " + o.toString());
            }
    ...
    /**
     * Hibernate Load method. Use this in a transactional context by using your current transaction object.
     * 
     * @param trx
     *            The current db transaction
     * @param theClass
     *            The class for the object to be loaded
     * @param pK
    ...
    Object loadObject(DBTransaction trx, Class theClass, Long pK) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("load (res " + (o == null ? "null" : "ok") + ")(trans " + trx.hashCode() + ") key " + pK + " class " + theClass.getName());
            }
     ...
     * @param type
     *            The Hibernate datatype of the search value
     */
    List find(DBTransaction trx, String query, Object value, Type type) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                ...
                logQuery("find (time " + time + ", res " + (li == null ? "null" : "" + li.size()) + ")(trans " + trx.hashCode() + ")", new Object[] { value },
                        new Type[] { type }, query);
            }
        } catch (HibernateException e) {
            trx.setErrorAndRollback(e);
     ...
     * 
     * @param object
     *            The object to be removed from hibernates session cache
     */
    ...
    /**
     * Find a Object by its identifier. This method should be used instead of loadObject when it is ok to not find the object. In oposite to the loadObject method this
     * method will return null and not throw a DBRuntimeException when the object can't be loaded.
     * 
     * @param theClass
     * @param key
    ...
    Object findObject(Class theClass, Long key) {
        ...
        /*
         * You should not use this method to determine if an instance exists (use <tt>get()</tt> instead). Use this only to retrieve an instance that you assume exists,
        ...
        if (log.isDebugEnabled()) {
            log.debug("findload (res " + (o == null ? "null" : "ok") + ") key " + key + " class " + theClass.getName());
        }
        return o;
        // } catch (HibernateException e) {
        // return null;
