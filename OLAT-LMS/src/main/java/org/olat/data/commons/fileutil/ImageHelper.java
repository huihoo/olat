...
/**
 * Helper class which scale an image and saved it as jpeg. Input format are the ones supported by standard java: gif, jpg, png.
 * 
...
public class ImageHelper {
     ...
     *            the image to scale
     * @param image
     *            extension if not available in file name (optional)
     * @param scaledImage
     *            the new scaled image
     * @param maxSize
     *            the maximum size (height or width) of the new scaled image
     * @return boolean
     */
     ...
     *            the new scaled image
     * @param maxWidth
     *            the maximum width of the new scaled image
     * @param maxheight
     *            the maximum height of the new scaled image
     * @return
     */
     ...
     *            the image to scale
     * @param image
     *            extension if not given by the image file (optional)
     * @param scaledImaged
     *            the new scaled image
     * @param maxWidth
     *            the maximum width of the new scaled image
    ...
    /**
     * Calculate the size of the new image. The method keep the ratio and doesn't scale up the image.
     * 
     * @param image
     *            the image to scale
     * @param maxWidth
    ...
    /**
     * This code is very inspired on Chris Campbells article "The Perils of Image.getScaledInstance()" The article can be found here:
     * http://today.java.net/pub/a/today/2007/04/03/perils-of-image-getscaledinstance.html Note that the filter method is threadsafe
     */
