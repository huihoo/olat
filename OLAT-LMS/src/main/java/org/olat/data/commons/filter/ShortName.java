...
/**
 * ShortName is an interface to implement if you would like to be able to present your business object (or other) in a non-html, one line String. e.g. Dropdown lists can
 * accept a List of ShortNames <br>
