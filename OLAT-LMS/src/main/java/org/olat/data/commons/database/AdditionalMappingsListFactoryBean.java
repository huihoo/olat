...
import org.olat.data.commons.DataSpringBeanTypes;
...
public class AdditionalMappingsListFactoryBean implements FactoryBean<List>, ApplicationContextAware {
    ...
    public List<AdditionalDBMappings> getObject() throws Exception {
        ...
        result.addAll(appCtx.getBeansOfType(DataSpringBeanTypes.additionalDBMappings.getExtensionTypeClass(), false, false).values());
        return result;
    }
