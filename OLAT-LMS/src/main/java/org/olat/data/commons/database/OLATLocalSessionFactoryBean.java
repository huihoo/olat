...
/**
 * Description:<br>
 * Extends the Spring LocalSessionFactoryBean to allow additional mappings for Hibernate. The additional mappings are defined in beans of the
 * org.olat.data.AdditionalDBMappings. These beans must be <strong>singleton</strong> and not use lazy-init.
 * <P>
 * &lt;bean id="markingMapping" class="org.olat.data.AdditionalDBMappings"&gt; &lt;property name="xmlFiles"&gt; &lt;list&gt; &lt;value&gt;MarkImpl.hbm.xml&lt;/value&gt;
 * &lt;/list&gt; &lt;/property&gt; &lt;/bean&gt;
 * <P>
