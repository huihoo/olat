...
/**
 * Description:<br>
 * A controller which collect a comment for a new revision of a versioned file or free the lock for the file .<br>
 * <ul>
 * <li>DONE_EVENT</li>
 * </ul>
 * <P>
...
public class VersionCommentController extends FormBasicController {
    ...
    protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
        ...
        if (lock) {
            String[] values = new String[] { getTranslator().translate("meta.unlock"), getTranslator().translate("meta.retainlock") };
