...
/**
 * Description:<br>
 * Based on the same principe as the AutoCreator, this one creates a ResultControler with the right constructor: UserRequest, WindowControl, Form and ResultDocument.
 * <P>
