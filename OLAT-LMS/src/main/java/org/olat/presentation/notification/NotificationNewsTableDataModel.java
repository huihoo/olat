 ...
 */
public class NotificationNewsTableDataModel extends DefaultTableDataModel {
    ...
    @Override
    public UserNotificationEventTO getObject(int row) {
        return (UserNotificationEventTO) super.getObject(row);
    }
    ...
    public Object createCopyWithEmptyList() {
        final NotificationNewsTableDataModel copy = new NotificationNewsTableDataModel(translator);
        return copy;
    }
