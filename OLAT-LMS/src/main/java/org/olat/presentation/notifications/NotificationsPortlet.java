...
public class NotificationsPortlet extends AbstractPortlet {
    ...
    protected NotificationsPortlet() {
    }

    @Override
    public Portlet createInstance(final WindowControl wControl, final UserRequest ureq, final Map configuration) {
        final Translator translator = PackageUtil.createPackageTranslator(NotificationsPortlet.class, ureq.getLocale());
        final Portlet p = new NotificationsPortlet();
