...
public class BlogPostFormController extends FormBasicController {
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        // Description
        description = uifactory.addRichTextElementForStringData("description", "feed.form.description", post.getDescription(), 8, -1, false, false, baseDir, null,
        ...
        // Content
        content = uifactory.addRichTextElementForStringData("content", "blog.form.content", post.getContent(), 18, -1, false, false, baseDir, null, formLayout,
