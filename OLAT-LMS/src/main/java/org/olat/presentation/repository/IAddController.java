...
public interface IAddController extends Disposable {
    ...
    /**
     * The transaction component which will be invoked by the repository add controller. Controllers may return null here if the do not need a GUI-based workflow. However
     * in such cases, they have to call addCallback.finished() at constructor time. (See AddCourseController for an example).
     * 
     ...
     * 
     * @return true if transaction could successfully finished, false otherwise. I IAddController returns false, the repository entry will not be created.
     */
