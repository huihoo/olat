...
public class StatusController extends BasicController {
    ...
    protected void updateRepositoryEntryList() {
        final List l = RepositoryDeletionManager.getInstance().getReprositoryEntriesInDeletionProcess(RepositoryDeletionManager.getInstance().getDeleteEmailDuration());
