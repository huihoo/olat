...
public class BusinessGroupFormController extends FormBasicController {
    ...
    protected boolean validateFormLogic(final UserRequest ureq) {
        ...
        if (hasWaitingGroup(businessGroup)) {
            boolean hasWaitingParticipants = hasWaitingParticipants(businessGroup);
            if (!isWaitingListEnabled() && hasWaitingParticipants) {
    ...
    private boolean hasWaitingParticipants(final BusinessGroup businessGroup) {
        boolean hasWaitingParticipants = (businessGroup.getWaitingListEnabled()).booleanValue();
