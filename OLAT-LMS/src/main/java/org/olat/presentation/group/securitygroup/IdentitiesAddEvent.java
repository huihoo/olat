...
public class IdentitiesAddEvent extends Event {
    ...
    private final List<Identity> addIdentities;
    ...
    /**
     * @param addIdentities
     *            List of Identiey which should be added
     */
    public IdentitiesAddEvent(final List<Identity> addIdentities) {
    ...
    public void setIdentitiesAddedEvent(final List<Identity> addedIdentities) {
        this.addedIdentities = addedIdentities;
    }

    public void setIdentitiesWithoutPermission(final List<Identity> identitiesWithoutPermission) {
        this.identitiesWithoutPermission = identitiesWithoutPermission;
    }

    public void setIdentitiesAlreadyInGroup(final List<Identity> identitiesAlreadyInGroup) {
