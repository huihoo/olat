...
public class UsersToGroupWizardController extends WizardController {
     ...
     */
    public UsersToGroupWizardController(final UserRequest ureq, final WindowControl wControl, final SecurityGroup aSecurityGroup, final MailTemplate mailTemplate) {
