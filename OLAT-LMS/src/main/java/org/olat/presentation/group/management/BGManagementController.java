...
public class BGManagementController extends MainLayoutBasicController implements GenericEventListener {
    ...
    private void doGroupDeleteConfirm(final UserRequest ureq) {
        ...
        if (deleteableList.isEmpty()) {
            ...
            final String[] args = new String[] { this.currentGroup.getName(), buf.toString() };
    ...
    private ContactFormController createContactFormController(final UserRequest ureq) {
        ...
        String subject = businessGroupTranslator.translate("businessgroup.contact.subject", new String[] { this.currentGroup.getName() });
        final String resourceUrl = Settings.getServerContextPathURI() + "/url/BusinessGroup/" + this.currentGroup.getKey();
        String bodyText = businessGroupTranslator.translate("businessgroup.contact.bodytext", new String[] { this.currentGroup.getName(), resourceUrl });
        ...
        ContactMessage contactMessage = sendToChooseFormUIModel.getContactMessageWithRecipientsAnd(subject, bodyText);
