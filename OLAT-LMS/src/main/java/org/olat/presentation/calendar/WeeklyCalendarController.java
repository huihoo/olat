    ...
    protected void event(final UserRequest ureq, final Controller source, final Event event) {
        ...
        if (weeklyCalendar.isDirty()) {
            if (subsContext != null) {
                ...
                getNotificationService().markPublisherNews(subsContext, ureq.getIdentity());
                ...
                CalendarRenderWrapper calWrapper = null;
                for (final Object calWrapperObj : calendarWrappers) {
                    calWrapper = (CalendarRenderWrapper) calWrapperObj;
                    if (affectedCal == calWrapper.getCalendar()) {
                        break;
                    }
                }
                if (calWrapper != null) {
                    ...
                    getNotificationService().markPublisherNews(tmpSubsContext, ureq.getIdentity());
                }
            }
        }
    }
