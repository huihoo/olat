...
public class SearchAllCalendarsController extends BasicController {
            ...
            if (event == Event.DONE_EVENT) {
                ...
                for (final Iterator iter = calendars.iterator(); iter.hasNext();) {
                    ...
                    final GenericTreeNode calendarNode = new GenericTreeNode("<i>" + translate("cal.form.calendarname") + ": "
                            + calendarWrapper.getCalendarConfig().getDisplayName() + "</i>", null);
    ...
    private String layoutEventDetails(final CalendarEntry event, final CalendarRenderWrapper calendarWrapper) {
        ...
        details.append(translate("cal.form.calendarname")).append(": ").append(calendarWrapper.getCalendarConfig().getDisplayName()).append("<br />");
