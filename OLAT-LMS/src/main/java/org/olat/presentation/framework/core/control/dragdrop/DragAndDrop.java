...
package org.olat.presentation.framework.core.control.dragdrop;
 ...
 * drag is supported, but drop not) it must be declared in the documentation and the method must throw an unsupportedoperation - exception.
 * <P>
