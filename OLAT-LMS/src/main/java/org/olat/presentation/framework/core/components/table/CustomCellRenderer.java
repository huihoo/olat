...
public interface CustomCellRenderer {
     ...
     * 
     * @param sb
     *            the StringOuput to put the rendering into
     * @param renderer
     *            the renderer to use
     * @param val
     *            the value from the tablemodel to be rendered.
     * @param locale
     *            the locale to use
     * @param alignment
     *            the alignment (see ColumnDescriptor.ALIGNMENT...)
     * @param action
     *            the action. if not null, then the output should be clickable and produce a command uri with action
     */
