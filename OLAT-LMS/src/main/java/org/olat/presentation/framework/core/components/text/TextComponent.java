...
/**
 * Description:<br>
 * The text component can be used to display a text message. The message can be either a string or an i18n key that is automatically translated during render time.
 * Optionally a CSS class can be provided.
 * <p>
...
public class TextComponent extends Component {
    ...
    /**
     * Constructor to create a text component with a translated plain vanilla text string. The text is displayed as is and not translated at render time.
     * 
     * @param name
     ...
     * 
     * @param i18nKey
     *            the key or NULL to reset
     */
    public void setI18nKey(String i18nKey) {
        if (i18nKey != null && getTranslator() == null) {
            throw new AssertException("Can not set i18n key when no translator is available. Use setTranslator() first.");
        }
