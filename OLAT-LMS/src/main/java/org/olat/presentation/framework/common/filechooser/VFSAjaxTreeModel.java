...
/**
 * Description:<br>
 * The VFS ajax tree model generates a dynamic data model for an ajax tree based on a given root container. The datamodel can be configured using a vfs item filter
 * <P>
...
class VFSAjaxTreeModel extends AjaxTreeModel {
     ...
     * @param vfsFilter
     *            The filter to be applied on the root container
     */
    ...
    /**
     * Resolve and return a VFSItem from the given tree node id that has been created by this tree model
     * 
     * @param treeNodeId
     * @return
     */
     ...
     * 
     * @param vfsItem
     * @param nodePathPrefix
     *            prefix representing the path hierarchy
     * @return
     */
