...
/**
 * <h3>Description:</h3> This layouter controller provides a fullscreen view with a back-link
 * <p>
...
public class LayoutMain3ColsBackController extends MainLayoutBasicController implements MainLayout3ColumnsController {
     ...
     *            identificator for this layout to persist the users column width settings
     */
    public LayoutMain3ColsBackController(UserRequest ureq, WindowControl wControl, Component col1, Component col2, Component col3, String layoutConfigKey) {
        super(ureq, wControl);
    ...
    /**
     * Deactivates back controller. Please do use this method here instead of getWindowControl().pop() !
     */
