...
public class Renderer {
     ...
     *            is used as a starting node for searching a component
     * @param translator
     *            the translator to be used to translate
     * @param ubu
     * @param renderResult
     ...
     * @param target
     * @param URI
     *            e.g. myspecialdispatcher/somestuff
     */
    ...
    public void render(StringOutput sb, Component source, String[] args) {
        ...
        if (source.isVisible()) {
            ...
            if (lev > 42)
                throw new AssertException("components were nested more than 42 times, assuming endless loop bug: latest comp name: " + source.getComponentName());
