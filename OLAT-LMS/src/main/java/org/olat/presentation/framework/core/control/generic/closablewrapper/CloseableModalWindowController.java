...
/**
 * <h3>Description:</h3> Modal dialog based on Ext.Window <h3>Events thrown by this controller:</h3>
 * <ul>
...
public class CloseableModalWindowController extends BasicController {
    ...
    /**
     * set the initial size of modal window. if changed by user once, this won't be read until cookies have expired or got deleted!
     * 
     * @param width
     *            in pixels
     * @param height
    ...
    public void deactivate() {
        ...
        sb.append("if( Ext.getCmp('").append(modalId).append("') != null ) {").append("  Ext.getCmp('").append(modalId).append("').close();").append("};");
