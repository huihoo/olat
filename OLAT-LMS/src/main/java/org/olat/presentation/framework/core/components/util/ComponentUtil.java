...
public class ComponentUtil {
    ...
    private static final String VELOCITY_ROOT = PackageUtil.getPackageVelocityRoot(ComponentUtil.class);
     ...
     * @param args
     *            the arguments for the translator, when you need to pass arguments to the translation. may be null
     * @param trans
     *            the translator to translate the given key
     * @param content
     *            the component which is to appear after the title
