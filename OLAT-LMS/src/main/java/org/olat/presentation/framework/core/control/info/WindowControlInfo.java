...
package org.olat.presentation.framework.core.control.info;
...
public interface WindowControlInfo {
     ...
     * 
     * @param ecstate
     *            the new state to adjust to
     * @param back
     *            if true, the transition direction is back, that is from end to start, otherwise it is forward (from start to end)
     * @param ureq
