 ...
 * 
 * @Deprecated The wiki markup area is no longer supported. In the legacy form infrastructure it's still there, but it won't be available in the new flexi forms. In flexi
 *             forms use the RichTextElement instead.
 * @author gnaegi
 */
@Deprecated
