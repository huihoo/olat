...
public interface Translator {
     ...
     * @param key
     * @param args
     * @param missingTranslationLogLevel
     *            one of Level.OFF,Level.INFO,Level.WARN,Level.ERROR
     * @return
     */
     ...
     * @param key
     * @param args
     *            the args to translate, may be null
     * @param fallBackToDefaultLocale
     *            if true fall back to configurated default language.
     * @return
     */
