...
(function() {
	...
	var translator;
	if (mainWin) {
		translator = mainWin.b_jsTranslatorFactory.getTranslator(mainWin.o_info.locale, 'org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatmatheditor')	
	} else {
		// implement dummy-translator
		translator = {	translate : function(key) { return key; } }
	}

	tinymce.create('org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatmatheditor', {
		/**
	...
	// Register plugin
	tinymce.PluginManager.add('olatmatheditor', org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatmatheditor);
})();
