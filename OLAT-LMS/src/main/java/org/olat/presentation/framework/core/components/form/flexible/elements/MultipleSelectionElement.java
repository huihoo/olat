...
public interface MultipleSelectionElement extends SelectionElement {
    ...
    /**
     * Enables or disables a checkbox. Note that this is not the same as {@link org.olat.presentation.framework.components.form.flexible.FormItem#setesetEnabled(boolean)}
     * which enables or disables <i>all</i> checkboxes of this form element.
     * 
     * @param key
     ...
     * @param isEnabled
     *            Whether the checkboxes given in <code>keys</code> are to be enabled (<code>true</code>) or disabled (<code>false</code>).
     */
    public void setEnabled(Set<String> keys, boolean isEnabled);

    /**
     * Shows or hides a checkbox. Note that this is not the same as {@link org.olat.presentation.framework.components.form.flexible.FormItem#setVisible(boolean)} which
     * shows or hides <i>all</i> checkboxes of this form element.
     * 
     * @param key
     *            The key of the checkbox.
     * @param isVisible
     *            <code>true</code> means visible.
     */
     ...
     *            Keys of the checkboxes.
     * @param isVisible
     *            Whether the checkboxes given in <code>keys</code> are to be shown (<code>true</code>) or hidden (<code>false</code>).
     */
