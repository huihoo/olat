...
public abstract class BasicView implements Disposable {
	 ...
	 * Know-how of translation a responsability of the view? provide the translator for a view for the controller/presenter and UIModel, maybe this should not be needed? 
	 * @return
	 */
