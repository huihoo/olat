...
public interface ColumnDescriptor {
    ...
    /**
     * @return the key of the header of this column. Is translated by the translator of the table to which this columndescriptor belongs to.
     */
    String getHeaderKey();

    /**
     * @return <code>true</code> if the header key should be translated by the renderer, otherwise <code>false</code>
     */
     ...
     * @param row
     * @param renderer
     *            the Renderer. if null this means that the renderValue should be in plain text (e.g. for excel download)
     */
    ...
    /**
     * @param table
     *            the backreference to the table
     */
    ...
    /**
     * called by the table if the model has changed. Useful in combination with sortingAboutToStart() to know when sortingAboutToStart() can use the cache or when it has
     * to resort again
     */
    void modelChanged();
    ...
    /**
     * called when this columnDescriptor is not being sorted by the user, but another columnDescriptor. usage: e.g. so getRenderValue(int row) can deliver different
     * results w/o being active (formatting or such)
     */
    void otherColumnDescriptorSorted();

    /**
     * @return true if this column should offer sorting (by clicking on the column header)
     */
    boolean isSortingAllowed();

    /**
     * @return true if the action link should open in a new window using java script
     */
    boolean isPopUpWindowAction();

    /**
     * @return javascript window.open attributes or null if browsers default should be used
     */
