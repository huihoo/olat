...
/**
 * Description:<br>
 * Event sent by TextBoxListComponent if changes occured or submitted. contains a list with all Elements -> getAllItems() another list keeps all added records (which were
 * added manually, means not from autocompletion list) -> getNewOnly()
 * <P>
