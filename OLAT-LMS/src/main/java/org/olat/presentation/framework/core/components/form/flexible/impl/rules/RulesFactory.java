 ...
 * <p>
 */
package org.olat.presentation.framework.core.components.form.flexible.impl.rules;
...
public class RulesFactory {
    /**
     * Creates a custom rule which is triggered whenever <code>triggerElement</code> is set to <code>triggerValue</code>. The code which gets executed resides in the
     * <code>apply</code> method of a {@link DependencyRuleApplayable} object. An implementation that executes if a trigger element changes to "true" could look like
     * this:
     * 
     * <pre>
     * {@code
     ...
     * </pre>
     * 
     * (Note that this example uses an anonymous class which makes it unnecessary for you to create a separate class which implements
     * <code>DependencyRuleApplayable</code> for each of your rules.) Don't forget to add action listeners for
     * {@link org.olat.presentation.framework.components.form.flexible.impl.FormEvent.ONCHANGE} to your trigger elements.
     * 
     * @param triggerElement
     *            The element that is being watched for changes.
     * @param triggerValue
     *            Triggers if the <code>triggerElement</code>'s key changes to <code>triggerValue</code>
     * @param targets
     *            The targets.
     * @param formLayout
     *            The container.
     ...
     * @return
     */
    public static FormItemDependencyRule createCustomRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
     ...
     * @return
     */
    public static FormItemDependencyRule createResetRule(FormItem triggerElement, Object triggerValue, Set<FormItem> targets, FormItemContainer formLayout) {
     ...
     * @return
     */
    public static FormItemDependencyRule createResetRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
        Set<FormItem> targets = new HashSet<FormItem>();
        targets.add(target);
     ...
     * @return
     */
    public static FormItemDependencyRule createHideRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
        Set<FormItem> targets = new HashSet<FormItem>();
        targets.add(target);
     ...
     * @return
     */
    public static FormItemDependencyRule createShowRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
        Set<FormItem> targets = new HashSet<FormItem>();
        targets.add(target);
     ...
     * @return
     */
    public static FormItemDependencyRule createReadOnlyRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
        Set<FormItem> targets = new HashSet<FormItem>();
        targets.add(target);
     ...
     * @return
     */
    public static FormItemDependencyRule createWritableRule(FormItem triggerElement, Object triggerValue, FormItem target, FormItemContainer formLayout) {
        Set<FormItem> targets = new HashSet<FormItem>();
        targets.add(target);
