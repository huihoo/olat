...
public class ImageComponent extends Component {
    ...
    /**
     * Call this method to display the image within a given box of width and height. The method does NOT manipulate the image itself, it does only adjust the images width
     * and height tag. <br />
     * The image will made displayed smaller, it will not enlarge the image since this always looks bad. The scaling is done in a way to get an image that is smaller than
     * the maxWidth or smaller than the maxHeight, depending on whith of the sizes produce a smaller scaling factor. <br />
