...
import org.olat.presentation.framework.core.formelements.IntegerElement;
...
public abstract class Form extends Component {
     ...
     * 
     * @param name
     *            should not contain anything critical to HTML (no ".", no umlaut, etc.)
     * @param formElement
     */
     ...
     * 
     * @param submitKeyi18n
     *            The submitKey to set
     * @deprecated since 22.11.2005 replaced by <code>addSubmitKey(String submitKeyi18n, String identifier)</code>.
     */
    @Deprecated
     ...
     * @param submitKeyi18n
     *            The submitKey to set
     * @deprecated since 19.07.2006 replaced by <code>addSubmitKey(String submitKeyi18n, String identifier)</code>.
     */
    @Deprecated
    ...
    /**
     * Sets the default cancel button. behaves like <code>setCancelKey("cancel")</code>
     */
    ...
    /**
     * Removes the default cancel button. This is only needed if you want to toggle the visibility of the button. behaves like <code>setCancelKey(null)</code>
     */
    ...
    public boolean hasMandatoryFields() {
        ...
        while (entries.hasNext()) {
            if (((FormElement) entries.next()).isMandatory())
                return true;
        }
        return false;
    }
    ...
    public boolean hasWikiMarkupFields() {
        Iterator entries = elements.values().iterator();
        while (entries.hasNext()) {
            if (entries.next() instanceof WikiMarkupTextAreaElement)
                return true;
        }
        return false;
    }
