...
public abstract class Component {
    ...
    public void validate(UserRequest ureq, ValidationResult vr) {
        if (this.dirty) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("increment component.timestamp new value=" + timestamp + " ureq=" + ureq + " component=" + this);
            }
        }
    }
    ...
    protected void fireEvent(final UserRequest ureq, final Event event) {
        ...
        for (Controller listenerA : listenerArray) {
            ...
            try {
                ...
                log.error("Error in setting up the businessPath on the IUserActivityLogger. listener=" + listener, e);
                // still continue
            }
    ...
    public void addListener(Controller controller) {
        ...
        if (listeners.contains(controller))
            throw new AssertException("controller was already added to component '" + getComponentName() + "', controller was: " + controller.toString());
     ...
     * 
     * @param domReplaceable
     *            The domReplaceable to set.
     */
