...
public class SingleSelectionImpl extends FormItemImpl implements SingleSelection {
    ...
    //
    private static final String PACKAGE = PackageUtil.getPackageName(SingleSelectionImpl.class);
    ...
    public String getFormDispatchId() {
        /**
         * FIXME:pb dirty hack or not to allow singleselection subcomponents being added to surrounding formlayouters -> e.g. language chooser selectbox
         * .................................................................. you would expect here ...+getComponent()+... for generating the form dispatch id, but it
         * must always be the formLayoutContainer -> see getComponent() to understand why this is not always the case.
         */
