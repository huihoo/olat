...
(function() {
	...
	var translator;
	if (mainWin) {
		translator = mainWin.b_jsTranslatorFactory.getTranslator(mainWin.o_info.locale, 'org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatsmileys')	
	} else {
	...
	tinymce.create('org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatsmileys', {
	...
	// Register plugin
	tinymce.PluginManager.add('olatsmileys', org.olat.presentation.framework.core.components.form.flexible.impl.elements.richText.plugins.olatsmileys);
})();
