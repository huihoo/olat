...
/**
 * Description:<br>
 * This controller wraps a component or a controller, add a link hide/show. The status is persisted in a user property which key is the persistedId defined in
 * constructor.
 * <P>
...
public class ToggleBoxController extends BasicController {
    ...
    // <a class="b_togglebox_hide" href="#"
    // onclick="Effect.Shrink('my_toggle_box_uuid',{ direction:'top-left', afterFinish: function() { top.o_openUriInMainWindow('$r.commandURI("hide")'); }}); return false;"><span>Hide</span></a>
}
