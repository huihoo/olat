 ...
 * <p>
 */
package org.olat.presentation.framework.layout.fullWebApp.util;
...
/**
 * Description:<br>
 * a message string which should be displayed on each page of the webbapplication. This is used in the OLAT LMS to display the maintenance message.
 * <P>
...
public class GlobalStickyMessage implements GenericEventListener, Initializable {
     ...
     * @return String A global message or null if no such message exists. The message will be displayed to all logged in users in a sticky way
     */
    ...
    /**
     * Sets a new global sticky message and updates all chief controllers to use the new message. The message will be displayed to all logged in users in a sticky way
     * 
     * @param message
     *            The message to display or null if no message should be used at all
     * @param global
     *            , if you like to set a message only on one node set global to false
     */
    public static void setGlobalStickyMessage(String message, boolean global) {
        ...
        log.info("Audit:Setting new maintenance message::" + maintenanceMessageGlobal);
