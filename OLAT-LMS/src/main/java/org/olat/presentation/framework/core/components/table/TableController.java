...
public class TableController extends BasicController {
     ...
     */
    public TableController(final TableGuiConfiguration tableConfig, final UserRequest ureq, final WindowControl wControl, final List filters,
    ...
    public TableController(final TableGuiConfiguration tableConfigP, final UserRequest ureq, final WindowControl wControl, final Translator tableTrans) {
        ...
        if (tableTrans != null) {
            setTranslator(new PackageTranslator(PackageUtil.getPackageName(TableController.class), ureq.getLocale(), tableTrans));
        }
