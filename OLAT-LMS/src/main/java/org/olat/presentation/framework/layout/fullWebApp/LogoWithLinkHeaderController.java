...
/**
 * <h3>Description:</h3> This is a simple controller that displays a clickable logo for in the layout header section.
 * <p>
...
public class LogoWithLinkHeaderController extends BasicController {
     ...
     *            Alt text for image
     */
    protected LogoWithLinkHeaderController(UserRequest ureq, WindowControl wControl, String linkURI, String imgURI, String imgAltText) {
        super(ureq, wControl);
