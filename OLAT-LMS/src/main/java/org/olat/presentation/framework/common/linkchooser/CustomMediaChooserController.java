...
/**
 * Description:<br>
 * This abstract class describes what a custom media chooser that can be used in the HTML editor must provide
 * <P>
...
public abstract class CustomMediaChooserController extends DefaultController {
     ...
     * @return true if success, false if no success, e.g. because user has no access right to start this controller
     */
    abstract public CustomMediaChooserController getInstance(UserRequest ureq, WindowControl wControl, VFSContainer rootDir, String[] suffixes, String fileName);
