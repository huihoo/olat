...
/**
 * <h3>Description:</h3> Event fired when a tree node has been moved within the tree.
 * <p>
...
public class MoveTreeNodeEvent extends Event {
     ...
     */
    public MoveTreeNodeEvent(String nodeId, String oldParentNodeId, String newParentNodeId, int position) {
        super("move");
        this.nodeId = nodeId;
     ...
     */
    public void setResult(boolean isSuccess, String failureTitle, String failureMessage) {
    ...
    /**
     * @return true if move is allowed and performed on the data model; false if move not allowed or an error occured.
     */
    ...
    /**
     * @return The title of the message in case of success = false or NULL if not set
     */
    ...
    /**
     * @return The message showed to the user in case of success = false or NULL if not set
     */
