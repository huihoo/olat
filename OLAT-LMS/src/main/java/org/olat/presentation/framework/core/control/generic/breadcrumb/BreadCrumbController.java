...
/**
 * <h3>Description:</h3> The BreadCrumbController implements a simple bred crumb navigation. This type of navigation is useful when users can launch loosely coupled
 * work-flows that don't span up in a new tab and that are not modal.
 * <p>
...
public class BreadCrumbController extends BasicController {
    ...
    /**
     * Add the first crumb controller to the crumb stack. To add followup crumbs to the stack you must use the crumbController.activateAndListenToChildCrumbController()
     * method
     * 
     * @param firstCrumbController
     *            The crumb controller that serves as the home crumb
     */
    ...
    /**
     * Remove a crumb controller and all it's child controllers that are created by this controller or it's children from the bread crumb stack and calls dispose on the
     * crumb controller. Use crumbController.removeFromBreadCrumbPathAndDispose() if you manually want to remove a crumb controller from the bread crumb
     * 
     * @param crumbController
     */
