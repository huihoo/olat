...
public class FileChooserUIFactory {
     ...
     *            The file choosen event
     * @param rootContainer
     *            The root container for which the relative path should be calculated
     * @param relativeBasePath
     *            when NULL, the path will be calculated relative to the rootContainer; when NULL, the relativeBasePath must represent a relative path within the root
     *            container that serves as the base. In this case, the calculated relative item path will start from this relativeBasePath
     * @return
     */
