...
package org.olat.presentation.framework.extensions.helpers;
...
import org.olat.presentation.framework.extensions.css.CSSIncluder;
import org.olat.presentation.framework.extensions.globalmapper.MapperProvider;
...
public class StaticAndCssHelper {
    ...
    /**
     * @param baseClass
     *            all static resources and the css file will be searched in the subfolder (called "raw") of the class file of the baseClass
     * @param cssName
     *            the name of the css file (e.g. stylesheet.css) to include in each olat page, or null if not stylesheet
     */
