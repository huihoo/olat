package org.olat.presentation.framework.core.control.generic.modal;
...
/**
 * <h3>Description:</h3> Use this factory to generate certain generic dialog types
 * <p>
...
public class DialogBoxUIFactory {
    ...
    public static DialogBoxController createYesNoDialog(UserRequest ureq, WindowControl wControl, String title, String text) {
        Translator trans = PackageUtil.createPackageTranslator(DialogBoxUIFactory.class, ureq.getLocale());
     ...
     * @return
     */
    public static DialogBoxController createGenericDialog(UserRequest ureq, WindowControl wControl, String title, String text, List<String> buttonLabels) {
     ...
     * @param lockEntry
     *            must be not null
     * @param i18nLockMsgKey
     *            must be not null and valid key in the given translator
     * @param translator
     *            must be not null
     * @return DialogController
     */
    public static DialogBoxController createResourceLockedMessage(UserRequest ureq, WindowControl wControl, LockResult lockEntry, String i18nLockMsgKey,
        ...
        String[] i18nParams = new String[] { lockEntry.getOwner().getName(), Formatter.getInstance(ureq.getLocale()).formatTime(new Date(lockEntry.getLockAquiredTime())) };
