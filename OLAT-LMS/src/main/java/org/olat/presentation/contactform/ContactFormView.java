...
public class ContactFormView extends BasicView{
	...
	public ContactFormView(UserRequest ureq, WindowControl wControl, Identity emailFrom, boolean hasAtLeastOneAddress, boolean isReadonly, boolean isCanceable, boolean hasRecipientsEditable){
		super(ureq,wControl);
