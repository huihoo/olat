...
public class STCourseNodeDisplayConfigFormController extends FormBasicController {
     ...
     */
    @Override
    protected void initForm(final FormItemContainer formLayout, @SuppressWarnings("unused") final Controller listener, @SuppressWarnings("unused") final UserRequest ureq) {
