...
public class TUConfigForm extends FormBasicController {
    ...
    public TUConfigForm(final UserRequest ureq, final WindowControl wControl, final ModuleConfiguration config, final boolean withCancel) {
        ...
        selectableValues = new String[] { OPTION_TUNNEL_THROUGH_OLAT_IFRAME, OPTION_SHOW_IN_OLAT_IN_AN_IFRAME, OPTION_SHOW_IN_NEW_BROWSER_WINDOW,
                OPTION_TUNNEL_THROUGH_OLAT_INLINE };

        selectableLabels = new String[] { translate(NLS_OPTION_TUNNEL_IFRAME_LABEL), translate(NLS_OPTION_OLAT_IFRAME_LABEL), translate(NLS_OPTION_EXTERN_PAGE_LABEL),
