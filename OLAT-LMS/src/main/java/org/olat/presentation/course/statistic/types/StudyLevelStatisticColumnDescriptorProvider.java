...
/**
 * TODO: Class Description for StudyLevelStatisticColumnDescriptorProvider
 * 
 * <P>
 ...
 * @author lavinia
 */
public class StudyLevelStatisticColumnDescriptorProvider implements ColumnDescriptorProvider {
    ...
    public ColumnDescriptor createColumnDescriptor(final UserRequest ureq, final int column, String headerId) {
        ...
        if (headerId != null) {
            ...
            if (translator != null) {
                final String newHeaderId = translator.translate("swissEduPersonStudyLevel." + headerId);
