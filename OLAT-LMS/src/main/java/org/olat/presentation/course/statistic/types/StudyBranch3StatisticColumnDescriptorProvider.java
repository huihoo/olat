...
/**
 * TODO: Class Description for StudyBranch3StatisticColumnDescriptorProvider
 * 
 * <P>
 ...
 * @author lavinia
 */
public class StudyBranch3StatisticColumnDescriptorProvider implements ColumnDescriptorProvider {
    ...
    public ColumnDescriptor createColumnDescriptor(final UserRequest ureq, final int column, String headerId) {
        ...
        if (headerId != null) {
            ...
            if (translator != null) {
                final String newHeaderId = translator.translate("swissEduPersonStudyBranch3." + headerId);
