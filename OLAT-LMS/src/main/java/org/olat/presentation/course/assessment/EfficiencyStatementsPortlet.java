...
public class EfficiencyStatementsPortlet extends AbstractPortlet {
    ...
    protected EfficiencyStatementsPortlet() {
    }

    @Override
    public Portlet createInstance(final WindowControl wControl, final UserRequest ureq, final Map configuration) {
        final Translator translator = new PackageTranslator(PackageUtil.getPackageName(EfficiencyStatementsPortlet.class), ureq.getLocale());
        final Portlet p = new EfficiencyStatementsPortlet();
