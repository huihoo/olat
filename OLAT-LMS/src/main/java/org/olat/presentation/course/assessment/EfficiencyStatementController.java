    ...
    public EfficiencyStatementController(final WindowControl wControl, final UserRequest ureq, final EfficiencyStatement efficiencyStatement) {
        ...
        if (efficiencyStatement != null) {
			...
			if(portfolioModule.isEnabled() && artHandler != null && artHandler.isEnabled()) {
				collectArtefactLink = org.olat.presentation.framework.core.components.link.LinkFactory.createCustomLink("collectArtefactLink", "collectartefact", "", org.olat.presentation.framework.core.components.link.Link.NONTRANSLATED, userDataVC, this);
