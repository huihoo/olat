...
/**
 * @author schnider Comment: Archives the User selected wiki's to the personal folder of this user. TODO: ORID-1007 Code Duplication (class is almost same as
 *         CourseForumsArchiveController)
 */
