...
/**
 * TODO: Class Description for HomeOrgStatisticColumnDescriptor
 * 
 * <P>
 ...
 * @author lavinia
 */
public class HomeOrgStatisticColumnDescriptorProvider implements ColumnDescriptorProvider {
    ...
    public ColumnDescriptor createColumnDescriptor(final UserRequest ureq, final int column, final String headerId) {
        ...
        /*
         * if (headerId!=null) { Translator translator = Util.createPackageTranslator(ShibbolethModule.class, ureq.getLocale()); if (translator!=null) { String
         * newHeaderId = translator.translate("swissEduPersonHomeOrganization."+headerId); if (newHeaderId!=null &&
         * !newHeaderId.startsWith(Translator.NO_TRANSLATION_ERROR_PREFIX)) { headerId = newHeaderId; } } }
         */
