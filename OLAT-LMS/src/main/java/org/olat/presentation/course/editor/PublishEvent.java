...
public class PublishEvent extends MultiUserEvent {
    ...
    long pubtimestamp;
    private final Long publishedCourseResId;
     ...
     *            is EVENT_IDENTIFIER
     */
    public PublishEvent(final long pubtimestamp, final ICourse publishedCourse, final String eventIdentifier) {
    ...
    public void setState(final int publishState) {
    ...
    void setInsertedCourseNodeIds(final Set<String> nodeIds) {
        insertedCourseNodeIds = nodeIds;
    }

    void setDeletedCourseNodeIds(final Set<String> nodeIds) {
        deletedCourseNodeIds = nodeIds;
    }

    void setModifiedCourseNodeIds(final Set<String> nodeIds) {
