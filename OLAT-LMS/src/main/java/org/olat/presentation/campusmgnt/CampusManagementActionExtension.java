...
public class CampusManagementActionExtension extends GenericActionExtension {
	...
	@Override
	public Controller createController(final UserRequest ureq,
			final WindowControl wControl, final Object arg) {
		if (arg instanceof OLATResourceable) {
			return new CampusManagementController(ureq, wControl,
					(OLATResourceable) arg);
		}
		else {
