...
public abstract class Memento implements Serializable {
    /**
     * holds the mementos state in a weakly coupled fashion. This helps if mementos are persisted using xmlstream and then changing the class structure of a memento
     * implementor.
     */
    ...
    protected Object getState() {
        ...
        /*
         * PostCondition: getVersion() == ((Integer)mementoState.get(VERSION)).intValue()
         */
