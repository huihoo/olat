...
public class SessionInfo {
    ...
    /**
     * @param ureq
     *            The user request for which the web mode should be calculated or null for normal web 1.0 mode (e.g. in web dav)
     */
    public void setWebModeFromUreq(UserRequest ureq) {
        ...
        if (ureq != null) {
            ...
            if (Windows.getWindows(ureq).getWindowManager().isForScreenReader())
                deliveryMode = "web 2.a";
        }
