...
public class GuiDemoFlexiFormSubworkflow extends FormBasicController {
    ...
    public GuiDemoFlexiFormSubworkflow(final UserRequest ureq, final WindowControl wControl, final GuiDemoFlexiFormPersonData data) {
        super(ureq, wControl);
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        setFormContextHelp("org.olat.presentation.filebrowser", "bc-webdav.html", "guidemo_flexi_form_withchooser.helphover");
        ...
        /*
         * - create a composite element - text element and to the left a choose link - the label of the textelement is set as the label of the layouting container.
         */
    ...
    private class GuiDemoFlexiFormSubworkflowTheChooser extends FormBasicController {
        ...
        public GuiDemoFlexiFormSubworkflowTheChooser(final UserRequest ureq, final WindowControl wControl, final String[] values, final String selection) {
            super(ureq, wControl);
            this.entries = values;
