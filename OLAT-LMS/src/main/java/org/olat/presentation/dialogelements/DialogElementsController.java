...
public class DialogElementsController extends BasicController {
    ...
    public DialogElementsController(final UserRequest ureq, final WindowControl wControl, final CourseNode courseNode, final UserCourseEnvironment userCourseEnv,
        ...
        if (subsContext != null) {
            ...
            final PublisherData pdata = new PublisherData(OresHelper.calculateTypeName(DialogElement.class), String.valueOf(getNotificationSubscriptionContextFactory()
                    .getSubContextIdFrom(subsContext.getSubidentifier())), businessPath);
            ...
            csCtr.setSubscribeButtonTitle("dialog.subscribeButton.title");
            csCtr.setUnsubscribeButtonTitle("dialog.unsubscribeButton.title");
        }
    ...
    protected void event(final UserRequest ureq, final Controller source, final Event event) {
        ...
        if (source == tableCtr) {
            ...
            if (event == Event.DONE_EVENT || event == Event.CANCELLED_EVENT) {
                ...
                try {
                    // get size of file
                    final OlatRootFolderImpl forumContainer = forumService.getForumContainer(recentDialogElement.getForumKey());
    ...
    private void doFileDelivery(final UserRequest ureq, final Long forumKey) {
        final OlatRootFolderImpl forumContainer = forumService.getForumContainer(forumKey);
    ...
    protected void event(final UserRequest ureq, final Component source, final Event event) {
        ...
        if (source == content) {
            ...
            final OlatRootFolderImpl forumContainer = forumService.getForumContainer(forum.getKey());
