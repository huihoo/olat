...
public class EPCollectStep04 extends BasicStep {
    ...
    public EPCollectStep04(final UserRequest ureq, final AbstractArtefact artefact) {
        super(ureq);
    ...
    public StepFormController getStepController(final UserRequest ureq, final WindowControl windowControl, final StepsRunContext stepsRunContext, final Form form) {
        final StepFormController stepI = new EPCollectStepForm04(ureq, windowControl, form, stepsRunContext, FormBasicController.LAYOUT_CUSTOM, null, artefact);
        return stepI;
    }
