...
public class GroupOverviewController extends BasicController {
    ...
    private List<Object[]> getBusinessGroupsModel() {
        ...
        for (final GroupMembershipParameter groupMembershipParameter : groupMembershipParameters) {
            ...
            groupEntry[1] = groupMembershipParameter.getBusinessGroup();
            if (groupMembershipParameter.getRoleTranslationArgument() != null) {
                groupEntry[2] = translate(groupMembershipParameter.getUserRole(), groupMembershipParameter.getRoleTranslationArgument());
            } else {
                groupEntry[2] = translate(groupMembershipParameter.getUserRole());
            }
            groupEntry[3] = groupMembershipParameter.getJoinDate();
