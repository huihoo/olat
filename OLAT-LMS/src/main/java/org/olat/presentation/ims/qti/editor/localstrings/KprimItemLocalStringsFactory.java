...
@Component
@Scope("prototype")
public class KprimItemLocalStringsFactory extends ScMcKprimItemLocalStringsAbstractFactory {

    KprimItemLocalStringsFactory(Translator translator) {
        super(translator);
    }

    @Override
    public QtiEditorLocalStrings createLocalStrings() {
        return super.createLocalStrings();
    }
