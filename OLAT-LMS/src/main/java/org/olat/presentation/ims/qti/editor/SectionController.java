...
public class SectionController extends TabbableDefaultController implements ControllerEventListener {
     ...
     * @param wControl
     */
    public SectionController(final Section section, final QTIEditorPackageEBL qtiPackage, final UserRequest ureq, final WindowControl wControl, final boolean restrictedEdit) {
        super(ureq, wControl);
