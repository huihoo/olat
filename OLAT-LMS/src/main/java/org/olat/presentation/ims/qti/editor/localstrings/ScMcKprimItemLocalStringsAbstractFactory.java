 ...
 */
public abstract class ScMcKprimItemLocalStringsAbstractFactory extends QtiEditorLocalStringsAbstractFactory {

    ScMcKprimItemLocalStringsAbstractFactory(Translator translator) {
        super(translator);
    }
    ...
    public QtiEditorLocalStrings createLocalStrings() {
        return new QtiEditorLocalStrings.Builder().newQuestion(translator.translate(NEW_QUESTION)).newQuestionText(translator.translate(NEW_QUESTION_TEXT))
                .newResponseText(translator.translate(NEW_RESPONSE_TEXT)).build();
    }
