...
public class ClusterAdminControllerCluster extends BasicController {
    ...
    public ClusterAdminControllerCluster(final UserRequest ureq, final WindowControl wControl) {
        super(ureq, wControl);
        final CoordinatorManager clustercoord = (CoordinatorManager) CoreSpringFactory.getBean(CoordinatorManager.class);
    ...
    public void event(final UserRequest ureq, final Controller source, final Event event) {
        if (source == usc) {
            ...
            if (event != Event.CANCELLED_EVENT) {
                ...
                ClusterLockDao clusterLockManager = (ClusterLockDao) CoreSpringFactory.getBean(ClusterLockDao.class);
