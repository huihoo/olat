 ...
 * 
 * @author Alexander Schneider Comment: The user can select if his name is (in)visible on the online user list.
 */
public class OnlineListForm extends FormBasicController {
    ...
    public OnlineListForm(final UserRequest ureq, final WindowControl wControl, final ImPreferences imPrefs) {
        super(ureq, wControl);
        this.imPrefs = imPrefs;
        initForm(ureq);
    }

    protected void updateImPreferencesFromFormData(final ImPreferences imPrefs) {
    ...
    protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
        ...
        this.setFormContextHelp("org.olat.presentation.user", "home-imsettings.html", "help.hover.imsettings");
