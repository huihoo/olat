...
/**
 * Description:<br>
 * TODO: patrickb Class Description for ZsuzStepUserData
 * <P>
 * Initial Date: 19.06.2008 <br>
 * 
 * @author patrickb
 */
public class ZsuzStepUserData extends BasicStep {

    public ZsuzStepUserData(final UserRequest ureq) {
        super(ureq);
        setI18nTitleAndDescr("step.userdata.title", null);
        setNextStep(new ZsuzStep00(ureq));
    }
    ...
    public StepFormController getStepController(final UserRequest ureq, final WindowControl windowControl, final StepsRunContext stepsRunContext, final Form form) {
        return new ZsuzStepUserDataForm(ureq, windowControl, form, stepsRunContext, FormBasicController.LAYOUT_VERTICAL, null);
    }
