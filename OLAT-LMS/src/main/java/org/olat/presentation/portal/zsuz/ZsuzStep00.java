...
/**
 * Description:<br>
 * TODO: patrickb Class Description for ZsuzStep00
 * <P>
 * Initial Date: 06.06.2008 <br>
 * 
 * @author patrickb
 */
class ZsuzStep00 extends BasicStep implements Step {

    public ZsuzStep00(final UserRequest ureq) {
        super(ureq);
        setI18nTitleAndDescr("step00.title", null);
        setNextStep(new ZsuzStep01(ureq));
    }
    ...
    public StepFormController getStepController(final UserRequest ureq, final WindowControl windowControl, final StepsRunContext stepsRunContext, final Form form) {
        final StepFormController sfbc = new ZsuzStep00Form(ureq, windowControl, form, stepsRunContext, FormBasicController.LAYOUT_VERTICAL, null);
        return sfbc;
    }
