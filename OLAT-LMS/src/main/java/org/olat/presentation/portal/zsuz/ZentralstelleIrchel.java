...
class ZentralstelleIrchel implements Identity {

    private UserService userService;

    /**
     * @param zentralstellePortlet
     */
    protected ZentralstelleIrchel() {
        //
    }
    ...
    public PrincipalAttributes getAttributes() {
        return new PrincipalAttributesImpl(this.userService);
    }
