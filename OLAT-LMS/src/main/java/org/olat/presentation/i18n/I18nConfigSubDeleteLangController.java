...
class I18nConfigSubDeleteLangController extends FormBasicController {
    ...
    protected void formOK(UserRequest ureq) {
        ...
        dialogCtr = activateYesNoDialog(ureq, translate("configuration.management.delete.confirm.title"),
                translate("configuration.management.delete.confirm", toDelete.toString()), dialogCtr);
    }
