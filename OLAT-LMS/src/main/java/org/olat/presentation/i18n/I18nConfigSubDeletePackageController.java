...
class I18nConfigSubDeletePackageController extends FormBasicController {
    ...
    protected void formOK(UserRequest ureq) {
        ...
        dialogCtr = activateYesNoDialog(ureq, translate("configuration.management.package.delete.confirm.title"),
                translate("configuration.management.package.delete.confirm", toDelete.toString()), dialogCtr);
    }
