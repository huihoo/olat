...
/**
 * Description:<br>
 * This class extends the AxisServlet class to provide an alternate "getEPRsForService" method.
 * <P>
...
public class OnyxAxisServlet extends AxisServlet {
	 ...
	 */
	@Override
	public EndpointReference[] getEPRsForService(final String serviceName, final String ip) throws AxisFault {
		EndpointReference epr = null;

		final String eprString = Settings.createServerURI();
