/**
 * SaveResultLocalResponse.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.5 Built on : Apr 30, 2009 (06:07:47 EDT)
 */

package de.bps.onyx.plugin.wsserver;

/**
 * SaveResultLocalResponse bean class
 */

public class SaveResultLocalResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://test.plugin.bps.de/", "saveResultLocalResponse", "ns1");
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		final org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			public void serialize(final org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
				SaveResultLocalResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":saveResultLocalResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "saveResultLocalResponse", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SaveResultLocalResponse parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			final SaveResultLocalResponse object = new SaveResultLocalResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"saveResultLocalResponse".equals(type)) {
							// find namespace for the prefix
							final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SaveResultLocalResponse) de.bps.onyx.plugin.wsserver.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
