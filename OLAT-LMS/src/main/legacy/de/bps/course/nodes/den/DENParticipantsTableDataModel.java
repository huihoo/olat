...
class DENParticipantsTableDataModel extends DefaultTableDataModel {
	...
	public DENParticipantsTableDataModel(final List objects) {
		super(objects);
	}
	...
	public Object getValueAt(final int row, final int col) {
		final Identity identity = (Identity) objects.get(row);
	...
	public void setEntries(final List<Identity> newEntries) {
		this.objects = newEntries;
	}

	public Identity getEntryAt(final int row) {
