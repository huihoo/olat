/**
 * Onyx_reporter_media_providerStub.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.4.1 Built on : Aug 13, 2008 (05:03:35 LKT)
 */
...
public class MediaProviderStub extends org.apache.axis2.client.Stub {
	...
	public MediaProviderStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint)
	 ...
	 */
	public MediaProviderStub(org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener)
			throws org.apache.axis2.AxisFault {
	 ...
	 * Default Constructor
	 */
	public MediaProviderStub(final org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
	 ...
	 */
	public MediaProviderStub(final java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
	...
	final de.bps.webservices.clients.onyxreporter.stubs.MediaProviderStub.MediaFileRequestE mediaFileRequest)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), mediaFileRequest, optimizeContent(new javax.xml.namespace.QName(
					"http://localhost:8080/axis2_tester/services/", "getMediaFiles")));
			...
			final java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
					de.bps.webservices.clients.onyxreporter.stubs.MediaProviderStub.MediaFileResponseE.class, getEnvelopeNamespaces(_returnEnv));
	...
	public static class ContentPackageDownload implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = contentPackageDownload Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace
		 * Prefix = ns1
		 */
		...
		/**
		 * field for RelativePath This was an Array!
		 */
		 ...
		 */
		protected void validateRelativePath(final java.lang.String[] param) {
		 ...
		 */
		public void setRelativePath(final java.lang.String[] param) {
		 ...
		 */
		public void addRelativePath(final java.lang.String param) {
			if (localRelativePath == null) {
				localRelativePath = new java.lang.String[] {};
			}

			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localRelativePath);
			list.add(param);
			this.localRelativePath = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":contentPackageDownload", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "contentPackageDownload", xmlWriter);
				}
			...
			if (localRelativePath != null) {
				...
				for (int i = 0; i < localRelativePath.length; i++) {
					...
					if (localRelativePath[i] != null) {
						...
						if (!emptyNamespace) {
							if (prefix == null) {
								final java.lang.String prefix2 = generatePrefix(namespace);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			if (localRelativePath != null) {
				for (int i = 0; i < localRelativePath.length; i++) {
					...
					if (localRelativePath[i] != null) {
						elementList.add(new javax.xml.namespace.QName("", "relativePath"));
						elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRelativePath[i]));
					} else {
		...
		public static class Factory {
			 ...
			 */
			public static ContentPackageDownload parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final ContentPackageDownload object = new ContentPackageDownload();
				...
				try {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"contentPackageDownload".equals(type)) {
								...
								return (ContentPackageDownload) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("", "relativePath").equals(reader.getName())) {
						...
						object.setRelativePath((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
	...
	public static class MediaFileRequestChoice_type0 implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = mediaFileRequestChoice_type0 Namespace URI = http://localhost:8080/axis2_tester/services/
		...
		/**
		 * Whenever a new property is set ensure all others are unset There can be only one choice and the last one wins
		 */
		...
		/**
		 * field for ResultFileDownload This was an Array!
		 */
		 ...
		 */
		protected void validateResultFileDownload(final ResultFileDownload[] param) {
		 ...
		 */
		public void setResultFileDownload(final ResultFileDownload[] param) {
		 ...
		 * @param param ResultFileDownload
		 */
		public void addResultFileDownload(final ResultFileDownload param) {
			...
			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localResultFileDownload);
			list.add(param);
			this.localResultFileDownload = (ResultFileDownload[]) list.toArray(new ResultFileDownload[list.size()]);
		 ...
		 */
		public void setContentPackageDownload(final ContentPackageDownload param) {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":mediaFileRequestChoice_type0", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mediaFileRequestChoice_type0", xmlWriter);
				}
				...
				if (localResultFileDownload != null) {
					for (int i = 0; i < localResultFileDownload.length; i++) {
						if (localResultFileDownload[i] != null) {
							localResultFileDownload[i].serialize(new javax.xml.namespace.QName("", "resultFileDownload"), factory, xmlWriter);
						} else {
			...
			if (localContentPackageDownloadTracker) {
				if (localContentPackageDownload == null) { throw new org.apache.axis2.databinding.ADBException("contentPackageDownload cannot be null!!"); }
				localContentPackageDownload.serialize(new javax.xml.namespace.QName("", "contentPackageDownload"), factory, xmlWriter);
			}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			if (localResultFileDownloadTracker) {
				if (localResultFileDownload != null) {
					for (int i = 0; i < localResultFileDownload.length; i++) {
						...
						if (localResultFileDownload[i] != null) {
							elementList.add(new javax.xml.namespace.QName("", "resultFileDownload"));
			...
			if (localContentPackageDownloadTracker) {
				elementList.add(new javax.xml.namespace.QName("", "contentPackageDownload"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static MediaFileRequestChoice_type0 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final MediaFileRequestChoice_type0 object = new MediaFileRequestChoice_type0();
				...
				try {
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("", "resultFileDownload").equals(reader.getName())) {
						...
						object.setResultFileDownload((ResultFileDownload[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(ResultFileDownload.class,
								list1));
	...
	public static class MediaFileResponseE implements org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "mediaFileResponse", "ns1");
		 ...
		 */
		public void setMediaFileResponse(final MediaFileResponse param) {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (localMediaFileResponse == null) { throw new org.apache.axis2.databinding.ADBException("Property cannot be null!"); }
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static MediaFileResponseE parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final MediaFileResponseE object = new MediaFileResponseE();
				...
				try {
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "mediaFileResponse").equals(reader.getName())) {
	...
	public static class ResultFileUploadSequence_type0 implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = resultFileUploadSequence_type0 Namespace URI = http://localhost:8080/axis2_tester/services/
		 * Namespace Prefix = ns1
		 */
		 ...
		 */
		public void setMediaFile(final javax.activation.DataHandler param) {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":resultFileUploadSequence_type0", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "resultFileUploadSequence_type0", xmlWriter);
				}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			elementList.add(new javax.xml.namespace.QName("", "mediaFile"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static ResultFileUploadSequence_type0 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final ResultFileUploadSequence_type0 object = new ResultFileUploadSequence_type0();
				...
				try {
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("", "mediaFile").equals(reader.getName())) {
						...
						if (isReaderMTOMAware(reader) && java.lang.Boolean.TRUE.equals(reader.getProperty(org.apache.axiom.om.OMConstants.IS_BINARY))) {
							...
							object.setMediaFile((javax.activation.DataHandler) reader.getProperty(org.apache.axiom.om.OMConstants.DATA_HANDLER));
						} else {
							if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
								...
								object.setMediaFile(((org.apache.axiom.soap.impl.builder.MTOMStAXSOAPModelBuilder) ((org.apache.axiom.om.impl.llom.OMStAXWrapper) reader)
								...
								object.setMediaFile(org.apache.axis2.databinding.utils.ConverterUtil.convertToBase64Binary(content));
	...
	public static class MediaFileResponse implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = mediaFileResponse Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace
		 * Prefix = ns1
		 */
		...
		/**
		 * field for ResultFileUpload This was an Array!
		 */
		 ...
		 */
		protected void validateResultFileUpload(final ResultFileUpload[] param) {
		 ...
		 */
		public void setResultFileUpload(final ResultFileUpload[] param) {
		 ...
		 * @param param ResultFileUpload
		 */
		public void addResultFileUpload(final ResultFileUpload param) {
			...
			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localResultFileUpload);
			list.add(param);
			this.localResultFileUpload = (ResultFileUpload[]) list.toArray(new ResultFileUpload[list.size()]);

		}

		/**
		 * field for ContentPackageUpload This was an Array!
		 */
		 ...
		 */
		protected void validateContentPackageUpload(final ContentPackageUpload[] param) {
		 ...
		 */
		public void setContentPackageUpload(final ContentPackageUpload[] param) {
		 ...
		 * @param param ContentPackageUpload
		 */
		public void addContentPackageUpload(final ContentPackageUpload param) {
			...
			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localContentPackageUpload);
			list.add(param);
			this.localContentPackageUpload = (ContentPackageUpload[]) list.toArray(new ContentPackageUpload[list.size()]);
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":mediaFileResponse", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mediaFileResponse", xmlWriter);
				}
				...
				if (localResultFileUpload != null) {
					for (int i = 0; i < localResultFileUpload.length; i++) {
						if (localResultFileUpload[i] != null) {
							localResultFileUpload[i].serialize(new javax.xml.namespace.QName("", "resultFileUpload"), factory, xmlWriter);
						} else {
				...
				if (localContentPackageUpload != null) {
					for (int i = 0; i < localContentPackageUpload.length; i++) {
						if (localContentPackageUpload[i] != null) {
							localContentPackageUpload[i].serialize(new javax.xml.namespace.QName("", "contentPackageUpload"), factory, xmlWriter);
						} else {
			...
			if (localResultFileUploadTracker) {
				if (localResultFileUpload != null) {
					for (int i = 0; i < localResultFileUpload.length; i++) {
						...
						if (localResultFileUpload[i] != null) {
							elementList.add(new javax.xml.namespace.QName("", "resultFileUpload"));
			...
			if (localContentPackageUploadTracker) {
				if (localContentPackageUpload != null) {
					for (int i = 0; i < localContentPackageUpload.length; i++) {
						...
						if (localContentPackageUpload[i] != null) {
							elementList.add(new javax.xml.namespace.QName("", "contentPackageUpload"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static MediaFileResponse parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final MediaFileResponse object = new MediaFileResponse();
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"mediaFileResponse".equals(type)) {
								// find namespace for the prefix
								final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (MediaFileResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement() && new javax.xml.namespace.QName("", "resultFileUpload").equals(reader.getName())) {
								...
								object.setResultFileUpload((ResultFileUpload[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(ResultFileUpload.class,
										list1));
							...
							if (reader.isStartElement() && new javax.xml.namespace.QName("", "contentPackageUpload").equals(reader.getName())) {
								...
								object.setContentPackageUpload((ContentPackageUpload[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
										ContentPackageUpload.class, list2));
	...
	public static class MediaFileRequestE implements org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "mediaFileRequest", "ns1");
		 ...
		 */
		public void setMediaFileRequest(final MediaFileRequest param) {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (localMediaFileRequest == null) { throw new org.apache.axis2.databinding.ADBException("Property cannot be null!"); }
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static MediaFileRequestE parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final MediaFileRequestE object = new MediaFileRequestE();
				...
				try {
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "mediaFileRequest").equals(reader.getName())) {
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader)
			...
			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "contentPackageDownload".equals(typeName)) {

			return ContentPackageDownload.Factory.parse(reader);

			}

			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "mediaFileRequest".equals(typeName)) {

			return MediaFileRequest.Factory.parse(reader);

			}

			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "mediaFileResponse".equals(typeName)) {

			return MediaFileResponse.Factory.parse(reader);

			}

			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "resultFileUpload".equals(typeName)) {

			return ResultFileUpload.Factory.parse(reader);

			}

			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "resultFileDownload".equals(typeName)) {

			return ResultFileDownload.Factory.parse(reader);

			}

			if ("http://localhost:8080/axis2_tester/services/".equals(namespaceURI) && "contentPackageUpload".equals(typeName)) {
	...
	public static class MediaFileRequest implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = mediaFileRequest Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace Prefix
		 * = ns1
		 */
		 ...
		 * @param param TestId
		 */
		public void setTestId(final java.lang.String param) {
		 ...
		 */
		public void setMediaFileRequestChoice_type0(final MediaFileRequestChoice_type0 param) {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":mediaFileRequest", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mediaFileRequest", xmlWriter);
				}
			...
			if (localMediaFileRequestChoice_type0 == null) { throw new org.apache.axis2.databinding.ADBException("mediaFileRequestChoice_type0 cannot be null!!"); }
		...
		public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			elementList.add(new javax.xml.namespace.QName("", "testId"));
			...
			elementList.add(new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "mediaFileRequestChoice_type0"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static MediaFileRequest parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final MediaFileRequest object = new MediaFileRequest();
				...
				try {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"mediaFileRequest".equals(type)) {
								// find namespace for the prefix
								final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (MediaFileRequest) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("", "testId").equals(reader.getName())) {
						...
						object.setTestId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
	...
	public static class ResultFileDownload implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = resultFileDownload Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace
		 * Prefix = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":resultFileDownload", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "resultFileDownload", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static ResultFileDownload parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final ResultFileDownload object = new ResultFileDownload();
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"resultFileDownload".equals(type)) {
								// find namespace for the prefix
								final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (ResultFileDownload) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
	...
	public static class ResultFileUpload implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = resultFileUpload Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace Prefix
		 * = ns1
		 */
		...
		/**
		 * field for ResultFileUploadSequence_type0 This was an Array!
		 */
		 ...
		 */
		protected void validateResultFileUploadSequence_type0(final ResultFileUploadSequence_type0[] param) {
		 ...
		 */
		public void setResultFileUploadSequence_type0(final ResultFileUploadSequence_type0[] param) {
		 ...
		 * @param param ResultFileUploadSequence_type0
		 */
		public void addResultFileUploadSequence_type0(final ResultFileUploadSequence_type0 param) {
			if (localResultFileUploadSequence_type0 == null) {
				localResultFileUploadSequence_type0 = new ResultFileUploadSequence_type0[] {};
			}

			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localResultFileUploadSequence_type0);
			list.add(param);
			this.localResultFileUploadSequence_type0 = (ResultFileUploadSequence_type0[]) list.toArray(new ResultFileUploadSequence_type0[list.size()]);
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":resultFileUpload", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "resultFileUpload", xmlWriter);
				}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			if (localResultFileUploadSequence_type0 != null) {
				for (int i = 0; i < localResultFileUploadSequence_type0.length; i++) {
					...
					if (localResultFileUploadSequence_type0[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://localhost:8080/axis2_tester/services/", "resultFileUploadSequence_type0"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static ResultFileUpload parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final ResultFileUpload object = new ResultFileUpload();
				...
				try {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"resultFileUpload".equals(type)) {
								// find namespace for the prefix
								final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (ResultFileUpload) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()) {
						...
						// call the converter utility to convert and set the array
						object.setResultFileUploadSequence_type0((ResultFileUploadSequence_type0[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
								ResultFileUploadSequence_type0.class, list2));
	...
	public static class ContentPackageUpload implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = contentPackageUpload Namespace URI = http://localhost:8080/axis2_tester/services/ Namespace
		 * Prefix = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
			...
			if (serializeType) {
				...
				final java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://localhost:8080/axis2_tester/services/");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":contentPackageUpload", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "contentPackageUpload", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static ContentPackageUpload parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				final ContentPackageUpload object = new ContentPackageUpload();
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"contentPackageUpload".equals(type)) {
								// find namespace for the prefix
								final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (ContentPackageUpload) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
	...
	private org.apache.axiom.om.OMElement toOM(final de.bps.webservices.clients.onyxreporter.stubs.MediaProviderStub.MediaFileRequestE param,
	...
	private org.apache.axiom.om.OMElement toOM(final de.bps.webservices.clients.onyxreporter.stubs.MediaProviderStub.MediaFileResponseE param,
			final boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory,
			final de.bps.webservices.clients.onyxreporter.stubs.MediaProviderStub.MediaFileRequestE param, final boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
